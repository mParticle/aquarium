...
#### Tables with Filters
Filters help users refine large datasets within tables. The mParticle table supports a range of filter types, including [Search](#link-to-search), Date Range filters, basic dropdowns, and more advanced [filters with an Apply button](#link-to-apply-button-filters).
