...
The **Dark** button provides a bold, high-contrast option with a black background and white text. Use `color="default"` with `variant="solid"` to achieve this style.

<Canvas of={ButtonStories.DarkButton} />
...
Untitled UI icons use the same `Icon` component, but pass the imported icon component instead of a string name.
...
<Canvas of={ButtonStories.Refresh} />

### Button with Dropdown

<Canvas of={ButtonStories.With2Options} />
...
> Full API reference: [Button — Ant Design](https://ant.design/components/button)
...
<table>
  ...
  <tbody>
    <tr>
      <td>Eames</td>
      <td><a href="https://www.figma.com/design/veXnmignQnJz8StIq10VJ5/Eames-2.0---Foundations-%26-Components?node-id=368-430&p=f&t=1Pi9thxrLJt7TsHN-0">Button Component</a></td>
    </tr>
    <tr>
      <td>AntD</td>
      <td><a href="https://ant.design/components/button">Button Component</a></td>
    </tr>
  </tbody>
</table>