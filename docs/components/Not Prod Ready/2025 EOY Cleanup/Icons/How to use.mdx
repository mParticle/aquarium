...
**Use the Cursor rule `@add-new-icon.mdc` for step-by-step guidance!** This rule will:
- Walk you through the complete process
- Start the required servers (icons-prettifier and storybook)
- Guide you through each file update in the correct order
- Help you verify the icon works properly

### Manual Steps to Add a New Icon:

1. **Ensure name of icon follows the desired principles**:
  <details>
    <summary style={{ fontFamily: "'Nunito Sans', sans-serif" }}>Here's the naming principles all icons should follow</summary>
...
<table>
  ...
  <tbody>
    <tr>
      <td>Eames</td>
      <td><a href="https://www.figma.com/design/3j5Nb0oOSkF3DW3URS8yex/mParticle-Icons-1.0.0?node-id=2055-9952&t=K7xlZo0hE2tn2y54-0">Figma Icon library</a></td>
    </tr>
    <tr>
      <td>Eames</td>
      <td><a href="https://mparticle.atlassian.net/wiki/spaces/DMP/pages/3988914258/Icons">Icon Guidelines for designers</a></td>
    </tr>
    <tr>
      <td>Eames</td>
      <td><a href="https://fontawesome.com/search?o=r&s=ligh">Fontawesome Library</a></td>
    </tr>
  </tbody>
</table>
