...
}`},(Me=(Re=B.parameters)==null?void 0:Re.docs)==null?void 0:Me.source)})});const pr=["Primary","Default","Dashed","Text","Link","WithDanger","Disabled","Ghost","Block","WithIcon","WithIconSM","WithIconDefaultColorSM","RoundIconButton","Loading","Circle","Round","Large","Small","PrimaryButtonWithClick"];export{h as Block,x as Circle,m as Dashed,i as Default,l as Disabled,g as Ghost,v as Large,d as Link,w as Loading,c as Primary,B as PrimaryButtonWithClick,b as Round,k as RoundIconButton,I as Small,p as Text,u as WithDanger,f as WithIcon,S as WithIconDefaultColorSM,y as WithIconSM,pr as __namedExportsOrder,mr as default};
