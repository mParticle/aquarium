...
}`},(ie=(oe=y.parameters)==null?void 0:oe.docs)==null?void 0:ie.source)})});var ne,ce,de;k.parameters=a(r({},k.parameters),{docs:a(r({},(ne=k.parameters)==null?void 0:ne.docs),{source:r({originalSource:`{
  render: () => {
    const items: IDescriptionsProps['items'] = [{
      label: 'Product',
      children: 'Cloud Database'
