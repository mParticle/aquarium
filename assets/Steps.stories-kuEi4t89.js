...
}`},(Ht=(Gt=w.parameters)==null?void 0:Gt.docs)==null?void 0:Ht.source)})});var Ut,_t,Ot;k.parameters=s(t({},k.parameters),{docs:s(t({},(Ut=k.parameters)==null?void 0:Ut.docs),{source:t({originalSource:`{
  render: () => {
    const description = 'This is a description.';
    const items = [{
      title: 'Finished',
...
}`},(Ot=(_t=k.parameters)==null?void 0:_t.docs)==null?void 0:Ot.source)})});var qt,Jt,Kt;z.parameters=s(t({},z.parameters),{docs:s(t({},(qt=z.parameters)==null?void 0:qt.docs),{source:t({originalSource:`{
  render: () => {
    const data = [{
