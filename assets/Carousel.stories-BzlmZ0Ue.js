...
}`},(ce=(de=S.parameters)==null?void 0:de.docs)==null?void 0:ce.source)})});var he,pe,ue;C.parameters=n(t({},C.parameters),{docs:n(t({},(he=C.parameters)==null?void 0:he.docs),{source:t({originalSource:`{
  render: () => {
...
}`},(ue=(pe=C.parameters)==null?void 0:pe.docs)==null?void 0:ue.source)})});const Ue=["Primary","WithAutoplay","CustomAutoplaySpeed","CustomDotPosition","WithoutDots","WithFadeEffect","WithLinearEasing","WithoutInfiniteLoop","CustomSpeed","WaitForAnimate","ExampleBasic","ExamplePosition","ExampleAutoScroll","ExampleFadeIn"];export{h as CustomAutoplaySpeed,p as CustomDotPosition,g as CustomSpeed,S as ExampleAutoScroll,f as ExampleBasic,C as ExampleFadeIn,j as ExamplePosition,d as Primary,v as WaitForAnimate,c as WithAutoplay,m as WithFadeEffect,x as WithLinearEasing,u as WithoutDots,y as WithoutInfiniteLoop,Ue as __namedExportsOrder,He as default};
