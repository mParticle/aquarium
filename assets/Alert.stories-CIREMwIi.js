...
}`},(L=(F=g.parameters)==null?void 0:F.docs)==null?void 0:L.source)})});var O,U,M;x.parameters=n(r({},x.parameters),{docs:n(r({},(O=x.parameters)==null?void 0:O.docs),{source:r({originalSource:`{
  args: {
    description: 'Additional content of the alert.'
  }
}`},(M=(U=x.parameters)==null?void 0:U.docs)==null?void 0:M.source)})});var N,P,R;u.parameters=n(r({},u.parameters),{docs:n(r({},(N=u.parameters)==null?void 0:N.docs),{source:r({originalSource:`{
  args: {
    action: <a style={{
      paddingLeft: '8px'
    }}>Click Me Link</a>
  }
}`},(R=(P=u.parameters)==null?void 0:P.docs)==null?void 0:R.source)})});var V,_,J;y.parameters=n(r({},y.parameters),{docs:n(r({},(V=y.parameters)==null?void 0:V.docs),{source:r({originalSource:`{
  args: {
    closeIcon: <Icon name="mpLogo" />
  }
}`},(J=(_=y.parameters)==null?void 0:_.docs)==null?void 0:J.source)})});var q,G,H;E.parameters=n(r({},E.parameters),{docs:n(r({},(q=E.parameters)==null?void 0:q.docs),{source:r({originalSource:`{
  render: () => {
    return <>
...
}`},(H=(G=E.parameters)==null?void 0:G.docs)==null?void 0:H.source)})});var K,Q,X;h.parameters=n(r({},h.parameters),{docs:n(r({},(K=h.parameters)==null?void 0:K.docs),{source:r({originalSource:`{
  render: () => {
    return <>
...
}`},(oe=(se=f.parameters)==null?void 0:se.docs)==null?void 0:oe.source)})});const ve=["Primary","Success","ErrorType","WarningBanner","Description","CustomAction","CustomCloseIcon","ExampleAllTypes","ExampleClosable","ExampleBanner","ExampleCatchError","ExampleCustomActions"];export{u as CustomAction,y as CustomCloseIcon,x as Description,d as ErrorType,E as ExampleAllTypes,T as ExampleBanner,S as ExampleCatchError,h as ExampleClosable,f as ExampleCustomActions,p as Primary,m as Success,g as WarningBanner,ve as __namedExportsOrder,Be as default};
