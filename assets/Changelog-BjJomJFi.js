var b=Object.defineProperty,n=Object.defineProperties;var d=Object.getOwnPropertyDescriptors;var m=Object.getOwnPropertySymbols;var h=Object.prototype.hasOwnProperty,p=Object.prototype.propertyIsEnumerable;var u=(a,t,e)=>t in a?b(a,t,{enumerable:!0,configurable:!0,writable:!0,value:e}):a[t]=e,i=(a,t)=>{for(var e in t||(t={}))h.call(t,e)&&u(a,e,t[e]);if(m)for(var e of m(t))p.call(t,e)&&u(a,e,t[e]);return a},r=(a,t)=>n(a,d(t));import{j as c}from"./jsx-runtime-CVnACwZl.js";import{useMDXComponents as s}from"./index-CkQzTg6q.js";import{al as f}from"./index-DwWZIu9p.js";import"./index-3OP4wdng.js";import"./iframe-RF-EF0AH.js";import"../sb-preview/runtime.js";import"./index-B-gr4m3q.js";import"./index-J1TP6alb.js";import"./extends-CF3RwP-h.js";import"./isNativeReflectConstruct-CWIsGhkf.js";import"./_baseClone-CXAe4HsA.js";import"./index-DtC6qIGv.js";import"./index-DrFu-skq.js";const l=`## [1.52.1](https://github.com/mParticle/aquarium/compare/v1.52.0...v1.52.1) (2025-08-26)
...
- active workspace style ([#148](https://github.com/mParticle/aquarium/issues/148)) ([a276806](https://github.com/mParticle/aquarium/commit/a27680671f90985746115f9d5fb5f6e5b60f0016))
...
- button-alligned center ([#287](https://github.com/mParticle/aquarium/issues/287)) ([d8c056d](https://github.com/mParticle/aquarium/commit/d8c056d7911bd9d0fb7aecf9ee50e1191e7bd764))
...
- hide expand icon in global navigation lists ([#178](https://github.com/mParticle/aquarium/issues/178)) ([edd21db](https://github.com/mParticle/aquarium/commit/edd21dbe7dac225d9385f79dd9fe675ef71ca195))
...
- Icon component build issue ([d7e2faf](https://github.com/mParticle/aquarium/commit/d7e2faff0ddb92ace9c66213dd7a019003f1197c))
...
- Input now support refs ([#169](https://github.com/mParticle/aquarium/issues/169)) ([20a7e47](https://github.com/mParticle/aquarium/commit/20a7e4709c6a77c5e197a449c6ad715e8b5c1a80))
...
- **lint:** fix linting problems ([c343136](https://github.com/mParticle/aquarium/commit/c343136b9759585983c0d24dfa7f9409ffef9aa2))
...
- nav link target ([#166](https://github.com/mParticle/aquarium/issues/166)) ([092a3aa](https://github.com/mParticle/aquarium/commit/092a3aa462741f42cddfab507807dc782848b639))
- **NavigationSearch:** swaps Ctrl for Cmd on Macs ([a0b7d63](https://github.com/mParticle/aquarium/commit/a0b7d6327d93cb74af8cfac7be92fa2921c987c5))
...
- rollback variables/style ([#310](https://github.com/mParticle/aquarium/issues/310)) ([efcaf5c](https://github.com/mParticle/aquarium/commit/efcaf5c0e3d2497a60298bb9fee6d22c65c6fbdf))
...
- style build missing custom rules ([#147](https://github.com/mParticle/aquarium/issues/147)) ([3a66b26](https://github.com/mParticle/aquarium/commit/3a66b268dc1b773b8d2b47c48ea334fc1104a2f6))
- sub menu links should open the correct herf ([#167](https://github.com/mParticle/aquarium/issues/167)) ([6b52fea](https://github.com/mParticle/aquarium/commit/6b52fea9ade1f654083b060d2234c8404168e041))
...
- **workspaceselector:** fix key duplication in the WorkspaceSelector ([2967c68](https://github.com/mParticle/aquarium/commit/2967c68a83182c7dd54b0cac3210b5205e7950fc))
- **workspaceselector:** fix performance problems by swapping Antd Menu component with native ul ([8a0257b](https://github.com/mParticle/aquarium/commit/8a0257b1517ecd108b45677a6bd5b3ec72250bd7))
...
- Add links to the minimap ([#246](https://github.com/mParticle/aquarium/issues/246)) ([80bd00c](https://github.com/mParticle/aquarium/commit/80bd00c991e931998b4df60e28394d0f7083f95b))
...
- Adds stylelint with recommended configs and rules from Indicative ([#82](https://github.com/mParticle/aquarium/issues/82)) ([4dd5380](https://github.com/mParticle/aquarium/commit/4dd5380ebd35b4c80516edd439e10b15ae95feaa))
...
- ant design system ([#9](https://github.com/mParticle/aquarium/issues/9)) ([7c0f090](https://github.com/mParticle/aquarium/commit/7c0f090eebdabf3cd1d4057251b3e82b5790d457))
...
- components ([#33](https://github.com/mParticle/aquarium/issues/33)) ([78dfb17](https://github.com/mParticle/aquarium/commit/78dfb173cab422ca6d2066f532c573cacb68dbe3))
- Exports bundle without libs (React, Antd) and TS types ([#76](https://github.com/mParticle/aquarium/issues/76)) ([5dbb9df](https://github.com/mParticle/aquarium/commit/5dbb9dfe9f0a9a1c64b2312aeb56de22acd6e1c7))
- first story with a simple component and directory structure with readmes ([a60b9b8](https://github.com/mParticle/aquarium/commit/a60b9b8122bf3227b934d9566af1c2443730e443))
...
- global navigation and styling ([#124](https://github.com/mParticle/aquarium/issues/124)) ([7863d9a](https://github.com/mParticle/aquarium/commit/7863d9acc33d9cc3447c598672a31d5e6bbedf5a))
...
- **icons:** export icons from the Aquarium ([dde4db2](https://github.com/mParticle/aquarium/commit/dde4db26af9fe2634893ce2707eb0e9a9151812b))
- install vitest unit test runner ([#143](https://github.com/mParticle/aquarium/issues/143)) ([2ad4075](https://github.com/mParticle/aquarium/commit/2ad4075c2efcd673a93825328676e40b2ac5863b))
...
- Organize component directories by type ([#16](https://github.com/mParticle/aquarium/issues/16)) ([6ad046d](https://github.com/mParticle/aquarium/commit/6ad046dfca6baac1cf638c9370c1b8d12a04db38))
...
- Storybook Testing ([#42](https://github.com/mParticle/aquarium/issues/42)) ([876c231](https://github.com/mParticle/aquarium/commit/876c23107b3f73098978b2517322fd92dbf1eadb))
- Tag component stories ([#68](https://github.com/mParticle/aquarium/issues/68)) ([4831b25](https://github.com/mParticle/aquarium/commit/4831b2593d2e217547acaebdc939e0bcc0476b6b))
...
`;function o(a){const t=i(i({h1:"h1"},s()),a.components);return c.jsxs(c.Fragment,{children:[c.jsx(t.h1,{id:"changelog",children:"CHANGELOG"}),`
`,c.jsx(f,{children:l})]})}function Q(a={}){const{wrapper:t}=i(i({},s()),a.components);return t?c.jsx(t,r(i({},a),{children:c.jsx(o,i({},a))})):o(a)}export{Q as default};
