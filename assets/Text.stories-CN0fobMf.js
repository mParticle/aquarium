import{bb as c,j as e,T as r,b as p,bd as d,aE as y,b3 as u}from"./iframe-oDjr8QHg.js";import{E as l}from"./ExampleStory-BPdl7GXa.js";import"./preload-helper-PPVm8Dsz.js";const{expect:x}=__STORYBOOK_MODULE_TEST__,h={title:"Components/General/Typography/Text",component:t=>e.jsx(r.Text,{...t,children:t.children}),args:{children:"Example Text",type:void 0,color:void 0,size:"base",code:!1,copyable:!1,delete:!1,disabled:!1,editable:!1,ellipsis:!1,mark:!1,strong:!1,italic:!1,underline:!1},argTypes:{children:{control:"text",name:"text"},type:{control:"select",options:["secondary","success","warning","danger"]},size:{control:"select",options:["base","sm","lg","xl"]},color:{control:"select",options:c},copyable:{control:"boolean"},delete:{control:"boolean"},disabled:{control:"boolean"},editable:{control:"boolean"},ellipsis:{control:"boolean"},mark:{control:"boolean"},strong:{control:"boolean"},italic:{control:"boolean"},code:{control:"boolean"}}},a={play:async t=>{const i=t.canvasElement.querySelector("span");x(i?.textContent).toEqual("Example Text")}},s={render:()=>e.jsx(l,{title:e.jsx(e.Fragment,{children:" "}),children:e.jsxs(p,{orientation:"vertical",children:[e.jsx(r.Text,{children:"Aquarium (default)"}),e.jsx(r.Text,{type:"secondary",children:"Aquarium (secondary)"}),e.jsx(r.Text,{type:"success",children:"Aquarium (success)"}),e.jsx(r.Text,{type:"warning",children:"Aquarium (warning)"}),e.jsx(r.Text,{type:"danger",children:"Aquarium (danger)"}),e.jsx(r.Text,{disabled:!0,children:"Aquarium (disabled)"}),e.jsx(r.Text,{mark:!0,children:"Aquarium (mark)"}),e.jsx(r.Text,{code:!0,children:"Aquarium (code)"}),e.jsx(r.Text,{keyboard:!0,children:"Aquarium (keyboard)"}),e.jsx(r.Text,{underline:!0,children:"Aquarium (underline)"}),e.jsx(r.Text,{delete:!0,children:"Aquarium (delete)"}),e.jsx(r.Text,{strong:!0,children:"Aquarium (strong)"}),e.jsx(r.Text,{italic:!0,children:"Aquarium (italic)"})]})})},o={render:()=>e.jsx(l,{title:e.jsx(e.Fragment,{children:" "}),children:e.jsx(p,{orientation:"vertical",children:e.jsx(r.Text,{size:"sm",color:"ColorPrimaryText",style:{paddingLeft:d},children:"Aquarium props test"})})})},n={render:()=>{const[t,i]=y.useState(!0);return e.jsxs(l,{title:"Toggle ellipsis on and off.",children:[e.jsx(u,{checked:t,onChange:()=>{i(!t)}}),e.jsx(r.Text,{style:t?{width:200}:void 0,ellipsis:t?{tooltip:"I am ellipsis now!"}:!1,children:"Ant Design, a design language for background applications, is refined by Ant UED Team."}),e.jsx(r.Text,{code:!0,style:t?{width:200}:void 0,ellipsis:t?{tooltip:"I am ellipsis now!"}:!1,children:"Ant Design, a design language for background applications, is refined by Ant UED Team."})]})}};a.parameters={...a.parameters,docs:{...a.parameters?.docs,source:{originalSource:`{
  play: async context => {
...
}`,...n.parameters?.docs?.source}}};const b=["Primary","ExampleTexts","ExampleProps","ExampleEllipsis"];export{n as ExampleEllipsis,o as ExampleProps,s as ExampleTexts,a as Primary,b as __namedExportsOrder,h as default};
