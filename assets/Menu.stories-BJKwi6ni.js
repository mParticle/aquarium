...
}`,...S.parameters?.docs?.source}}};const N=["Primary","Inline","Horizontal","MultipleSelection","CustomExpandIcon","InlineCollapsedState","Dark","CustomStyle","WithSubMenuDelay","ExampleHorizontalTop","ExampleVerticalInline","ExampleCollapsable","ExampleOpenCurrentSubmenu","ExampleVerticalMenu"],P=Object.freeze(Object.defineProperty({__proto__:null,CustomExpandIcon:u,CustomStyle:d,Dark:m,ExampleCollapsable:g,ExampleHorizontalTop:k,ExampleOpenCurrentSubmenu:h,ExampleVerticalInline:O,ExampleVerticalMenu:S,Horizontal:c,Inline:s,InlineCollapsedState:y,MultipleSelection:p,Primary:r,WithSubMenuDelay:b,__namedExportsOrder:N,default:M},Symbol.toStringTag,{value:"Module"}));export{P as M,M as m};
