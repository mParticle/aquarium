...
}`},(Vt=(Bt=D.parameters)==null?void 0:Bt.docs)==null?void 0:Vt.source)})});var Rt,_t,Yt;I.parameters=i(t({},I.parameters),{docs:i(t({},(Rt=I.parameters)==null?void 0:Rt.docs),{source:t({originalSource:`{
  render: () => {
    const [current, setCurrent] = useState(0);
    const onChange = (value: number) => {
      console.log('onChange:', value);
...
}`},(Yt=(_t=I.parameters)==null?void 0:_t.docs)==null?void 0:Yt.source)})});var Mt,$t,Ot;F.parameters=i(t({},F.parameters),{docs:i(t({},(Mt=F.parameters)==null?void 0:Mt.docs),{source:t({originalSource:`{
  render: () => {
    const description = 'This is a description.';
