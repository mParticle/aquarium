...
}`},(uo=(bo=m.parameters)==null?void 0:bo.docs)==null?void 0:uo.source)})});var Co,So,wo;p.parameters=s(d({},p.parameters),{docs:s(d({},(Co=p.parameters)==null?void 0:Co.docs),{source:d({originalSource:`{
  render: () => {
    return <>
...
}`},(wo=(So=p.parameters)==null?void 0:So.docs)==null?void 0:wo.source)})});var Bo,ko,Fo;h.parameters=s(d({},h.parameters),{docs:s(d({},(Bo=h.parameters)==null?void 0:Bo.docs),{source:d({originalSource:`{
  render: () => {
    return <>
        <h2>Text Colors</h2>
        <table style={{
...
}`},(No=(To=g.parameters)==null?void 0:To.docs)==null?void 0:No.source)})});const Do=["Primary","Semantic","Text","Borders"],Oo=Object.freeze(Object.defineProperty({__proto__:null,Borders:g,Primary:m,Semantic:p,Text:h,__namedExportsOrder:Do,default:Eo},Symbol.toStringTag,{value:"Module"}));export{g as B,Oo as C,m as P,p as S,h as T};
