...
}`},(W=(G=k.parameters)==null?void 0:G.docs)==null?void 0:W.source)})});var _,K,R;C.parameters=r(c({},C.parameters),{docs:r(c({},(_=C.parameters)==null?void 0:_.docs),{source:c({originalSource:`{
  render: () => {
...
}`},(R=(K=C.parameters)==null?void 0:K.docs)==null?void 0:R.source)})});const xe=["Primary","WithAutoFocus","DefaultChecked","Disabled","Indeterminate","ExampleCheckAll"];export{p as DefaultChecked,u as Disabled,C as ExampleCheckAll,k as Indeterminate,h as Primary,m as WithAutoFocus,xe as __namedExportsOrder,ge as default};
