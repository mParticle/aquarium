...
}`},(ae=(re=x.parameters)==null?void 0:re.docs)==null?void 0:ae.source)})});const Ee=["Primary","HorizontalDirection","WithCustomItems","ShowInkInFixed","ExampleBasic","ExampleHorizontal","ExampleAnchorStatic","ExampleOnclick","ExampleScrollOffset","ExampleLinkChange","ExampleReplaceHistory"];export{f as ExampleAnchorStatic,m as ExampleBasic,g as ExampleHorizontal,u as ExampleLinkChange,k as ExampleOnclick,x as ExampleReplaceHistory,y as ExampleScrollOffset,h as HorizontalDirection,l as Primary,d as ShowInkInFixed,p as WithCustomItems,Ee as __namedExportsOrder,Ae as default};
