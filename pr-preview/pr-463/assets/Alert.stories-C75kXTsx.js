...
}`},(L=(F=g.parameters)==null?void 0:F.docs)==null?void 0:L.source)})});var O,U,_;x.parameters=t(r({},x.parameters),{docs:t(r({},(O=x.parameters)==null?void 0:O.docs),{source:r({originalSource:`{
  args: {
    description: 'Additional content of the alert.'
  }
}`},(_=(U=x.parameters)==null?void 0:U.docs)==null?void 0:_.source)})});var M,N,P;u.parameters=t(r({},u.parameters),{docs:t(r({},(M=u.parameters)==null?void 0:M.docs),{source:r({originalSource:`{
  args: {
    action: <a style={{
      paddingLeft: '8px'
    }}>Click Me Link</a>
  }
}`},(P=(N=u.parameters)==null?void 0:N.docs)==null?void 0:P.source)})});var R,V,q;y.parameters=t(r({},y.parameters),{docs:t(r({},(R=y.parameters)==null?void 0:R.docs),{source:r({originalSource:`{
  args: {
    closeIcon: <Icon name="mpLogo" />
  }
}`},(q=(V=y.parameters)==null?void 0:V.docs)==null?void 0:q.source)})});var G,H,J;E.parameters=t(r({},E.parameters),{docs:t(r({},(G=E.parameters)==null?void 0:G.docs),{source:r({originalSource:`{
  render: () => {
    return <>
...
}`},(ne=(oe=f.parameters)==null?void 0:oe.docs)==null?void 0:ne.source)})});const ke=["Primary","Success","ErrorType","WarningBanner","Description","CustomAction","CustomCloseIcon","ExampleAllTypes","ExampleClosable","ExampleBanner","ExampleCatchError","ExampleCustomActions"];export{u as CustomAction,y as CustomCloseIcon,x as Description,d as ErrorType,E as ExampleAllTypes,T as ExampleBanner,S as ExampleCatchError,h as ExampleClosable,f as ExampleCustomActions,p as Primary,m as Success,g as WarningBanner,ke as __namedExportsOrder,ve as default};
