...
}`},(_o=(Qo=x.parameters)==null?void 0:Qo.docs)==null?void 0:_o.source)})});var Oo,Xo,qo;p.parameters=c(s({},p.parameters),{docs:c(s({},(Oo=p.parameters)==null?void 0:Oo.docs),{source:s({originalSource:`{
  render: () => {
    const semanticRows = [{
      swatch: ColorPrimary,
      name: 'Primary',
...
}`},(qo=(Xo=p.parameters)==null?void 0:Xo.docs)==null?void 0:qo.source)})});var Yo,Go,Jo;h.parameters=c(s({},h.parameters),{docs:c(s({},(Yo=h.parameters)==null?void 0:Yo.docs),{source:s({originalSource:`{
  render: () => {
    return <>
        <h2>Text Colors</h2>
        <table style={{
