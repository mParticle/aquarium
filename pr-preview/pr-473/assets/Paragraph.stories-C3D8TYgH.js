var oa=Object.defineProperty,sa=Object.defineProperties;var ia=Object.getOwnPropertyDescriptors;var W=Object.getOwnPropertySymbols;var la=Object.prototype.hasOwnProperty,ca=Object.prototype.propertyIsEnumerable;var v=(r,n,o)=>n in r?oa(r,n,{enumerable:!0,configurable:!0,writable:!0,value:o}):r[n]=o,e=(r,n)=>{for(var o in n||(n={}))la.call(n,o)&&v(r,o,n[o]);if(W)for(var o of W(n))ca.call(n,o)&&v(r,o,n[o]);return r},a=(r,n)=>sa(r,ia(n));import{j as t}from"./jsx-runtime-BcCOBRXo.js";import{d as s,I as l,R as p,m as pa,a3 as ga}from"./GlobalNavigation-CgXhFj8z.js";import{E as U}from"./ExampleStory-BX8rZA0M.js";import{r as i}from"./index-CNk6hRaE.js";import"./_baseClone-u1J3oOXU.js";import"./LightTheme-BtoaoHMG.js";import"./row-4dnY1EES.js";import"./useToken-BceXVVM_.js";import"./extends-CF3RwP-h.js";import"./Serializer-OW4gUFyn.js";import"./index-D-4E_f9W.js";import"./isNativeReflectConstruct-0c7aa-qo.js";import"./dayjs.min-KGLNs1IR.js";import"./customParseFormat-oYt9ov06.js";import"./_getPrototype-CAOE_2rY.js";const wa={title:"Components/General/Typography.Paragraph",component:r=>t.jsx(s.Paragraph,a(e({},r),{children:"Paragraph text goes here"})),args:{code:!1,copyable:!1,delete:!1,disabled:!1,editable:!1,ellipsis:!1,mark:!1,strong:!1,italic:!1,type:void 0,underline:!1,onClick:r=>{console.log("Paragraph Clicked")}},argTypes:{type:{control:"select",options:["secondary","success","warning","danger"]}}},g={},d={args:{code:!0}},u={args:{copyable:!0}},h={args:{delete:!0}},m={args:{disabled:!0}},y={args:{editable:!0}},f={args:{ellipsis:!0}},b={args:{mark:!0}},S={args:{strong:!0}},x={args:{italic:!0}},T={args:{type:"success"}},E={args:{type:"secondary"}},k={args:{type:"warning"}},C={args:{type:"danger"}},D={args:{underline:!0}},P={args:{onClick:r=>{alert("Custom Click Handler")}}},A={render:()=>{const[r,n]=i.useState("This is an editable text."),[o,L]=i.useState("This is a loooooooooooooooooooooooooooooooong editable text with suffix."),[ze,Fe]=i.useMemo(()=>[o.slice(0,-12),o.slice(-12)],[o]),[Ye,_e]=i.useState("Custom Edit icon and replace tooltip text."),[$e,Be]=i.useState("Text or icon as trigger - click to start editing."),[c,Je]=i.useState(["icon"]),[Ke,Qe]=i.useState("Editable text with a custom enter icon in edit field."),[Ve,Xe]=i.useState("Editable text with no enter icon in edit field."),[Ze,ea]=i.useState("Hide Edit tooltip."),[aa,ta]=i.useState("This is an editable text with limited length."),ra=R=>{switch(R){case"text":return["text"];case"both":return["icon","text"];case"icon":default:return["icon"]}},na=i.useMemo(()=>c.includes("text")?c.includes("icon")?"both":"text":"icon",[c]);return t.jsxs(U,{title:"Make Typography editable.",children:[t.jsx(s.Paragraph,{editable:{onChange:n},children:r}),t.jsx(s.Paragraph,{editable:{onChange:L,text:o},ellipsis:{suffix:Fe},children:ze}),t.jsx(s.Paragraph,{editable:{icon:t.jsx(l,{name:"mpLogo"}),tooltip:"click to edit text",onChange:_e},children:Ye}),"Trigger edit with:"," ",t.jsxs(p.Group,{onChange:R=>{Je(ra(R.target.value))},value:na,children:[t.jsx(p,{value:"icon",children:"icon"}),t.jsx(p,{value:"text",children:"text"}),t.jsx(p,{value:"both",children:"both"})]}),t.jsx(s.Paragraph,{editable:{tooltip:"click to edit text",onChange:Be,triggerType:c},children:$e}),t.jsx(s.Paragraph,{editable:{icon:t.jsx(l,{name:"mpLogo"}),tooltip:"click to edit text",onChange:Qe,enterIcon:t.jsx(l,{name:"mpLogo"})},children:Ke}),t.jsx(s.Paragraph,{editable:{icon:t.jsx(l,{name:"mpLogo"}),tooltip:"click to edit text",onChange:Xe,enterIcon:null},children:Ve}),t.jsx(s.Paragraph,{editable:{tooltip:!1,onChange:ea},children:Ze}),t.jsx(s.Paragraph,{editable:{onChange:ta,maxLength:50,autoSize:{maxRows:5,minRows:3}},children:aa})]})}},w={render:()=>t.jsxs(U,{title:"Make Typography copyable.",children:[t.jsx(s.Paragraph,{copyable:!0,children:"This is a copyable text."}),t.jsx(s.Paragraph,{copyable:{text:"Hello, Ant Design!"},children:"Replace copy text."}),t.jsx(s.Paragraph,{copyable:{icon:[t.jsx(l,{name:"mpLogo"},1),t.jsx(l,{name:"mpLogo"},2)],tooltips:["click here","you clicked!!"]},children:"Custom Copy icon and replace tooltips text."}),t.jsx(s.Paragraph,{copyable:{tooltips:!1},children:"Hide Copy tooltips."})]})},j={render:()=>{const[r,n]=i.useState(!0);return t.jsxs(U,{title:"Multiple line ellipsis support. You can use tooltip to config ellipsis tooltip. Recommend expandable when have lots of content.",children:[t.jsx(pa,{checked:r,onChange:()=>{n(!r)}}),t.jsx(s.Paragraph,{ellipsis:r,children:"Ant Design, a design language for background applications, is refined by Ant UED Team. Ant Design, a design language for background applications, is refined by Ant UED Team. Ant Design, a design language for background applications, is refined by Ant UED Team. Ant Design, a design language for background applications, is refined by Ant UED Team. Ant Design, a design language for background applications, is refined by Ant UED Team. Ant Design, a design language for background applications, is refined by Ant UED Team."}),t.jsx(s.Paragraph,{ellipsis:r?{rows:2,expandable:!0,symbol:"more"}:!1,children:"Ant Design, a design language for background applications, is refined by Ant UED Team. Ant Design, a design language for background applications, is refined by Ant UED Team. Ant Design, a design language for background applications, is refined by Ant UED Team. Ant Design, a design language for background applications, is refined by Ant UED Team. Ant Design, a design language for background applications, is refined by Ant UED Team. Ant Design, a design language for background applications, is refined by Ant UED Team."})]})}},I={render:()=>{const[r,n]=i.useState(1),o="To be, or not to be, that is a question: Whether it is nobler in the mind to suffer. The slings and arrows of outrageous fortune Or to take arms against a sea of troubles, And by opposing end them? To die: to sleep; No more; and by a sleep to say we end The heart-ache and the thousand natural shocks That flesh is heir to, 'tis a consummation Devoutly to be wish'd. To die, to sleep To sleep- perchance to dream: ay, there's the rub! For in that sleep of death what dreams may come When we have shuffled off this mortal coil, Must give us pause. There 's the respect That makes calamity of so long life";return t.jsxs(U,{title:"Add suffix ellipsis support.",children:[t.jsx(ga,{value:r,min:1,max:10,onChange:n}),t.jsx(s.Paragraph,{ellipsis:{rows:r,expandable:!0,suffix:"--William Shakespeare",onEllipsis:L=>{console.log("Ellipsis changed:",L)}},title:`${o}--William Shakespeare`,children:o})]})}};var M,H,N;g.parameters=a(e({},g.parameters),{docs:a(e({},(M=g.parameters)==null?void 0:M.docs),{source:e({originalSource:"{}"},(N=(H=g.parameters)==null?void 0:H.docs)==null?void 0:N.source)})});var O,G,q;d.parameters=a(e({},d.parameters),{docs:a(e({},(O=d.parameters)==null?void 0:O.docs),{source:e({originalSource:`{
  args: {
    code: true
  }
...
}`},(Y=(F=u.parameters)==null?void 0:F.docs)==null?void 0:Y.source)})});var _,$,B;h.parameters=a(e({},h.parameters),{docs:a(e({},(_=h.parameters)==null?void 0:_.docs),{source:e({originalSource:`{
  args: {
    delete: true
  }
}`},(B=($=h.parameters)==null?void 0:$.docs)==null?void 0:B.source)})});var J,K,Q;m.parameters=a(e({},m.parameters),{docs:a(e({},(J=m.parameters)==null?void 0:J.docs),{source:e({originalSource:`{
  args: {
    disabled: true
  }
...
}`},(te=(ae=f.parameters)==null?void 0:ae.docs)==null?void 0:te.source)})});var re,ne,oe;b.parameters=a(e({},b.parameters),{docs:a(e({},(re=b.parameters)==null?void 0:re.docs),{source:e({originalSource:`{
  args: {
    mark: true
  }
}`},(oe=(ne=b.parameters)==null?void 0:ne.docs)==null?void 0:oe.source)})});var se,ie,le;S.parameters=a(e({},S.parameters),{docs:a(e({},(se=S.parameters)==null?void 0:se.docs),{source:e({originalSource:`{
  args: {
    strong: true
  }
