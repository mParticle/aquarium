import{j as e,aJ as r,I as c,aE as b,F as S,aH as u,b as h}from"./iframe-B82bSDB8.js";import{E as x}from"./ExampleStory-CVG_IV6V.js";import"./preload-helper-PPVm8Dsz.js";const{userEvent:f}=__STORYBOOK_MODULE_TEST__,{expect:T}=__STORYBOOK_MODULE_TEST__,v={title:"Components/Not Prod Ready/Data Display/Tag",component:o=>e.jsx(r,{...o,children:"Tag"}),args:{closeIcon:!1,color:"",icon:null,bordered:!0,onClose:o=>{alert("Tag Closed")}}},n={},s={args:{closeIcon:!0}},t={args:{color:"#3498db"}},l={args:{icon:e.jsx(c,{name:"mpLogo"})}},i={args:{bordered:!1}},g={args:{closeIcon:!0,onClose:o=>{alert("Tag Closed")}}},d={render:()=>{const[o,a]=b.useState(!0);return e.jsx(e.Fragment,{children:e.jsx(x,{title:"Basic checkable usage",children:e.jsx(S,{justify:"center",children:e.jsx(r.CheckableTag,{checked:o,bordered:!0,onChange:j=>{alert(`Tag ${j?"Checked":"Unchecked"}`),a(k=>!k)},children:"Tag"})})})})},play:async o=>{const a=o.canvasElement.querySelector(".ant-tag.ant-tag-checkable");if(a)T(a).not.toBeNull(),T(a.classList.contains("ant-tag-checkable-checked")).toBeTruthy(),await f.click(a),T(a.classList.contains("ant-tag-checkable-checked")).toBeFalsy();else throw new Error("Tag not found")}},p={render:()=>e.jsx(e.Fragment,{children:e.jsxs(x,{title:"Available colors",children:[e.jsx(u,{titlePlacement:"left",children:"Presets"}),e.jsxs(h,{size:[0,8],wrap:!0,children:[e.jsx(r,{color:"magenta",children:"magenta"}),e.jsx(r,{color:"red",children:"red"}),e.jsx(r,{color:"volcano",children:"volcano"}),e.jsx(r,{color:"orange",children:"orange"}),e.jsx(r,{color:"gold",children:"gold"}),e.jsx(r,{color:"lime",children:"lime"}),e.jsx(r,{color:"green",children:"green"}),e.jsx(r,{color:"cyan",children:"cyan"}),e.jsx(r,{color:"blue",children:"blue"}),e.jsx(r,{color:"geekblue",children:"geekblue"}),e.jsx(r,{color:"purple",children:"purple"})]}),e.jsx(u,{titlePlacement:"left",children:"Custom"}),e.jsxs(h,{size:[0,8],wrap:!0,children:[e.jsx(r,{color:"#f50",children:"#f50"}),e.jsx(r,{color:"#2db7f5",children:"#2db7f5"}),e.jsx(r,{color:"#87d068",children:"#87d068"}),e.jsx(r,{color:"#108ee9",children:"#108ee9"})]})]})})},m={render:()=>e.jsx(e.Fragment,{children:e.jsxs(x,{title:"Basic status tags",children:[e.jsx(u,{titlePlacement:"left",children:"Without icon"}),e.jsxs(h,{size:[0,8],wrap:!0,children:[e.jsx(r,{color:"success",children:"success"}),e.jsx(r,{color:"processing",children:"processing"}),e.jsx(r,{color:"error",children:"error"}),e.jsx(r,{color:"warning",children:"warning"}),e.jsx(r,{color:"default",children:"default"})]}),e.jsx(u,{titlePlacement:"left",children:"With icon"}),e.jsxs(h,{size:[0,8],wrap:!0,children:[e.jsx(r,{icon:e.jsx(c,{name:"mpLogo"}),color:"success",children:"success"}),e.jsx(r,{icon:e.jsx(c,{name:"mpLogo"}),color:"processing",children:"processing"}),e.jsx(r,{icon:e.jsx(c,{name:"mpLogo"}),color:"error",children:"error"}),e.jsx(r,{icon:e.jsx(c,{name:"mpLogo"}),color:"warning",children:"warning"})]})]})})};n.parameters={...n.parameters,docs:{...n.parameters?.docs,source:{originalSource:"{}",...n.parameters?.docs?.source}}};s.parameters={...s.parameters,docs:{...s.parameters?.docs,source:{originalSource:`{
  args: {
    closeIcon: true
  }
...
}`,...m.parameters?.docs?.source}}};const w=["Primary","WithCloseIcon","WithColor","WithIcon","WithoutBorder","WithOnCloseCallback","ExampleCheckableTagPrimary","ExampleColors","ExampleStatusTags"];export{d as ExampleCheckableTagPrimary,p as ExampleColors,m as ExampleStatusTags,n as Primary,s as WithCloseIcon,t as WithColor,l as WithIcon,g as WithOnCloseCallback,i as WithoutBorder,w as __namedExportsOrder,v as default};
