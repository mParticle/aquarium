import{j as e,cs as t,I as T,G as y}from"./iframe-DwkImtFk.js";import{E as o}from"./ExampleStory-DcHspWVF.js";import"./preload-helper-PPVm8Dsz.js";const k={title:"Experimental/Navigation/Pagination",component:t,args:{current:1,defaultCurrent:1,defaultPageSize:10,disabled:!1,hideOnSinglePage:!1,itemRender:(r,a,s)=>a==="page"?e.jsx("a",{children:r}):s,pageSize:10,pageSizeOptions:[10,20,50,100],responsive:!1,showLessItems:!1,showQuickJumper:!1,showSizeChanger:!1,showTitle:!0,showTotal:(r,a)=>`Total ${r} items`,simple:!1,size:"middle",total:27,onChange:(r,a)=>{alert(`Page changed to ${r}, Page Size: ${a}`)},onShowSizeChange:(r,a)=>{alert(`Page Size changed to ${a}, Current Page: ${r}`)}}},i={},l={args:{size:"small"}},u={args:{responsive:!0}},m={args:{showQuickJumper:{goButton:e.jsx(T,{name:"alicorn"})}}},c={args:{showSizeChanger:!0,total:60}},p={args:{simple:!0}},g={args:{showLessItems:!0}},d={args:{showTotal:(r,a)=>`Showing ${a[0]}-${a[1]} of ${r} items`}},h={render:()=>e.jsx(o,{title:"Basic pagination.",children:e.jsx(t,{defaultCurrent:1,total:50})})},S={render:()=>e.jsx(o,{title:"More Pages.",children:e.jsx(t,{defaultCurrent:6,total:500})})},x={render:()=>{const r=(a,s)=>{console.log(a,s)};return e.jsxs(o,{title:"Change pageSize.",children:[e.jsx(t,{showSizeChanger:!0,onShowSizeChange:r,defaultCurrent:3,total:500}),e.jsx("br",{}),e.jsx(t,{showSizeChanger:!0,onShowSizeChange:r,defaultCurrent:3,total:500,disabled:!0})]})}},C={render:()=>{const r=a=>{console.log("Page: ",a)};return e.jsxs(o,{title:"Jump to a page directly.",children:[e.jsx(t,{showQuickJumper:!0,defaultCurrent:2,total:500,onChange:r}),e.jsx("br",{}),e.jsx(t,{showQuickJumper:!0,defaultCurrent:2,total:500,onChange:r,disabled:!0})]})}},w={render:()=>{const r=a=>`Total ${a} items`;return e.jsxs(o,{title:"Mini size pagination.",children:[e.jsx(t,{size:"small",total:50}),e.jsx(t,{size:"small",total:50,showSizeChanger:!0,showQuickJumper:!0}),e.jsx(t,{size:"small",total:50,showTotal:r}),e.jsx(t,{size:"small",total:50,disabled:!0,showTotal:r,showSizeChanger:!0,showQuickJumper:!0})]})}},P={render:()=>e.jsxs(o,{title:"Simple mode.",children:[e.jsx(t,{simple:!0,defaultCurrent:2,total:50}),e.jsx("br",{}),e.jsx(t,{disabled:!0,simple:!0,defaultCurrent:2,total:50})]})},z={render:()=>{const[r,a]=y.useState(3),s=n=>{console.log(n),a(n)};return e.jsx(o,{title:"Controlled page number.",children:e.jsx(t,{current:r,onChange:s,total:50})})}},f={render:()=>e.jsxs(o,{title:"You can show the total number of data by setting showTotal.",children:[e.jsx(t,{total:85,showTotal:r=>`Total ${r} items`,defaultPageSize:20,defaultCurrent:1}),e.jsx("br",{}),e.jsx(t,{total:85,showTotal:(r,a)=>`${a[0]}-${a[1]} of ${r} items`,defaultPageSize:20,defaultCurrent:1})]})},E={render:()=>e.jsx(o,{title:"Show all configured prop.",children:e.jsx(t,{total:85,showSizeChanger:!0,showQuickJumper:!0,showTotal:r=>`Total ${r} items`})})},j={render:()=>{const r=(a,s,n)=>s==="prev"?e.jsx("a",{children:"Previous"}):s==="next"?e.jsx("a",{children:"Next"}):n;return e.jsx(o,{title:"Use text link for prev and next button.",children:e.jsx(t,{total:500,itemRender:r})})}};i.parameters={...i.parameters,docs:{...i.parameters?.docs,source:{originalSource:"{}",...i.parameters?.docs?.source}}};l.parameters={...l.parameters,docs:{...l.parameters?.docs,source:{originalSource:`{
  args: {
    size: 'small'
  }
