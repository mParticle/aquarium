...
`,Q={title:"Components/General/Icons",component:g,argTypes:{size:{control:"select",options:B},color:{control:"select",options:H},variant:{control:"select",options:Object.values(b)}},parameters:{docs:{description:{component:Y}}}};g.parameters={...g.parameters,docs:{...g.parameters?.docs,source:{originalSource:`({
  color = 'black',
  size = 'lg',
  name,
  variant
...
}`,...g.parameters?.docs?.source}}};const W=["IconTable"];export{g as IconTable,W as __namedExportsOrder,Q as default};
