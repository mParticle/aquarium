    ...
    return <>
        <ExampleStory title="With close button">
          ...
          width: '100%'
            ...
            <Alert message="Warning Text Warning Text Warning TextW arning Text Warning Text Warning TextWarning Text" type="warning" closable onClose={_e => {
            alert('closed');
          }} />
            <Alert message="Error Text" description="Error Description Error Description Error Description Error Description Error Description Error Description" type="error" closable onClose={_e => {
            alert('closed');
          }} />
          </Space>
        </ExampleStory>
