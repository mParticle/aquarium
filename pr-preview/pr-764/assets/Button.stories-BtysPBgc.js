...
}`,...D.parameters?.docs?.source}}};const V=["Playground","LinkUsageNote","Primary","PrimaryWithIcon","Default","DefaultWithIcon","Dashed","DashedWithIcon","Link","LinkWithIcon","Text","Danger","Loading","LoadingText","TypesOverview","DarkButton","IconTypesOverview","SizeExamples","IconOnly","Refresh","With2Options","ButtonsWithLocalIcons","ButtonsWithUntitledUIIcons","WithUntitledUIIcons"],Y=Object.freeze(Object.defineProperty({__proto__:null,ButtonsWithLocalIcons:v,ButtonsWithUntitledUIIcons:L,Danger:f,DarkButton:z,Dashed:u,DashedWithIcon:y,Default:p,DefaultWithIcon:m,IconOnly:S,IconTypesOverview:I,Link:h,LinkUsageNote:c,LinkWithIcon:g,Loading:j,LoadingText:B,Playground:i,Primary:l,PrimaryWithIcon:d,Refresh:b,SizeExamples:k,Text:x,TypesOverview:T,With2Options:w,WithUntitledUIIcons:D,__namedExportsOrder:V,default:X},Symbol.toStringTag,{value:"Module"}));export{Y as B,z as D,I,c as L,i as P,b as R,k as S,T,w as W,S as a,v as b,L as c,j as d,B as e,f};
