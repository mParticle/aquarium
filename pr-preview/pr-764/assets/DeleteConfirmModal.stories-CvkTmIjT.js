import{c3 as r,aG as p,j as e,bI as T,c4 as h,bf as y,ai as u,k as g,T as m,b9 as j,I as C,bV as D}from"./iframe-DtNK1CB8.js";const I={title:"Components/feedback/Modal/Delete Confirm Modal",component:r,args:{}},k=()=>{const[a,t]=p.useState(!1),i=({key:l})=>{l==="delete"?t(!0):console.log("Menu item clicked:",l)},c=()=>{t(!1),D.success("Item deleted successfully")},d=()=>{t(!1)},x={menu:{items:[{key:"edit",label:"Edit"},{key:"duplicate",label:"Duplicate"},{key:"archive",label:"Archive"},{key:"delete",label:"Delete",danger:!0}],onClick:i}},f=[{key:"1",name:"Item Name",type:"Item Type",category:"Category A",createdBy:"John Doe",actions:e.jsx(j,{...x,placement:"bottom",children:e.jsx("a",{onClick:l=>l.preventDefault(),children:e.jsx(C,{name:"moreActions",size:"lg",color:"default"})})})}],b=[{title:"Name",dataIndex:"name",key:"name",width:"200px"},{title:"Type",dataIndex:"type",key:"type",width:"150px"},{title:"Category",dataIndex:"category",key:"category",width:"150px"},{title:"Created by",dataIndex:"createdBy",key:"createdBy",width:"150px"},{title:"Actions",dataIndex:"actions",key:"actions",align:"center",width:"100px"}];return e.jsxs(e.Fragment,{children:[e.jsxs("div",{children:[e.jsx(T,{columns:b,dataSource:f,pagination:!1,size:"middle",className:"no-hover-table"}),e.jsx("style",{children:`
