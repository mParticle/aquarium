var ge=Object.defineProperty,xe=Object.defineProperties;var he=Object.getOwnPropertyDescriptors;var U=Object.getOwnPropertySymbols;var je=Object.prototype.hasOwnProperty,ve=Object.prototype.propertyIsEnumerable;var C=(o,t,n)=>t in o?ge(o,t,{enumerable:!0,configurable:!0,writable:!0,value:n}):o[t]=n,a=(o,t)=>{for(var n in t||(t={}))je.call(t,n)&&C(o,n,t[n]);if(U)for(var n of U(t))ve.call(t,n)&&C(o,n,t[n]);return o},s=(o,t)=>xe(o,he(t));import{j as e}from"./jsx-runtime-CVnACwZl.js";import{r as f}from"./index-3OP4wdng.js";import{A as r,I as c,b as l,B as b,f as L}from"./NavigationItemsService-hPiWu-lO.js";import"./WarningStateIcon-Branp5bh.js";import"./_baseClone-CXAe4HsA.js";import{E as p}from"./ExampleStory-9NiuP4Ld.js";import"./LightTheme-BtoaoHMG.js";import"./row-Bsm_WxsR.js";import"./Context-R5ee3nrF.js";import"./useToken-C_i1q6Gz.js";import"./presets-BrZHayqo.js";import"./extends-CF3RwP-h.js";import"./index-B-gr4m3q.js";import"./isNativeReflectConstruct-CWIsGhkf.js";const Be={title:"Components/Not Prod Ready/Data Display/Avatar",component:r,args:{alt:"Avatar",gap:4,icon:e.jsx(c,{name:"alicorn",size:"lg",color:"white"}),shape:"circle",size:"default",src:void 0,srcSet:void 0,draggable:!0,crossOrigin:"",onError:()=>!0},argTypes:{crossOrigin:{control:"select",options:["anonymous","use-credentials",""]},shape:{control:"select",options:["circle","square"]},draggable:{control:"select",options:[!0,!1,"true","false"]},icon:{control:"select",options:["Users","Sparkles"],mapping:{Users:e.jsx(c,{name:"users"}),Sparkles:e.jsx(c,{name:"predictions",variant:"duo-tone"})}}}},d={},m={args:{shape:"square"}},u={args:{size:"large"}},g={args:{size:"small"}},x={args:{size:{xs:24,sm:32,md:40,lg:64,xl:80,xxl:120}}},h={args:{icon:"Sparkles"}},j={render:()=>e.jsx(p,{title:"Four sizes and two shapes are available.",children:e.jsxs(l,{direction:"vertical",size:16,children:[e.jsxs(l,{wrap:!0,size:16,children:[e.jsx(r,{size:64,icon:e.jsx(c,{name:"alicorn"})}),e.jsx(r,{size:"large",icon:e.jsx(c,{name:"alicorn"})}),e.jsx(r,{icon:e.jsx(c,{name:"alicorn"})}),e.jsx(r,{size:"small",icon:e.jsx(c,{name:"alicorn"})})]}),e.jsxs(l,{wrap:!0,size:16,children:[e.jsx(r,{shape:"square",size:64,icon:e.jsx(c,{name:"alicorn"})}),e.jsx(r,{shape:"square",size:"large",icon:e.jsx(c,{name:"alicorn"})}),e.jsx(r,{shape:"square",icon:e.jsx(c,{name:"alicorn"})}),e.jsx(r,{shape:"square",size:"small",icon:e.jsx(c,{name:"alicorn"})})]})]})})},v={render:()=>{const o="https://gw.alipayobjects.com/zos/rmsportal/KDpgvguMpGfqaHPjicRK.svg";return e.jsx(p,{title:"Image, Icon and letter are supported, and the latter two kinds of avatar can have custom colors and background colors.",children:e.jsxs(l,{size:16,wrap:!0,children:[e.jsx(r,{icon:e.jsx(c,{name:"alicorn"})}),e.jsx(r,{children:"U"}),e.jsx(r,{size:40,children:"USER"}),e.jsx(r,{src:o}),e.jsx(r,{src:e.jsx("img",{src:o,alt:"avatar"})}),e.jsx(r,{style:{backgroundColor:"#fde3cf",color:"#f56a00"},children:"U"}),e.jsx(r,{style:{backgroundColor:"#87d068"},icon:e.jsx(c,{name:"alicorn"})})]})})}},z={render:()=>e.jsx(p,{title:"Usually used for reminders and notifications.",children:e.jsxs(l,{size:24,children:[e.jsx(b,{count:1,children:e.jsx(r,{shape:"square",icon:e.jsx(c,{name:"alicorn"})})}),e.jsx(b,{dot:!0,children:e.jsx(r,{shape:"square",icon:e.jsx(c,{name:"alicorn"})})})]})})},S={render:()=>e.jsx(p,{title:"Avatar size can be automatically adjusted based on the screen size.",children:e.jsx(r,{size:{xs:24,sm:32,md:40,lg:64,xl:80,xxl:100},icon:e.jsx(c,{name:"alicorn"})})})},y={render:()=>{const o=["Edward","U","Lucy","Tom"],t=["#f56a00","#7265e6","#ffbf00","#00a2ae"],n=[4,3,2,1],[A,ie]=f.useState(o[0]),[le,pe]=f.useState(t[0]),[E,de]=f.useState(n[0]),me=()=>{const i=o.indexOf(A);ie(i<o.length-1?o[i+1]:o[0]),pe(i<t.length-1?t[i+1]:t[0])},ue=()=>{const i=n.indexOf(E);de(i<n.length-1?n[i+1]:n[0])};return e.jsxs(p,{title:"For letter type Avatar, when the letters are too long to display, the font size can be automatically adjusted according to the width of the Avatar. You can also use gap to set the unit distance between left and right sides.",children:[e.jsx(r,{style:{backgroundColor:le,verticalAlign:"middle"},size:"large",gap:E,children:A}),e.jsx(L,{size:"small",style:{margin:"0 16px",verticalAlign:"middle"},onClick:me,children:"ChangeUser"}),e.jsx(L,{size:"small",style:{verticalAlign:"middle"},onClick:ue,children:"changeGap"})]})}};var w,I,q;d.parameters=s(a({},d.parameters),{docs:s(a({},(w=d.parameters)==null?void 0:w.docs),{source:a({originalSource:"{}"},(q=(I=d.parameters)==null?void 0:I.docs)==null?void 0:q.source)})});var k,G,B;m.parameters=s(a({},m.parameters),{docs:s(a({},(k=m.parameters)==null?void 0:k.docs),{source:a({originalSource:`{
  args: {
    shape: 'square'
  }
...
}`},(ae=(ee=z.parameters)==null?void 0:ee.docs)==null?void 0:ae.source)})});var se,re,oe;S.parameters=s(a({},S.parameters),{docs:s(a({},(se=S.parameters)==null?void 0:se.docs),{source:a({originalSource:`{
  render: () => {
...
}`},(oe=(re=S.parameters)==null?void 0:re.docs)==null?void 0:oe.source)})});var te,ne,ce;y.parameters=s(a({},y.parameters),{docs:s(a({},(te=y.parameters)==null?void 0:te.docs),{source:a({originalSource:`{
  render: () => {
...
}`},(ce=(ne=y.parameters)==null?void 0:ne.docs)==null?void 0:ce.source)})});const Re=["Primary","Square","Large","Small","CustomSizes","CustomIcon","ExampleBasic","ExampleTypes","ExampleWithBadge","ExampleResponsive","ExampleAutosetFontSize"];export{h as CustomIcon,x as CustomSizes,y as ExampleAutosetFontSize,j as ExampleBasic,S as ExampleResponsive,v as ExampleTypes,z as ExampleWithBadge,u as Large,d as Primary,g as Small,m as Square,Re as __namedExportsOrder,Be as default};
