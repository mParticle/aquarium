import{j as e,aB as g,i as r,p as u,ac as m,ae as h,F as f,$ as y,T as p,aC as o}from"./iframe-FEOso3HU.js";const x={title:"Components/Feedback/Notification",component:g,args:{type:"info",children:e.jsx(r,{type:"primary",children:"Show Notification"}),message:"Message",description:"Description goes here",duration:0,placement:"topRight"},argTypes:{type:{control:"select",options:["info","warning","success","error"]}}},t={render:()=>e.jsx("div",{style:{padding:"1px",background:"linear-gradient(135deg, rgba(0, 0, 0, 0.06) 0%, rgba(0, 0, 0, 0.12) 100%)",borderRadius:u,width:"100%"},children:e.jsx(m,{message:e.jsxs(f,{align:"center",gap:y,children:[e.jsx(p.Text,{size:"xl",children:"💡"}),e.jsxs(p.Text,{size:"base",children:["Use a"," ",e.jsx(p.Link,{href:"?path=/docs/components-feedback-message--docs",color:"ColorText",children:"Message"})," ","for brief, auto-dismissing feedback. Use an"," ",e.jsx(p.Link,{href:"?path=/docs/components-feedback-alert--docs",color:"ColorText",children:"Alert"})," ","for persistent inline messages that are part of the page."]})]}),showIcon:!1,type:"info",style:{backgroundColor:h,border:"none",borderRadius:u,width:"100%",marginBottom:0}})})},a={name:"Action Success",render:()=>{const n=()=>{o.success({message:"Configuration saved",description:"Your changes have been applied and are now active.",duration:3})};return e.jsx(r,{onClick:n,children:"Save Configuration"})}},s={name:"Action Error",render:()=>{const n=()=>{o.error({message:"Failed to save",description:"An error occurred while saving your changes. Please try again.",duration:0})};return e.jsx(r,{onClick:n,children:"Trigger Error"})}},i={name:"Action Warning",render:()=>{const n=()=>{o.warning({message:"Review required",description:"Some settings may affect existing data. Review before continuing.",duration:3})};return e.jsx(r,{onClick:n,children:"Trigger Warning"})}},c={name:"Action Info",render:()=>{const n=()=>{o.info({message:"New update available",description:"A new version is available. Refresh the page to get the latest features.",duration:3})};return e.jsx(r,{onClick:n,children:"Show Info"})}},d={name:"With Action Button",render:()=>{const n=()=>{o.success({message:"Export complete",description:"Your data export is ready to download.",duration:0,btn:e.jsx(r,{size:"small",type:"primary",children:"Download"})})};return e.jsx(r,{onClick:n,children:"Export Data"})}},l={name:"Title Only",render:()=>{const n=()=>{o.success({message:"Profile updated",duration:3})};return e.jsx(r,{onClick:n,children:"Update Profile"})}};t.parameters={...t.parameters,docs:{...t.parameters?.docs,source:{originalSource:`{
  render: () => {
    return <div style={{
      padding: '1px',
...
}`,...l.parameters?.docs?.source}}};const b=["StorybookNote","ActionSuccess","ActionError","ActionWarning","ActionInfo","WithActionButton","TitleOnly"],T=Object.freeze(Object.defineProperty({__proto__:null,ActionError:s,ActionInfo:c,ActionSuccess:a,ActionWarning:i,StorybookNote:t,TitleOnly:l,WithActionButton:d,__namedExportsOrder:b,default:x},Symbol.toStringTag,{value:"Module"}));export{T as N,x as m};
