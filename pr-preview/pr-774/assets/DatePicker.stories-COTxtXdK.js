import{b7 as D,j as s,aP as m,b8 as b,aY as g}from"./iframe-BPPWs4QB.js";const t=()=>{const[u,l]=m.useState(null),i=e=>e&&e.year()<2023,y=e=>{const a=Array.isArray(e)?e[0]:e;a&&i(a)?l(null):l(a)},p=(e,a)=>{if(!b.isDayjs(e))return a.originNode;const c=i(e),o=d=>{c&&(d.preventDefault(),d.stopPropagation())};return a.type==="year"&&c?s.jsx(g,{title:"Data is only available for years 2023 and onwards.",children:s.jsx("div",{className:"ant-picker-cell-inner",style:{color:"rgba(0, 0, 0, 0.25)",cursor:"not-allowed"},onClick:o,onMouseDown:o,onKeyDown:o,children:e.year()})}):a.originNode};return s.jsx(D,{picker:"year",cellRender:p,value:u,onChange:y})},f={title:"Components/Data Entry/Date Picker",component:D,args:{}},n={},r={render:()=>s.jsx(t,{})};r.parameters={docs:{source:{code:`
