...
`,De={title:"Components/General/Icons",component:g,argTypes:{size:{control:"select",options:ie},color:{control:"select",options:se},variant:{control:"select",options:Object.values(D)}},parameters:{docs:{description:{component:ce}}}};var z,k,U;g.parameters=_(y({},g.parameters),{docs:_(y({},(z=g.parameters)==null?void 0:z.docs),{source:y({originalSource:`({
  color = 'black',
  size = 'lg',
  name,
  variant
...
}`},(U=(k=g.parameters)==null?void 0:k.docs)==null?void 0:U.source)})});const je=["IconTable"];export{g as IconTable,je as __namedExportsOrder,De as default};
