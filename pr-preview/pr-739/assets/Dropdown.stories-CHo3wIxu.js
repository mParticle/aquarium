...
}`,...A.parameters?.docs?.source}}};const K=["Primary","WithArrow","Disabled","CustomDropdownRender","AutoAdjustOverflow","DestroyPopupOnHide","WithOverlayStyle","CustomPlacement","TriggerClick","OpenDropdown","OnOpenChangeCallback","ExampleBasic","ExamplePlacement","ExampleArrow","ExampleArrowCenter","ExampleClickEvent","ExampleCustomDropdown","ExampleClosingMenu","ExampleLoading","ExampleSelectable","ExampleContextMenu","ExampleNested","ExampleButtons","ExampleContainerDivider"],q=Object.freeze(Object.defineProperty({__proto__:null,AutoAdjustOverflow:g,CustomDropdownRender:b,CustomPlacement:x,DestroyPopupOnHide:y,Disabled:w,ExampleArrow:B,ExampleArrowCenter:v,ExampleBasic:C,ExampleButtons:M,ExampleClickEvent:E,ExampleClosingMenu:L,ExampleContainerDivider:A,ExampleContextMenu:O,ExampleCustomDropdown:R,ExampleLoading:_,ExampleNested:T,ExamplePlacement:D,ExampleSelectable:P,OnOpenChangeCallback:S,OpenDropdown:j,Primary:p,TriggerClick:f,WithArrow:h,WithOverlayStyle:k,__namedExportsOrder:K,default:Y},Symbol.toStringTag,{value:"Module"}));export{q as D,Y as m};
