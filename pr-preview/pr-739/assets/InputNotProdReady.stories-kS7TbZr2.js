import{aQ as v,aG as w,j as r,b,k as S}from"./iframe-iQbfxH-7.js";import{E as C}from"./ExampleStory-Bt-q1UT5.js";import"./preload-helper-PPVm8Dsz.js";const{expect:y,userEvent:B}=__STORYBOOK_MODULE_TEST__,j={title:"Components/Not Prod Ready/Data Entry/Input",component:v,args:{placeholder:"Input Placeholder",addonAfter:void 0,addonBefore:void 0,allowClear:!1,bordered:!0,classNames:{},count:void 0,defaultValue:"",disabled:!1,id:void 0,maxLength:void 0,prefix:void 0,showCount:!1,status:void 0,styles:{},size:"middle",suffix:void 0,type:"text",value:"",onChange:e=>{console.log("Input changed: "+e.target.value)},onPressEnter:e=>{console.log("Enter key pressed: "+String(e))}},argTypes:{status:{control:"select",options:["warning","error"]},size:{control:"select",options:["small","medium","large"]}}},o={args:{status:"error"}},n={args:{type:"textarea"}},c={args:{size:"large"}},l={args:{size:"middle"}},u={args:{size:"small"}},i={},p={args:{addonBefore:"https://",placeholder:"Enter URL"}},d={args:{addonAfter:".com",placeholder:"Domain"}},m={args:{allowClear:!0,placeholder:"Clearable Input"}},g={args:{disabled:!0}},f={args:{maxLength:10,placeholder:"Max 10 characters"}},h={args:{prefix:"@",suffix:".com",placeholder:"Email"}},x={args:{value:"Test value"},render:(e,a)=>{const t=w.useRef(null),s=(E="start")=>{t.current?.focus({cursor:E})};return r.jsx(C,{title:a.name,children:r.jsxs(b,{orientation:"vertical",style:{width:"100%"},children:[r.jsxs(b,{wrap:!0,children:[r.jsx(S,{onClick:()=>{s("start")},children:"Focus at start"}),r.jsx(S,{onClick:()=>{s("end")},children:"Focus at last"}),r.jsx(S,{onClick:()=>{s("all")},children:"Focus to select all"})]}),r.jsx("br",{}),r.jsx(v,{...e,defaultValue:"Welcome to the Aquarium",ref:t})]})})},play:async e=>{const a=e.canvasElement.querySelector("input");await y(a).toBeInTheDocument();const t=e.canvasElement.querySelectorAll("button");await y(t.length).toBe(3);for(const s of t)a?.blur(),await B.click(s),await y(a).toHaveFocus(),a?.blur()}};o.parameters={...o.parameters,docs:{...o.parameters?.docs,source:{originalSource:`{
  args: {
    status: 'error'
  }
