import{c6 as t}from"./iframe-D4RU3iDc.js";const l={title:"UX Patterns/MoreActionsButton",component:t,parameters:{layout:"centered"},argTypes:{disabled:{control:"boolean",description:"Whether the button is disabled",defaultValue:!1}}},e={args:{menuItems:{items:[{key:"edit",label:"Edit",onClick:()=>alert("Edit clicked")},{key:"copy",label:"Copy",onClick:()=>alert("Copy clicked")},{key:"delete",label:"Delete",danger:!0,onClick:()=>alert("Delete clicked")}]}}};e.parameters={...e.parameters,docs:{...e.parameters?.docs,source:{originalSource:`{
  args: {
    menuItems: {
      items: [{
        key: 'edit',
