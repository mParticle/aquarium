...
}`},(U=(H=m.parameters)==null?void 0:H.docs)==null?void 0:U.source)})});var Z,q,J;u.parameters=i(t({},u.parameters),{docs:i(t({},(Z=u.parameters)==null?void 0:Z.docs),{source:t({originalSource:`{
  args: {
    progressDot: true
  }
}`},(J=(q=u.parameters)==null?void 0:q.docs)==null?void 0:J.source)})});var K,Q,X;g.parameters=i(t({},g.parameters),{docs:i(t({},(K=g.parameters)==null?void 0:K.docs),{source:t({originalSource:`{
  args: {
    progressDot: (iconDot, {
      index,
      status,
...
}`},(X=(Q=g.parameters)==null?void 0:Q.docs)==null?void 0:X.source)})});var tt,et,st;h.parameters=i(t({},h.parameters),{docs:i(t({},(tt=h.parameters)==null?void 0:tt.docs),{source:t({originalSource:`{
  args: {
    items: [{
      status: 'wait'
    }, {
...
}`},(Lt=(At=C.parameters)==null?void 0:At.docs)==null?void 0:Lt.source)})});var Nt,Bt,Vt;D.parameters=i(t({},D.parameters),{docs:i(t({},(Nt=D.parameters)==null?void 0:Nt.docs),{source:t({originalSource:`{
  render: () => {
    const [current, setCurrent] = useState(0);
...
}`},(Vt=(Bt=D.parameters)==null?void 0:Bt.docs)==null?void 0:Vt.source)})});var Rt,Yt,_t;I.parameters=i(t({},I.parameters),{docs:i(t({},(Rt=I.parameters)==null?void 0:Rt.docs),{source:t({originalSource:`{
  render: () => {
    const [current, setCurrent] = useState(0);
    const onChange = (value: number) => {
      console.log('onChange:', value);
...
}`},(Ut=(Ht=w.parameters)==null?void 0:Ht.docs)==null?void 0:Ut.source)})});var Zt,qt,Jt;z.parameters=i(t({},z.parameters),{docs:i(t({},(Zt=z.parameters)==null?void 0:Zt.docs),{source:t({originalSource:`{
  render: () => {
    const data = [{
