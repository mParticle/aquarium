var Se=Object.defineProperty,ye=Object.defineProperties;var ve=Object.getOwnPropertyDescriptors;var W=Object.getOwnPropertySymbols;var be=Object.prototype.hasOwnProperty,Ee=Object.prototype.propertyIsEnumerable;var R=(s,t,a)=>t in s?Se(s,t,{enumerable:!0,configurable:!0,writable:!0,value:a}):s[t]=a,e=(s,t)=>{for(var a in t||(t={}))be.call(t,a)&&R(s,a,t[a]);if(W)for(var a of W(t))Ee.call(t,a)&&R(s,a,t[a]);return s},r=(s,t)=>ye(s,ve(t));var j=(s,t,a)=>new Promise((n,l)=>{var i=c=>{try{w(a.next(c))}catch(C){l(C)}},xe=c=>{try{w(a.throw(c))}catch(C){l(C)}},w=c=>c.done?n(c.value):Promise.resolve(c.value).then(i,xe);w((a=a.apply(s,t)).next())});import{j as o}from"./jsx-runtime-C9TrHvcC.js";import{t as he,a as F,e as B}from"./NavigationItemsService-q4EyVFMv.js";import"./ErrorStateIcon-lPL2zJXs.js";import"./SuccessStateIcon-DchWMFvD.js";import"./WarningStateIcon-BOk4cYVs.js";import"./_baseClone-DwBCp-Ss.js";import{E as we}from"./ExampleStory-aCXxVXr3.js";import{r as Ce}from"./index-3OP4wdng.js";import{e as A,u as Be}from"./index-9E5VwD_6.js";import"./LightTheme-WtG2Efeh.js";import"./row-DlEJUZa0.js";import"./Context-R5ee3nrF.js";import"./useToken-BIYN7ogo.js";import"./presets-CQzyf-6F.js";import"./extends-CF3RwP-h.js";import"./index-DA79H6I3.js";import"./isNativeReflectConstruct-CWIsGhkf.js";import"./AntdIcon-DRQs8XP6.js";import"./style-D_W9RJEq.js";import"./WarningFilled-D6ijQqgK.js";const Je={title:"Components/Not Prod Ready/Data Entry/Input",component:he,args:{placeholder:"Input Placeholder",addonAfter:void 0,addonBefore:void 0,allowClear:!1,bordered:!0,classNames:{},count:void 0,defaultValue:"",disabled:!1,id:void 0,maxLength:void 0,prefix:void 0,showCount:!1,status:void 0,styles:{},size:"middle",suffix:void 0,type:"text",value:"",onChange:s=>{console.log("Input changed: "+s.target.value)},onPressEnter:s=>{console.log("Enter key pressed: "+String(s))}},argTypes:{status:{control:"select",options:["warning","error"]},size:{control:"select",options:["small","medium","large"]}}},u={args:{status:"error"}},p={args:{type:"textarea"}},m={args:{size:"large"}},d={args:{size:"middle"}},g={args:{size:"small"}},f={},h={args:{addonBefore:"https://",placeholder:"Enter URL"}},x={args:{addonAfter:".com",placeholder:"Domain"}},S={args:{allowClear:!0,placeholder:"Clearable Input"}},y={args:{disabled:!0}},v={args:{maxLength:10,placeholder:"Max 10 characters"}},b={args:{prefix:"@",suffix:".com",placeholder:"Email"}},E={args:{value:"Test value"},render:(s,t)=>{const a=Ce.useRef(null),n=(l="start")=>{var i;(i=a.current)==null||i.focus({cursor:l})};return o.jsx(we,{title:t.name,children:o.jsxs(F,{direction:"vertical",style:{width:"100%"},children:[o.jsxs(F,{wrap:!0,children:[o.jsx(B,{onClick:()=>{n("start")},children:"Focus at start"}),o.jsx(B,{onClick:()=>{n("end")},children:"Focus at last"}),o.jsx(B,{onClick:()=>{n("all")},children:"Focus to select all"})]}),o.jsx("br",{}),o.jsx(he,r(e({},s),{defaultValue:"Welcome to the Aquarium",ref:a}))]})})},play:s=>j(void 0,null,function*(){const t=s.canvasElement.querySelector("input");yield A(t).toBeInTheDocument();const a=s.canvasElement.querySelectorAll("button");yield A(a.length).toBe(3);for(const n of a)t==null||t.blur(),yield Be.click(n),yield A(t).toHaveFocus(),t==null||t.blur()})};var I,k,D;u.parameters=r(e({},u.parameters),{docs:r(e({},(I=u.parameters)==null?void 0:I.docs),{source:e({originalSource:`{
  args: {
    status: 'error'
  }
...
}`},(ae=(te=S.parameters)==null?void 0:te.docs)==null?void 0:ae.source)})});var se,oe,ne;y.parameters=r(e({},y.parameters),{docs:r(e({},(se=y.parameters)==null?void 0:se.docs),{source:e({originalSource:`{
  args: {
    disabled: true
  }
