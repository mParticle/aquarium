...
}`},(T=(j=c.parameters)==null?void 0:j.docs)==null?void 0:T.source)})});var f,W,F;d.parameters=r(e({},d.parameters),{docs:r(e({},(f=d.parameters)==null?void 0:f.docs),{source:e({originalSource:`{
  render: () => {
    return <Space direction="vertical" size={4} style={{
      maxWidth: 320
    }}>
...
}`},(F=(W=d.parameters)==null?void 0:W.docs)==null?void 0:F.source)})});var E,z,A;u.parameters=r(e({},u.parameters),{docs:r(e({},(E=u.parameters)==null?void 0:E.docs),{source:e({originalSource:`{
  render: () => {
    return <Space direction="vertical" size={4} style={{
      maxWidth: 320
    }}>
...
}`},(A=(z=u.parameters)==null?void 0:z.docs)==null?void 0:A.source)})});var P,C,H;p.parameters=r(e({},p.parameters),{docs:r(e({},(P=p.parameters)==null?void 0:P.docs),{source:e({originalSource:`{
  render: () => {
...
}`},(H=(C=p.parameters)==null?void 0:C.docs)==null?void 0:H.source)})});var q,O,R;m.parameters=r(e({},m.parameters),{docs:r(e({},(q=m.parameters)==null?void 0:q.docs),{source:e({originalSource:`{
  render: () => {
    return <Space direction="vertical" size={4} style={{
      maxWidth: 320
    }}>
...
}`},(R=(O=m.parameters)==null?void 0:O.docs)==null?void 0:R.source)})});var M,N,D;h.parameters=r(e({},h.parameters),{docs:r(e({},(M=h.parameters)==null?void 0:M.docs),{source:e({originalSource:`{
  render: () => {
...
}`},(D=(N=h.parameters)==null?void 0:N.docs)==null?void 0:D.source)})});var L,_,k;x.parameters=r(e({},x.parameters),{docs:r(e({},(L=x.parameters)==null?void 0:L.docs),{source:e({originalSource:`{
  render: () => {
    return <Form<FieldType> layout="vertical" style={{
      maxWidth: 320
    }}>
...
}`},(Y=(X=g.parameters)==null?void 0:X.docs)==null?void 0:Y.source)})});const xe=["TextInput","NumberInput","PercentageInput","DurationInput","SearchInput","RequiredTextInput","OptionalInput","HelpTextInput","TextAreaInput","PasswordInput"],Te=Object.freeze(Object.defineProperty({__proto__:null,DurationInput:p,HelpTextInput:y,NumberInput:d,OptionalInput:x,PasswordInput:g,PercentageInput:u,RequiredTextInput:h,SearchInput:m,TextAreaInput:I,TextInput:c,__namedExportsOrder:xe,default:me},Symbol.toStringTag,{value:"Module"}));export{p as D,y as H,Te as I,d as N,x as O,u as P,h as R,m as S,c as T,I as a,g as b};
