...
}`},(_e=(Pe=L.parameters)==null?void 0:Pe.docs)==null?void 0:_e.source)})});var Te,Ae,Oe;R.parameters=r(n({},R.parameters),{docs:r(n({},(Te=R.parameters)==null?void 0:Te.docs),{source:n({originalSource:`{
  render: () => {
...
}`},(Oe=(Ae=R.parameters)==null?void 0:Ae.docs)==null?void 0:Oe.source)})});var Me,Ie,He;P.parameters=r(n({},P.parameters),{docs:r(n({},(Me=P.parameters)==null?void 0:Me.docs),{source:n({originalSource:`{
  render: () => {
    const {
      useToken
    } = theme;
...
}`},(ze=(We=_.parameters)==null?void 0:We.docs)==null?void 0:ze.source)})});var Fe,Ne,Ye;T.parameters=r(n({},T.parameters),{docs:r(n({},(Fe=T.parameters)==null?void 0:Fe.docs),{source:n({originalSource:`{
  render: () => {
    const items: MenuProps['items'] = [{
...
}`},(Ye=(Ne=T.parameters)==null?void 0:Ne.docs)==null?void 0:Ye.source)})});var Ke,$e,qe;A.parameters=r(n({},A.parameters),{docs:r(n({},(Ke=A.parameters)==null?void 0:Ke.docs),{source:n({originalSource:`{
  render: () => {
    const items: MenuProps['items'] = [{
      key: '1',
      label: 'Item 1'
...
}`},(qe=($e=A.parameters)==null?void 0:$e.docs)==null?void 0:qe.source)})});var Je,Qe,Ue;O.parameters=r(n({},O.parameters),{docs:r(n({},(Je=O.parameters)==null?void 0:Je.docs),{source:n({originalSource:`{
  render: () => {
    const items: MenuProps['items'] = [{
      label: '1st menu item',
      key: '1'
...
}`},(Ue=(Qe=O.parameters)==null?void 0:Qe.docs)==null?void 0:Ue.source)})});var Ve,Xe,Ze;M.parameters=r(n({},M.parameters),{docs:r(n({},(Ve=M.parameters)==null?void 0:Ve.docs),{source:n({originalSource:`{
  render: () => {
    const items: MenuProps['items'] = [{
      key: '1',
      type: 'group',
