...
}`},(Te=(Se=x.parameters)==null?void 0:Se.docs)==null?void 0:Te.source)})});const Ve=["Primary","Code","Copyable","Deleted","Disabled","Editable","Keyboard","Marked","Strong","Italic","Success","Secondary","Warning","Danger","Underline","CustomOnClick","ExampleLinks"];export{c as Code,p as Copyable,T as CustomOnClick,b as Danger,d as Deleted,g as Disabled,l as Editable,x as ExampleLinks,k as Italic,m as Keyboard,u as Marked,i as Primary,h as Secondary,y as Strong,L as Success,S as Underline,D as Warning,Ve as __namedExportsOrder,Qe as default};
