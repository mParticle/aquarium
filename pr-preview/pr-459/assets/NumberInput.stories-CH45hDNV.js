...
}`},(_=(R=i.parameters)==null?void 0:R.docs)==null?void 0:_.source)})});var O,T,Y;d.parameters=e(r({},d.parameters),{docs:e(r({},(O=d.parameters)==null?void 0:O.docs),{source:r({originalSource:`{
  args: {
    autoFocus: true
  }
}`},(Y=(T=d.parameters)==null?void 0:T.docs)==null?void 0:Y.source)})});const pr=["Primary","Default","Placeholder","ErrorMessage","Disabled","Min","Max","AutoFocus"];export{d as AutoFocus,c as Default,p as Disabled,m as ErrorMessage,i as Max,u as Min,n as Placeholder,t as Primary,pr as __namedExportsOrder,mr as default};
