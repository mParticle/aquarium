...
}`},(oe=(le=y.parameters)==null?void 0:le.docs)==null?void 0:oe.source)})});var ie,ce,de;f.parameters=r(n({},f.parameters),{docs:r(n({},(ie=f.parameters)==null?void 0:ie.docs),{source:n({originalSource:`{
  render: () => {
    const items: IDescriptionsProps['items'] = [{
      label: 'Product',
      children: 'Cloud Database'
