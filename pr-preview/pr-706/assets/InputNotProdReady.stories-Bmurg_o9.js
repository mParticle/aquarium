var Se=Object.defineProperty,ye=Object.defineProperties;var ve=Object.getOwnPropertyDescriptors;var W=Object.getOwnPropertySymbols;var be=Object.prototype.hasOwnProperty,Ee=Object.prototype.propertyIsEnumerable;var R=(o,a,t)=>a in o?Se(o,a,{enumerable:!0,configurable:!0,writable:!0,value:t}):o[a]=t,e=(o,a)=>{for(var t in a||(a={}))be.call(a,t)&&R(o,t,a[t]);if(W)for(var t of W(a))Ee.call(a,t)&&R(o,t,a[t]);return o},r=(o,a)=>ye(o,ve(a));var j=(o,a,t)=>new Promise((n,l)=>{var i=c=>{try{w(t.next(c))}catch(C){l(C)}},xe=c=>{try{w(t.throw(c))}catch(C){l(C)}},w=c=>c.done?n(c.value):Promise.resolve(c.value).then(i,xe);w((t=t.apply(o,a)).next())});import{j as s}from"./jsx-runtime-GRP_BLAX.js";import{u as he,a as F,c as B}from"./NavigationItemsService-Hr1be8SE.js";import"./ErrorStateIcon-Do_CM_GO.js";import"./SuccessStateIcon-CmToGiKI.js";import"./WarningStateIcon-M2kIOVZb.js";import"./_baseClone-BJQa_8Hx.js";import{E as we}from"./ExampleStory-BzSWq0mY.js";import{r as Ce}from"./index-CNk6hRaE.js";import{e as A,u as Be}from"./index-9E5VwD_6.js";import"./LightTheme-BtoaoHMG.js";import"./row-M_82l6gX.js";import"./Context-BUSkoOJ1.js";import"./useToken-ZHvy9ttm.js";import"./presets-vy2ytAcW.js";import"./index-DN1Ck1Y5.js";import"./isNativeReflectConstruct-CWIsGhkf.js";import"./AntdIcon-Bm4W6gxM.js";import"./style-Cv9zhzF_.js";import"./client-CgpM46-k.js";import"./WarningFilled-KKNPfhjt.js";const Je={title:"Components/Not Prod Ready/Data Entry/Input",component:he,args:{placeholder:"Input Placeholder",addonAfter:void 0,addonBefore:void 0,allowClear:!1,bordered:!0,classNames:{},count:void 0,defaultValue:"",disabled:!1,id:void 0,maxLength:void 0,prefix:void 0,showCount:!1,status:void 0,styles:{},size:"middle",suffix:void 0,type:"text",value:"",onChange:o=>{console.log("Input changed: "+o.target.value)},onPressEnter:o=>{console.log("Enter key pressed: "+String(o))}},argTypes:{status:{control:"select",options:["warning","error"]},size:{control:"select",options:["small","medium","large"]}}},u={args:{status:"error"}},p={args:{type:"textarea"}},m={args:{size:"large"}},d={args:{size:"middle"}},g={args:{size:"small"}},f={},h={args:{addonBefore:"https://",placeholder:"Enter URL"}},x={args:{addonAfter:".com",placeholder:"Domain"}},S={args:{allowClear:!0,placeholder:"Clearable Input"}},y={args:{disabled:!0}},v={args:{maxLength:10,placeholder:"Max 10 characters"}},b={args:{prefix:"@",suffix:".com",placeholder:"Email"}},E={args:{value:"Test value"},render:(o,a)=>{const t=Ce.useRef(null),n=(l="start")=>{var i;(i=t.current)==null||i.focus({cursor:l})};return s.jsx(we,{title:a.name,children:s.jsxs(F,{orientation:"vertical",style:{width:"100%"},children:[s.jsxs(F,{wrap:!0,children:[s.jsx(B,{onClick:()=>{n("start")},children:"Focus at start"}),s.jsx(B,{onClick:()=>{n("end")},children:"Focus at last"}),s.jsx(B,{onClick:()=>{n("all")},children:"Focus to select all"})]}),s.jsx("br",{}),s.jsx(he,r(e({},o),{defaultValue:"Welcome to the Aquarium",ref:t}))]})})},play:o=>j(void 0,null,function*(){const a=o.canvasElement.querySelector("input");yield A(a).toBeInTheDocument();const t=o.canvasElement.querySelectorAll("button");yield A(t.length).toBe(3);for(const n of t)a==null||a.blur(),yield Be.click(n),yield A(a).toHaveFocus(),a==null||a.blur()})};var I,k,D;u.parameters=r(e({},u.parameters),{docs:r(e({},(I=u.parameters)==null?void 0:I.docs),{source:e({originalSource:`{
  args: {
    status: 'error'
  }
...
}`},(te=(ae=S.parameters)==null?void 0:ae.docs)==null?void 0:te.source)})});var oe,se,ne;y.parameters=r(e({},y.parameters),{docs:r(e({},(oe=y.parameters)==null?void 0:oe.docs),{source:e({originalSource:`{
  args: {
    disabled: true
  }
