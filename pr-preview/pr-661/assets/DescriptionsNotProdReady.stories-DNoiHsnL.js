...
}`},(le=(oe=f.parameters)==null?void 0:oe.docs)==null?void 0:le.source)})});const Oe=["Bordered","Vertical","Small","CustomTitle","WithExtra","WithTitleAndExtra","WithContentStyle","WithLabelStyle","ResponsiveColumn","ExampleTableLook","ExampleSize","ExampleResponsiveDescriptions"];export{c as Bordered,p as CustomTitle,f as ExampleResponsiveDescriptions,k as ExampleSize,y as ExampleTableLook,h as ResponsiveColumn,m as Small,d as Vertical,x as WithContentStyle,u as WithExtra,g as WithLabelStyle,b as WithTitleAndExtra,Oe as __namedExportsOrder,Ge as default};
