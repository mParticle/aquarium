...
}`},(h=(S=i.parameters)==null?void 0:S.docs)==null?void 0:h.source)})});var j,z,B;c.parameters=r(s({},c.parameters),{docs:r(s({},(j=c.parameters)==null?void 0:j.docs),{source:s({originalSource:`{
  render: () => {
    const colors = [{
      label: 'Primary',
      value: ColorInfo
...
}`},(B=(z=c.parameters)==null?void 0:z.docs)==null?void 0:B.source)})});var P,b,w;u.parameters=r(s({},u.parameters),{docs:r(s({},(P=u.parameters)==null?void 0:P.docs),{source:s({originalSource:`{
  argTypes: {
    status: {
      control: 'select',
      options: ['success', 'processing', 'default', 'error', 'warning']
...
}`},(w=(b=u.parameters)==null?void 0:b.docs)==null?void 0:w.source)})});var q,y,E;d.parameters=r(s({},d.parameters),{docs:r(s({},(q=d.parameters)==null?void 0:q.docs),{source:s({originalSource:`{
  args: {
    dot: true,
    status: 'success',
    text: 'Active'
  }
}`},(E=(y=d.parameters)==null?void 0:y.docs)==null?void 0:E.source)})});var W,C,T;p.parameters=r(s({},p.parameters),{docs:r(s({},(W=p.parameters)==null?void 0:W.docs),{source:s({originalSource:`{
  render: () => {
...
}`},(T=(C=p.parameters)==null?void 0:C.docs)==null?void 0:T.source)})});var F,_,A;g.parameters=r(s({},g.parameters),{docs:r(s({},(F=g.parameters)==null?void 0:F.docs),{source:s({originalSource:`{
  render: () => {
    return <Space wrap size="middle">
