...
}`},(Le=(ve=w.parameters)==null?void 0:ve.docs)==null?void 0:Le.source)})});var Ue,be,Fe;k.parameters=r(n({},k.parameters),{docs:r(n({},(Ue=k.parameters)==null?void 0:Ue.docs),{source:n({originalSource:`{
  args: {
    type: 'primary',
    loading: true,
    children: 'Loading'
  }
}`},(Fe=(be=k.parameters)==null?void 0:be.docs)==null?void 0:Fe.source)})});var De,Ee,Me;v.parameters=r(n({},v.parameters),{docs:r(n({},(De=v.parameters)==null?void 0:De.docs),{source:n({originalSource:`{
  args: {
    type: 'text',
    loading: true,
    children: 'Load more'
...
}`},(We=(Pe=L.parameters)==null?void 0:Pe.docs)==null?void 0:We.source)})});var Ae,Ce,Oe;U.parameters=r(n({},U.parameters),{docs:r(n({},(Ae=U.parameters)==null?void 0:Ae.docs),{source:n({originalSource:`{
  render: () => {
    return <Flex wrap gap={MarginMd} align="center">
...
}`},(Oe=(Ce=U.parameters)==null?void 0:Ce.docs)==null?void 0:Oe.source)})});var Ne,_e,qe;b.parameters=r(n({},b.parameters),{docs:r(n({},(Ne=b.parameters)==null?void 0:Ne.docs),{source:n({originalSource:`{
  render: () => {
...
}`},(qe=(_e=b.parameters)==null?void 0:_e.docs)==null?void 0:qe.source)})});var $e,Ve,Xe;F.parameters=r(n({},F.parameters),{docs:r(n({},($e=F.parameters)==null?void 0:$e.docs),{source:n({originalSource:`{
  render: () => {
    return <Flex wrap gap={MarginMd} align="center">
...
}`},(Xe=(Ve=F.parameters)==null?void 0:Ve.docs)==null?void 0:Xe.source)})});var Ge,Ke,Ze;D.parameters=r(n({},D.parameters),{docs:r(n({},(Ge=D.parameters)==null?void 0:Ge.docs),{source:n({originalSource:`{
  render: () => {
    return <>
...
}`},(Ze=(Ke=D.parameters)==null?void 0:Ke.docs)==null?void 0:Ze.source)})});var He,Je,Qe;E.parameters=r(n({},E.parameters),{docs:r(n({},(He=E.parameters)==null?void 0:He.docs),{source:n({originalSource:`{
  render: () => {
...
}`},(cn=(on=P.parameters)==null?void 0:on.docs)==null?void 0:cn.source)})});const Tn=["LinkUsageNote","Primary","PrimaryWithIcon","Default","DefaultWithIcon","Dashed","DashedWithIcon","Link","LinkWithIcon","Text","Danger","Loading","LoadingText","TypesOverview","IconTypesOverview","SizeExamples","IconOnly","Refresh","With2Options","ButtonsWithLocalIcons","ButtonsWithUntitledUIIcons","WithUntitledUIIcons"],Mn=Object.freeze(Object.defineProperty({__proto__:null,ButtonsWithLocalIcons:M,ButtonsWithUntitledUIIcons:R,Danger:w,Dashed:B,DashedWithIcon:I,Default:f,DefaultWithIcon:j,IconOnly:F,IconTypesOverview:U,Link:T,LinkUsageNote:h,LinkWithIcon:z,Loading:k,LoadingText:v,Primary:g,PrimaryWithIcon:x,Refresh:D,SizeExamples:b,Text:S,TypesOverview:L,With2Options:E,WithUntitledUIIcons:P,__namedExportsOrder:Tn,default:In},Symbol.toStringTag,{value:"Module"}));export{Mn as B,w as D,U as I,h as L,b as S,L as T,F as a,M as b,R as c,k as d,v as e};
