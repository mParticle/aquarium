import{b6 as q,j as e,b7 as J,aC as Q,b8 as Z,F as l,aY as ee,T as s,aE as r,k as t,be as se,aR as n,bf as i,bg as re}from"./iframe-DLzD0hVH.js";const oe={title:"Components/Feedback/Alert",component:q,args:{banner:!1,showIcon:!1,type:"info",onClose:P=>{alert("Alert On Close")},afterClose:()=>{console.log("Alert After Closed")}},argTypes:{type:{control:"select",options:["success","info","warning","error","default"]}}},g={render:()=>e.jsx(q,{message:e.jsxs(l,{align:"center",gap:ee,children:[e.jsx(s.Text,{size:"xl",children:"💡"}),e.jsxs(s.Text,{size:"base",children:["Use the"," ",e.jsx(s.Link,{href:"?path=/docs/components-feedback-message--docs",color:"ColorText",children:"Message component"})," ","if the notification should dismiss automatically."]})]}),showIcon:!1,type:"info",style:{backgroundColor:Z,border:`1px solid ${Q}`,borderRadius:J,width:"860px",marginBottom:0}})},m={render:()=>e.jsx(q,{message:e.jsxs(l,{align:"center",gap:ee,children:[e.jsx(s.Text,{size:"xl",children:"💡"}),e.jsx(s.Text,{size:"base",children:"We don't use bolding or titles for our alerts."})]}),showIcon:!1,type:"info",style:{backgroundColor:Z,border:`1px solid ${Q}`,borderRadius:J,width:"860px",marginBottom:0}})},d={args:{type:"info",message:"This is an informational message.",showIcon:!0,style:{marginBottom:0,width:"860px"}}},h={args:{type:"success",message:"This is a success message.",showIcon:!0,style:{marginBottom:0,width:"860px"}}},u={args:{message:"This is a warning message.",type:"warning",showIcon:!0,style:{marginBottom:0,width:"860px"}}},y={args:{message:"This is an error message.",type:"error",showIcon:!0,style:{marginBottom:0,width:"860px"}}},x={args:{type:"info",message:"This is an informational message.",showIcon:!1,style:{marginBottom:0,width:"860px"}}},T={args:{message:"An error occurred creating the tracing configuration",type:"error",showIcon:!1,style:{marginBottom:0,width:"860px"}}},f={args:{type:"error",expandable:!0,closable:!0,message:"This is an error message.",expandableContent:e.jsx(s.Text,{size:"base",children:"Error details go here"}),style:{marginBottom:0,width:"860px"}}},w={args:{type:"warning",message:"This is a warning message.",showIcon:!0,closable:!0,style:{marginBottom:0,width:"860px"}}},v={args:{type:"success",message:"This is a success message.",showIcon:!0,closable:!0,style:{marginBottom:0,width:"860px"}}},B={args:{type:"info",message:"This is an informational message.",showIcon:!0,closable:!0,style:{marginBottom:0,width:"860px"}}},b={args:{type:"warning",message:"This is a warning message.",showIcon:!0,closable:!0,style:{marginBottom:0,width:"860px"}}},I={args:{type:"error",message:"This is an error message.",showIcon:!0,closable:!0,style:{marginBottom:0,width:"860px"}}},S={args:{type:"info",message:"This is a long informational message that wraps onto multiple lines to demonstrate that the icon remains top-aligned rather than centered vertically.",showIcon:!0,style:{marginBottom:0,width:"400px"}}},C={args:{type:"warning",message:"This is a long warning message that wraps onto multiple lines to demonstrate that both the icon and close button remain top-aligned rather than centered vertically.",showIcon:!0,closable:!0,style:{marginBottom:0,width:"400px"}}},j={args:{type:"success",message:e.jsxs(s.Text,{size:"base",children:["Your changes have been saved successfully."," ",e.jsx(s.Link,{color:"ColorText",underline:!0,href:"#",children:"View details"})]}),showIcon:!0,style:{marginBottom:0,width:"860px"}}},W={args:{type:"info",message:e.jsxs(s.Text,{size:"base",children:["This is an informational message."," ",e.jsx(s.Link,{color:"ColorText",underline:!0,href:"#",children:"Learn more"})]}),showIcon:!0,style:{marginBottom:0,width:"860px"}}},k={args:{type:"warning",message:e.jsxs(s.Text,{size:"base",children:["This is a warning message."," ",e.jsx(s.Link,{color:"ColorText",underline:!0,href:"#",children:"Review settings"})]}),showIcon:!0,style:{marginBottom:0,width:"860px"}}},E={args:{type:"error",message:e.jsxs(s.Text,{size:"base",children:["An error occurred processing your request."," ",e.jsx(s.Link,{color:"ColorText",underline:!0,href:"#",children:"Try again"})]}),showIcon:!0,style:{marginBottom:0,width:"860px"}}},z={render:()=>{const[P,o]=r.useState(!1),[$,c]=r.useState(""),[V,_]=r.useState(""),[G,U]=r.useState(""),H=()=>{o(!1)},Y=()=>{o(!1)};return e.jsxs(e.Fragment,{children:[e.jsx(t,{type:"default",onClick:()=>o(!0),children:"Open Modal with Info Alert"}),e.jsx(se,{title:"Save Configuration",open:P,onOk:H,onCancel:Y,width:600,okText:"Save",children:e.jsxs(l,{vertical:!0,gap:"middle",children:[e.jsx(s.Text,{size:"base",children:"Please review the configuration settings below before saving."}),e.jsxs(l,{vertical:!0,gap:"small",children:[e.jsxs("div",{children:[e.jsx(s.Text,{size:"base",children:"Field 1"}),e.jsx(n,{value:$,onChange:a=>c(a.target.value),placeholder:"Enter value",style:{marginTop:i}})]}),e.jsxs("div",{children:[e.jsx(s.Text,{size:"base",children:"Field 2"}),e.jsx(n,{value:V,onChange:a=>_(a.target.value),placeholder:"Enter value",style:{marginTop:i}})]}),e.jsxs("div",{children:[e.jsx(s.Text,{size:"base",children:"Field 3"}),e.jsx(n,{value:G,onChange:a=>U(a.target.value),placeholder:"Enter value",style:{marginTop:i}})]})]}),e.jsx(q,{type:"info",message:"These settings cannot be changed once saved.",showIcon:!0,closable:!1,style:{marginBottom:0,marginTop:re}})]})})]})}},M={args:{type:"default",message:"This is a general informational message.",showIcon:!0,style:{marginBottom:0,width:"860px"}}},L={args:{type:"default",message:"This is a general informational message.",showIcon:!1,style:{marginBottom:0,width:"860px"}}},O={args:{type:"default",message:"This is a general informational message.",showIcon:!0,closable:!0,style:{marginBottom:0,width:"860px"}}},A={args:{type:"default",message:e.jsxs(s.Text,{size:"base",children:["This is a general informational message."," ",e.jsx(s.Link,{color:"ColorText",underline:!0,href:"#",children:"Learn more"})]}),showIcon:!1,style:{marginBottom:0,width:"860px"}}},F={args:{type:"info",message:"This is an informational message.",showIcon:!0,action:e.jsx(t,{size:"small",type:"primary",children:"Learn More"}),style:{marginBottom:0,width:"860px"}}},N={args:{type:"success",message:"Your changes have been saved successfully.",showIcon:!0,action:e.jsx(t,{size:"small",type:"text",children:"Undo"}),style:{marginBottom:0,width:"860px"}}},R={args:{type:"warning",message:"This action requires additional permissions.",showIcon:!0,action:e.jsx(t,{size:"small",type:"default",children:"Review"}),style:{marginBottom:0,width:"860px"}}},D={args:{type:"error",message:"An error occurred processing your request.",showIcon:!0,action:e.jsx(t,{size:"small",danger:!0,children:"Retry"}),style:{marginBottom:0,width:"860px"}}},K={args:{type:"default",message:"This is a general informational message.",showIcon:!0,action:e.jsx(t,{size:"small",type:"default",children:"Details"}),style:{marginBottom:0,width:"860px"}}},X={render:()=>{const[P,o]=r.useState(!1),[$,c]=r.useState(!1),[V,_]=r.useState(""),[G,U]=r.useState(""),[H,Y]=r.useState(""),a=()=>{c(!0)},ae=()=>{o(!1),c(!1),_(""),U(""),Y("")},te=()=>{o(!0),c(!1)};return e.jsxs(e.Fragment,{children:[e.jsx(t,{type:"default",onClick:te,children:"Open Modal with Error on Save"}),e.jsx(se,{title:"Save Configuration",open:P,onOk:a,onCancel:ae,width:600,okText:"Save",children:e.jsxs(l,{vertical:!0,gap:"middle",children:[e.jsx(s.Text,{size:"base",children:"Please review the configuration settings below before saving."}),e.jsxs(l,{vertical:!0,gap:"small",children:[e.jsxs("div",{children:[e.jsx(s.Text,{size:"base",children:"Field 1"}),e.jsx(n,{value:V,onChange:p=>_(p.target.value),placeholder:"Enter value",style:{marginTop:i}})]}),e.jsxs("div",{children:[e.jsx(s.Text,{size:"base",children:"Field 2"}),e.jsx(n,{value:G,onChange:p=>U(p.target.value),placeholder:"Enter value",style:{marginTop:i}})]}),e.jsxs("div",{children:[e.jsx(s.Text,{size:"base",children:"Field 3"}),e.jsx(n,{value:H,onChange:p=>Y(p.target.value),placeholder:"Enter value",style:{marginTop:i}})]})]}),$&&e.jsx(q,{type:"error",message:"Unable to save. Please verify all required permissions are granted.",showIcon:!0,closable:!1,style:{marginBottom:0,marginTop:re}})]})})]})}};g.parameters={...g.parameters,docs:{...g.parameters?.docs,source:{originalSource:`{
  render: () => {
