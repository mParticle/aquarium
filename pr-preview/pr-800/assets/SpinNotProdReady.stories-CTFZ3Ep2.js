import{av as s,j as e,I as b,F as y,G as j,a3 as E,ah as L,a0 as v,i as F}from"./iframe-C5_iV81x.js";import{E as r}from"./ExampleStory-D7c1DJR9.js";import"./preload-helper-PPVm8Dsz.js";const N={title:"Experimental/Feedback/Spin",component:s,args:{delay:void 0,indicator:void 0,size:"default",spinning:!0,tip:void 0,wrapperClassName:void 0,fullscreen:!1}},t={},i={args:{size:"small"}},o={args:{size:"large"}},l={args:{delay:500}},d={args:{indicator:e.jsx(b,{name:"mpLogo"})}},c={args:{spinning:!1}},p={args:{tip:"Loading...",children:e.jsx(e.Fragment,{})}},m={args:{wrapperClassName:"custom-wrapper"}},g={args:{fullscreen:!0}},u={render:()=>e.jsx(r,{title:"A small Spin is used for loading text, default sized Spin for loading a card-level block, and large Spin used for loading a page.",children:e.jsxs(y,{align:"center",gap:"middle",children:[e.jsx(s,{size:"small"}),e.jsx(s,{}),e.jsx(s,{size:"large"})]})})},S={render:()=>{const[a,n]=j.useState(!1);return e.jsxs(r,{title:"Embedding content into Spin will set it into loading state.",children:[e.jsx(s,{spinning:a,children:e.jsx(E,{type:"info",message:"Alert message title",description:"Further details about the context of this alert."})}),e.jsxs("div",{style:{marginTop:L},children:["Loading state：",e.jsx(v,{checked:a,onChange:n})]})]})}},x={render:()=>e.jsx(r,{title:"Adds subtext",children:e.jsxs(y,{gap:50,vertical:!0,children:[e.jsxs(y,{gap:100,children:[e.jsx(s,{tip:"Loading",size:"small",children:e.jsx("div",{className:"content"})}),e.jsx(s,{tip:"Loading",children:e.jsx("div",{className:"content"})}),e.jsx(s,{tip:"Loading",size:"large",children:e.jsx("div",{className:"content"})})]}),e.jsx(s,{tip:"Loading...",children:e.jsx(E,{message:"Alert message title",description:"Further details about the context of this alert.",type:"info"})})]})})},h={render:()=>{const[a,n]=j.useState(!1);return e.jsxs(r,{title:"Specifies a delay for loading state. If spinning ends during delay, loading status won't appear.",children:[e.jsx(s,{spinning:a,delay:500,children:e.jsx(E,{type:"info",message:"Alert message title",description:"Further details about the context of this alert."})}),e.jsxs("div",{style:{marginTop:L},children:["Loading state：",e.jsx(v,{checked:a,onChange:n})]})]})}},f={render:()=>{const[a,n]=j.useState(!1),z=()=>{n(!0),setTimeout(()=>{n(!1)},3e3)};return e.jsxs(r,{title:"The fullscreen mode is perfect for creating page loaders. It adds a dimmed overlay with a centered spinner.",children:[e.jsx(F,{onClick:z,children:"Show fullscreen for 3s"}),e.jsx(s,{spinning:a,fullscreen:!0})]})}};t.parameters={...t.parameters,docs:{...t.parameters?.docs,source:{originalSource:"{}",...t.parameters?.docs?.source}}};i.parameters={...i.parameters,docs:{...i.parameters?.docs,source:{originalSource:`{
  args: {
    size: 'small'
  }
