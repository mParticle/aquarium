...
}`},(W=(N=g.parameters)==null?void 0:N.docs)==null?void 0:W.source)})});var $,q,G;f.parameters=r(t({},f.parameters),{docs:r(t({},($=f.parameters)==null?void 0:$.docs),{source:t({originalSource:`{
  render: () => {
...
}`},(G=(q=f.parameters)==null?void 0:q.docs)==null?void 0:G.source)})});var J,K,Q;k.parameters=r(t({},k.parameters),{docs:r(t({},(J=k.parameters)==null?void 0:J.docs),{source:t({originalSource:`{
  render: () => {
...
}`},(Q=(K=k.parameters)==null?void 0:K.docs)==null?void 0:Q.source)})});var U,V,X;y.parameters=r(t({},y.parameters),{docs:r(t({},(U=y.parameters)==null?void 0:U.docs),{source:t({originalSource:`{
  render: () => {
...
}`},(X=(V=y.parameters)==null?void 0:V.docs)==null?void 0:X.source)})});var Y,Z,ee;u.parameters=r(t({},u.parameters),{docs:r(t({},(Y=u.parameters)==null?void 0:Y.docs),{source:t({originalSource:`{
  render: () => {
...
}`},(ee=(Z=u.parameters)==null?void 0:Z.docs)==null?void 0:ee.source)})});var te,re,ae;x.parameters=r(t({},x.parameters),{docs:r(t({},(te=x.parameters)==null?void 0:te.docs),{source:t({originalSource:`{
  render: () => {
...
}`},(ae=(re=x.parameters)==null?void 0:re.docs)==null?void 0:ae.source)})});const he=["Primary","HorizontalDirection","WithCustomItems","ShowInkInFixed","ExampleBasic","ExampleHorizontal","ExampleAnchorStatic","ExampleOnclick","ExampleScrollOffset","ExampleLinkChange","ExampleReplaceHistory"],xe=Object.freeze(Object.defineProperty({__proto__:null,ExampleAnchorStatic:f,ExampleBasic:m,ExampleHorizontal:g,ExampleLinkChange:u,ExampleOnclick:k,ExampleReplaceHistory:x,ExampleScrollOffset:y,HorizontalDirection:h,Primary:l,ShowInkInFixed:d,WithCustomItems:p,__namedExportsOrder:he,default:le},Symbol.toStringTag,{value:"Module"}));export{xe as A,le as m};
