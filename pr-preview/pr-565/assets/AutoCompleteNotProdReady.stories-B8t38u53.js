var Ae=Object.defineProperty,fe=Object.defineProperties;var je=Object.getOwnPropertyDescriptors;var F=Object.getOwnPropertySymbols;var ve=Object.prototype.hasOwnProperty,Pe=Object.prototype.propertyIsEnumerable;var z=(t,r,s)=>r in t?Ae(t,r,{enumerable:!0,configurable:!0,writable:!0,value:s}):t[r]=s,o=(t,r)=>{for(var s in r||(r={}))ve.call(r,s)&&z(t,s,r[s]);if(F)for(var s of F(r))Pe.call(r,s)&&z(t,s,r[s]);return t},a=(t,r)=>fe(t,je(r));import{j as e}from"./jsx-runtime-BcCOBRXo.js";import{r as m}from"./index-CNk6hRaE.js";import{u,x as V,b as Ee,I as ye,F as be}from"./NavigationItemsService-CDrHG6Kg.js";import"./_baseClone-DBzvlRjn.js";import{E as g}from"./ExampleStory-YT6FfXGk.js";import"./LightTheme-BtoaoHMG.js";import"./row-GPgCuxPF.js";import"./useToken-BSaSgSTZ.js";import"./extends-CF3RwP-h.js";import"./index-D-4E_f9W.js";import"./isNativeReflectConstruct-CWIsGhkf.js";const I=[{label:"The quick brown fox jumps over the lazy dog",value:1},{label:"Waxy and quivering, jocks fumble the pizza",value:2},{label:"When zombies arrive, quickly fax judge Pat",value:3},{label:"Pack my red box with five dozen quality jugs",value:4},{label:"The quick onyx goblin jumps over the lazy dwarf",value:5}],$e={title:"Components/Not Prod Ready/Data Entry/Auto Complete",component:t=>{const[r,s]=m.useState(""),[c,l]=m.useState([]),p=d=>d?I.filter(x=>x.label.toLowerCase().includes(d.toLowerCase())):[],n=d=>{l(p(d))},h=d=>{console.log("you selected value: "+d)};return e.jsx(e.Fragment,{children:e.jsx(u,a(o({},t),{value:r,options:c,onSelect:h,onSearch:n,onChange:s}))})},args:{allowClear:!1,autoFocus:!1,backfill:!1,bordered:!0,defaultActiveFirstOption:!0,options:I,defaultOpen:void 0,defaultValue:void 0,disabled:!1,popupClassName:void 0,open:void 0,placeholder:"Search AutoComplete",status:void 0,style:{width:200},value:void 0,onBlur:()=>{console.log("Blur Event")},onChange:t=>{alert(`Selected Value: ${t}`)},onDropdownVisibleChange:t=>{console.log(`Dropdown Open: ${t}`)},onFocus:()=>{console.log("Focus Event")},onSearch:t=>{alert(`Search Value: ${t}`)},onSelect:(t,r)=>{alert(`Selected Value: ${t}, Option: ${String(r.label)}`)},onClear:()=>{alert("Clear Event")}},argTypes:{status:{control:"select",options:["error","warning"]}}},S={args:{allowClear:!0}},C={args:{placeholder:"Custom Placeholder Text"}},y={args:{disabled:!0}},b={args:{notFoundContent:e.jsx(e.Fragment,{children:"Custom Not Found Component goes here"})}},w={args:{bordered:!1}},A={render:()=>{const[t,r]=m.useState(""),[s,c]=m.useState([]),[l,p]=m.useState([]),n=(i,we=1)=>({value:i.repeat(we)}),h=i=>i?[n(i),n(i,2),n(i,3)]:[],d=i=>{alert("onSelect:"+i)},x=i=>{r(i)};return e.jsx(e.Fragment,{children:e.jsxs(g,{title:"Basic Usage, set data source of autocomplete with options property.",children:[e.jsx(u,{options:s,style:{width:200},onSelect:d,onSearch:i=>{c(h(i))},placeholder:"input here"}),e.jsx("br",{}),e.jsx("br",{}),e.jsx(u,{value:t,options:l,style:{width:200},onSelect:d,onSearch:i=>{p(h(i))},onChange:x,placeholder:"control mode"})]})})}},f={render:()=>{const[t,r]=m.useState([]),s=c=>{let l;!c||c.includes("@")?l=[]:l=["gmail.com","163.com","qq.com"].map(p=>({value:c,label:`${c}@${p}`})),r(l)};return e.jsx(e.Fragment,{children:e.jsx(g,{title:"You could set custom Option label.",children:e.jsx(u,{style:{width:200},onSearch:s,placeholder:"input here",options:t})})})}},j={render:()=>{const[t,r]=m.useState([]),s=p=>{r(p?[{value:p},{value:p+p},{value:p+p+p}]:[])},c=p=>{console.log("handleKeyPress",p)},l=p=>{alert("selected: "+p)};return e.jsx(g,{title:"Customize Input Component",children:e.jsx(u,{options:t,style:{width:200},onSelect:l,onSearch:s,children:e.jsx(V.TextArea,{placeholder:"input here",className:"custom",style:{height:50},onKeyPress:c})})})}},v={render:()=>e.jsx(e.Fragment,{children:e.jsx(g,{title:"A non-case-sensitive AutoComplete.",children:e.jsx(u,{style:{width:200},options:I.map(t=>a(o({},t),{label:t.label.toUpperCase()})),placeholder:"try to type `b`",filterOption:(t,r)=>{var s,c;return(c=(s=r==null?void 0:r.label)==null?void 0:s.toString().toUpperCase().includes(t.toUpperCase()))!=null?c:!1}})})})},P={render:()=>{const t=c=>e.jsxs("span",{children:[c,e.jsx("a",{style:{float:"right"},href:"https://www.google.com/search?q=antd",target:"_blank",rel:"noopener noreferrer",children:"more"})]}),r=(c,l)=>({value:c,label:e.jsxs(be,{justify:"space-between",children:[c,e.jsxs("span",{children:[e.jsx(ye,{name:"mpLogo"}),l]})]})}),s=[{label:t("Libraries"),options:[r("AntDesign",1e4),r("AntDesign UI",10600)]},{label:t("Solutions"),options:[r("AntDesign UI FAQ",60100),r("AntDesign FAQ",30010)]},{label:t("Articles"),options:[r("AntDesign design language",1e5)]}];return e.jsx(e.Fragment,{children:e.jsx(g,{title:e.jsxs(e.Fragment,{children:["Demonstration of"," ",e.jsx("a",{href:"https://ant.design/docs/spec/reaction/#lookup-patterns",target:"_blank",rel:"noreferrer",children:"Lookup Patterns: Certain Category"}),"Basic Usage, set options of autocomplete with options property."]}),children:e.jsx(u,{popupClassName:"certain-category-search-dropdown",popupMatchSelectWidth:500,style:{width:250},options:s,size:"large",children:e.jsx(V.Search,{size:"large",placeholder:"input here"})})})})}},E={render:()=>{const t=(n,h=0)=>Math.floor(Math.random()*(n-h+1))+h,r=n=>new Array(t(5)).join(".").split(".").map((h,d)=>{const x=`${n}${d}`;return{value:x,label:e.jsxs(be,{justify:"space-between",children:[e.jsxs("span",{children:["Found ",n," on"," ",e.jsx("a",{href:`https://s.taobao.com/search?q=${n}`,target:"_blank",rel:"noopener noreferrer",children:x})]}),e.jsxs("span",{children:[t(200,100)," results"]})]})}}),[s,c]=m.useState([]),l=n=>{c(n!==""?r(n):[])},p=n=>{alert("selected: "+n)};return e.jsx(e.Fragment,{children:e.jsx(g,{title:e.jsxs(e.Fragment,{children:["Demonstration of"," ",e.jsx("a",{href:"https://ant.design/docs/spec/reaction#lookup-patterns",target:"_blank",rel:"noreferrer",children:"Lookup Patterns: Certain Category"}),"Basic Usage, set options of autocomplete with options property."]}),children:e.jsx(u,{popupMatchSelectWidth:252,style:{width:300},options:s,onSelect:p,onSearch:l,size:"large",children:e.jsx(V.Search,{size:"large",placeholder:"input here",enterButton:!0})})})})}},O={render:()=>{const t=(n,h=1)=>({value:n.repeat(h)}),[r,s]=m.useState([]),[c,l]=m.useState([]),p=n=>n?[t(n),t(n,2),t(n,3)]:[];return e.jsx(g,{title:"Add status to AutoComplete with status, which could be error or warning.",children:e.jsxs(Ee,{direction:"vertical",style:{width:"100%"},children:[e.jsx(u,{placeholder:"Error",options:r,onSearch:n=>{s(p(n))},status:"error",style:{width:200}}),e.jsx(u,{placeholder:"Warning",options:c,onSearch:n=>{l(p(n))},status:"warning",style:{width:200}})]})})}},k={render:()=>{const t=(l,p=1)=>({value:l.repeat(p)}),[r,s]=m.useState([]),c=l=>l?[t(l),t(l,2),t(l,3)]:[];return e.jsx(e.Fragment,{children:e.jsxs(g,{title:"Customize clear button",children:[e.jsx(u,{options:r,style:{width:200},onSearch:l=>{s(c(l))},placeholder:"No clear icon",allowClear:!1}),e.jsx("br",{}),e.jsx("br",{}),e.jsx(u,{options:r,style:{width:200},onSearch:l=>{s(c(l))},placeholder:"Customized clear icon",allowClear:{clearIcon:e.jsx(ye,{name:"mpLogo"})}})]})})}};var D,T,B;S.parameters=a(o({},S.parameters),{docs:a(o({},(D=S.parameters)==null?void 0:D.docs),{source:o({originalSource:`{
  args: {
    allowClear: true
  }
...
}`},(ne=(ae=v.parameters)==null?void 0:ae.docs)==null?void 0:ne.source)})});var le,ce,pe;P.parameters=a(o({},P.parameters),{docs:a(o({},(le=P.parameters)==null?void 0:le.docs),{source:o({originalSource:`{
  render: () => {
...
}`},(pe=(ce=P.parameters)==null?void 0:ce.docs)==null?void 0:pe.source)})});var ie,ue,de;E.parameters=a(o({},E.parameters),{docs:a(o({},(ie=E.parameters)==null?void 0:ie.docs),{source:o({originalSource:`{
  render: () => {
