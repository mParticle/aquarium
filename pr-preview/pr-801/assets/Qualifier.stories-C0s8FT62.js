import{Q as n}from"./iframe-CGRBtYa3.js";import"./preload-helper-PPVm8Dsz.js";const p={title:"Components/Data Entry/QueryItem/Qualifier",component:n.Qualifier,tags:["deprecated"],parameters:{docs:{description:{component:"⚠️ **Deprecated** — The QueryItem component group is deprecated and will not receive further updates. Avoid using it in new implementations."}}},args:{}},t=[{value:"0",label:"is equal to"},{value:"1",label:"is not equal to"},{value:"2",label:"is greater than"},{value:"3",label:"is greater or equal to"},{value:"4",label:"is less than"},{value:"5",label:"is less or equal to"}],e={},r={args:{options:t}},a={args:{errorMessage:"This is an error message for the Qualifier component",options:t}},s={args:{disabled:!0,options:t}},o={args:{options:t,value:{value:"2",label:"is greater than"}}};e.parameters={...e.parameters,docs:{...e.parameters?.docs,source:{originalSource:"{}",...e.parameters?.docs?.source}}};r.parameters={...r.parameters,docs:{...r.parameters?.docs,source:{originalSource:`{
  args: {
