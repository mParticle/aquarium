import{cj as s,j as a,I as L,G as D}from"./iframe-DCYbTPIE.js";import{E}from"./ExampleStory-BLoWp6CO.js";const w=[{value:"A",label:"A",children:[{value:"B",label:"B",children:[{value:"C",label:"C"}]}]},{value:"D",label:"D",children:[{value:"E",label:"E",children:[{value:"F",label:"F"}]}]}],j={title:"Experimental/Data Entry/Cascader",component:s,args:{allowClear:!0,autoClearSearchValue:!0,autoFocus:!1,bordered:!0,changeOnSelect:!1,className:"",defaultValue:[],disabled:!1,tagRender:void 0,popupClassName:"",dropdownRender:void 0,expandIcon:void 0,expandTrigger:"click",loadData:void 0,maxTagCount:void 0,maxTagPlaceholder:void 0,maxTagTextLength:void 0,notFoundContent:"Not Found",open:void 0,options:w,placeholder:"Placeholder Text",placement:"bottomLeft",showSearch:!1,size:void 0,status:void 0,style:{},suffixIcon:void 0,value:void 0,multiple:!1,removeIcon:void 0,searchValue:void 0,dropdownMenuColumnStyle:void 0,loadingIcon:void 0,showCheckedStrategy:s.SHOW_PARENT,fieldNames:{label:"label",value:"value",children:"children"},displayRender:(e,r)=>e.join("/"),onSearch:e=>{console.log(`Search Value: ${e}`)},onOpenChange:e=>{console.log(`Dropdown Visible: ${e}`)},onChange:(e,r)=>{alert(`Selected Value: ${String(e)}, Selected Options: ${JSON.stringify(r)}`)},getPopupContainer:e=>document.body},argTypes:{placement:{control:"select",options:["bottomLeft","bottomRight","topLeft","topRight"]},size:{control:"select",options:["small","middle","large"]},status:{control:"select",options:["error","warning"]},showCheckedStrategy:{control:"select",options:[s.SHOW_PARENT,s.SHOW_CHILD]}}},n={},t={args:{allowClear:!0}},l={args:{autoFocus:!0}},c={args:{expandTrigger:"hover"}},i={args:{bordered:!1}},d={args:{multiple:!0}},p={args:{showSearch:!0}},u={args:{dropdownMenuColumnStyle:{minWidth:"15px",color:"blueviolet"}}},m={args:{suffixIcon:a.jsx(L,{name:"mpLogo"})}},g={args:{displayRender:(e,r)=>e.join(" -> ")}},h={args:{disabled:!0}},b={args:{options:[{value:"A",label:"A",children:[{value:"B",label:"B",children:[{value:"C",label:"C"}]}]},{value:"D",label:"D",children:[{value:"E",label:"E",disabled:!0,children:[{value:"F",label:"F"}]}]}]}},S={args:{defaultValue:["A","B","C"]}},v={render:()=>{const[e,r]=D.useState("Unselect");return a.jsx(a.Fragment,{children:a.jsx(E,{title:"Separate trigger button and result.",children:a.jsxs("span",{children:[e," ",a.jsx(s,{options:w,onChange:(O,f)=>{r(f.map(y=>y.label).join(", "))},children:a.jsx("a",{children:"Change city"})})]})})})}},C={render:()=>{const e=[{value:"A",label:"A",isLeaf:!1},{value:"B",label:"B",isLeaf:!1}],[r,O]=D.useState(e),f=(x,o)=>{console.log(x,o)},y=x=>{const o=x?.[x.length-1];o&&setTimeout(()=>{o.children=[{label:`${o.label} Dynamic 1`,value:"dynamic1"},{label:`${o.label} Dynamic 2`,value:"dynamic2"}],O([...r])},1e3)};return a.jsx(a.Fragment,{children:a.jsx(E,{title:"Load options lazily with loadData.",children:a.jsx(s,{options:r,loadData:y,onChange:f,changeOnSelect:!0})})})}};n.parameters={...n.parameters,docs:{...n.parameters?.docs,source:{originalSource:"{}",...n.parameters?.docs?.source}}};t.parameters={...t.parameters,docs:{...t.parameters?.docs,source:{originalSource:`{
  args: {
    allowClear: true
  }
...
}`,...C.parameters?.docs?.source}}};const A=["Primary","AllowClear","AutoFocus","HoverExpand","NoBorder","MultipleCascader","SearchIcon","CustomDropdownStyle","SuffixIcon","DisplayRender","Disabled","DisabledOption","DefaultValue","ExampleCustomTrigger","ExampleLazyLoad"],F=Object.freeze(Object.defineProperty({__proto__:null,AllowClear:t,AutoFocus:l,CustomDropdownStyle:u,DefaultValue:S,Disabled:h,DisabledOption:b,DisplayRender:g,ExampleCustomTrigger:v,ExampleLazyLoad:C,HoverExpand:c,MultipleCascader:d,NoBorder:i,Primary:n,SearchIcon:p,SuffixIcon:m,__namedExportsOrder:A,default:j},Symbol.toStringTag,{value:"Module"}));export{F as C,j as m};
