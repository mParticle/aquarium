...
}`},(_e=(Pe=L.parameters)==null?void 0:Pe.docs)==null?void 0:_e.source)})});var Ae,Oe,Te;R.parameters=r(t({},R.parameters),{docs:r(t({},(Ae=R.parameters)==null?void 0:Ae.docs),{source:t({originalSource:`{
  render: () => {
...
}`},(Te=(Oe=R.parameters)==null?void 0:Oe.docs)==null?void 0:Te.source)})});var Me,Ie,He;P.parameters=r(t({},P.parameters),{docs:r(t({},(Me=P.parameters)==null?void 0:Me.docs),{source:t({originalSource:`{
  render: () => {
    const {
      useToken
    } = theme;
...
}`},(We=(Ge=_.parameters)==null?void 0:Ge.docs)==null?void 0:We.source)})});var Ne,Ye,Ke;A.parameters=r(t({},A.parameters),{docs:r(t({},(Ne=A.parameters)==null?void 0:Ne.docs),{source:t({originalSource:`{
  render: () => {
    const items: MenuProps['items'] = [{
...
}`},(Ke=(Ye=A.parameters)==null?void 0:Ye.docs)==null?void 0:Ke.source)})});var $e,Fe,qe;O.parameters=r(t({},O.parameters),{docs:r(t({},($e=O.parameters)==null?void 0:$e.docs),{source:t({originalSource:`{
  render: () => {
    const items: MenuProps['items'] = [{
      key: '1',
      label: 'Item 1'
...
}`},(qe=(Fe=O.parameters)==null?void 0:Fe.docs)==null?void 0:qe.source)})});var Je,Qe,Ue;T.parameters=r(t({},T.parameters),{docs:r(t({},(Je=T.parameters)==null?void 0:Je.docs),{source:t({originalSource:`{
  render: () => {
    const items: MenuProps['items'] = [{
      label: '1st menu item',
      key: '1'
...
}`},(Ue=(Qe=T.parameters)==null?void 0:Qe.docs)==null?void 0:Ue.source)})});var Ve,Xe,Ze;M.parameters=r(t({},M.parameters),{docs:r(t({},(Ve=M.parameters)==null?void 0:Ve.docs),{source:t({originalSource:`{
  render: () => {
    const items: MenuProps['items'] = [{
      key: '1',
      type: 'group',
