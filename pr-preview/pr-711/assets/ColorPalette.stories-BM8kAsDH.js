...
}`},(_o=(Qo=x.parameters)==null?void 0:Qo.docs)==null?void 0:_o.source)})});var Oo,Xo,Go;p.parameters=c(s({},p.parameters),{docs:c(s({},(Oo=p.parameters)==null?void 0:Oo.docs),{source:s({originalSource:`{
  render: () => {
    const semanticRows = [{
      swatch: ColorPrimary,
      name: 'Primary',
...
}`},(Go=(Xo=p.parameters)==null?void 0:Xo.docs)==null?void 0:Go.source)})});var Yo,qo,Jo;h.parameters=c(s({},h.parameters),{docs:c(s({},(Yo=h.parameters)==null?void 0:Yo.docs),{source:s({originalSource:`{
  render: () => {
    return <>
        <h2>Text Colors</h2>
        <table style={{
...
}`},(Jo=(qo=h.parameters)==null?void 0:qo.docs)==null?void 0:Jo.source)})});var Ko,Uo,Zo;g.parameters=c(s({},g.parameters),{docs:c(s({},(Ko=g.parameters)==null?void 0:Ko.docs),{source:s({originalSource:`{
  render: () => {
    return <>
        <h2>Icon Colors</h2>
        <table style={{
