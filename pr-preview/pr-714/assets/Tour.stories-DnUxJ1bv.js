import{j as e}from"./jsx-runtime-u17CrQMm.js";import{r as s}from"./iframe-ZAwtOOsv.js";import{p as a,q as p,I as l}from"./UnauthorizedTooltip-C-uexwNG.js";import"./ErrorStateIcon-B6JkuEkJ.js";import"./SuccessStateIcon-BoEEKEoh.js";import"./WarningStateIcon-DvK-CXgy.js";const c={title:"Components/Not Prod Ready/Data Display/Tour",component:a,args:{}},t={render:()=>{const o=s.useRef(null),[n,r]=s.useState(!0),i=[{title:"Navigate mParticle effortlessly!",description:"Switch between product suites anytime using this selector.",placement:"right",target:()=>o.current}];return e.jsxs(e.Fragment,{children:[e.jsx("div",{ref:o,children:e.jsx(p,{label:"Data Platform",icon:e.jsx(l,{name:"siteMap"}),onSuiteLogoClick:()=>{r(!0)}})}),e.jsx(a,{mask:!1,type:"primary",open:n,onClose:()=>{r(!1)},steps:i})]})}};t.parameters={...t.parameters,docs:{...t.parameters?.docs,source:{originalSource:`{
  render: () => {
