import{h as o}from"./UnauthorizedTooltip-C-uexwNG.js";const{expect:r,screen:c,userEvent:l}=__STORYBOOK_MODULE_TEST__,s={title:"Components/Data Entry/Select",component:o,tags:["play-test-validation"],args:{}},e={args:{placeholder:"Select Environment",options:[{label:"All",value:"all"},{label:"Prod",value:"prod"},{label:"Dev",value:"dev"}],style:{width:"180px"}},play:async a=>{const t=a.canvasElement.querySelector(".ant-select");if(!t)throw new Error("Select element not found");await l.click(t);const n=await c.findByText("Prod");await r(n).toBeInTheDocument(),await l.click(n)}};e.parameters={...e.parameters,docs:{...e.parameters?.docs,source:{originalSource:`{
  args: {
