import{j as e}from"./jsx-runtime-u17CrQMm.js";import{r as o}from"./iframe-ZAwtOOsv.js";import{aB as p,b as c,F as v,I as U}from"./UnauthorizedTooltip-C-uexwNG.js";import{E as L}from"./ErrorStateIcon-B6JkuEkJ.js";import{S as V}from"./SuccessStateIcon-BoEEKEoh.js";import{W as w}from"./WarningStateIcon-DvK-CXgy.js";import{S as B,aT as W,G as H}from"./style-BLGxefMg.js";import"./preload-helper-PPVm8Dsz.js";import"./LightTheme-BtoaoHMG.js";import"./row-_uEFDODe.js";import"./Context-D1vOXvMD.js";import"./useToken-xerQhSdt.js";import"./presets-C7IxLGBr.js";import"./index-BkWt5-fR.js";import"./index-CKTaITbW.js";import"./AntdIcon-CLyLtIX5.js";import"./client-D5Z-HDZA.js";import"./WarningFilled-DrGq8YeO.js";const b={LIGHT:"light",DUO_TONE:"duo-tone"},Y=["xxxxl","xxxl","xxl","xl","lg","md","sm","xs"],X=["default","primary","success","warning","error","info","white","black","text","strong","brand"],x={UI_ACTION_PATTERNS:["accept","close","edit","delete","copy","add","remove","unlock","lock","play","pause","run","filter","search","upload","next","previous","back","openTab","fullScreen","fitToScreen","zoomIn","zoomOut","jumpTo","moreActions","dragAndDrop","reorder","refresh","clone","boost","submitFeedback","dropdown","logout","moveToTop"],INFORMATIONAL_PATTERNS:["info","help","history","hybrid","notification","active","cohort","funnel","group","placeholder","privileges","textWidget","annotation","generic","calculatedAttribute","conversion","criteriaGroup","audienceGroup","abSplit","account","user","users","viewOnly","premium","agentCopilot","refreshFrequency","stateError","bannerFreemium","toggleLogicBlocks"],DATA_TYPE_PATTERNS:["array","boolean","number","string","timestamp","list","otherData","stateEmpty","stateNoResults"],NAVIGATION_PATTERNS:["catalog","directory","dsr","enrichment","forwarding","journeyAnalysis","liveStream","observability","systemAlerts","transformation","userProfiles"]},N=(d,s)=>s.some(y=>d.includes(y)),A=d=>d.filter(s=>!p[s].deprecated),m=({color:d="black",size:s="lg",name:y,variant:R})=>{const n=Object.keys(p),g={display:"grid",gridTemplateColumns:"repeat(6, 1fr)",gap:B,alignItems:"center",justifyItems:"center"},a={marginBottom:W},P={marginBottom:H};if(y)return e.jsx("div",{style:g,children:j(y)});const I=t=>{const r=[],l=[];return t.forEach(u=>{p[u].default===b.DUO_TONE?l.push(u):r.push(u)}),{lightIcons:r,duotoneIcons:l}},i=(t,r,l=5)=>r.length===0?null:e.jsxs("div",{style:P,children:[e.jsx(c.Title,{level:l,children:t}),e.jsx("div",{style:g,children:r.sort().map(j)})]}),h=o.useMemo(()=>A(n.filter(t=>N(t,x.UI_ACTION_PATTERNS))),[n]),G=["api","audiences","database","dashboard","date","devices","identity","organization","predictions","scheduledReport","segmentationAnalysis","flag","insights","link","favorite","paywall","pipelines","precision","rateDown","rateStar","rateUp","settings","support","selected"],S=o.useMemo(()=>A(n.filter(t=>N(t,x.INFORMATIONAL_PATTERNS)||G.includes(t)||t.includes("other")&&t!=="otherData")),[n]),F=["empty","event","eventAttribute","userAttribute"],f=o.useMemo(()=>A(n.filter(t=>N(t,x.DATA_TYPE_PATTERNS)||F.includes(t))),[n]),z=["connections","savedProjects","privacy","setup"],T=o.useMemo(()=>A(n.filter(t=>N(t,x.NAVIGATION_PATTERNS)||z.includes(t))),[n]),k=o.useMemo(()=>n.filter(t=>p[t].deprecated),[n]),D=o.useMemo(()=>n.filter(t=>!p[t].deprecated&&!h.includes(t)&&!S.includes(t)&&!f.includes(t)&&!T.includes(t)),[n,h,S,f,T]),O=o.useMemo(()=>I(h),[h]),_=o.useMemo(()=>I(S),[S]),E=o.useMemo(()=>I(f),[f]),M=o.useMemo(()=>I(T),[T]),C=o.useMemo(()=>I(D),[D]);return e.jsxs("div",{children:[e.jsxs("div",{style:a,children:[e.jsx(c.Title,{level:4,children:"Special Icons"}),e.jsxs("div",{style:g,children:[e.jsxs(v,{vertical:!0,align:"center",children:[e.jsx(L,{size:s}),e.jsx("p",{style:{fontFamily:"monospace",textAlign:"center"},children:"ErrorStateIcon"})]},"error-state-icon"),e.jsxs(v,{vertical:!0,align:"center",children:[e.jsx(w,{size:s}),e.jsx("p",{style:{fontFamily:"monospace",textAlign:"center"},children:"WarningStateIcon"})]},"warning-state-icon"),e.jsxs(v,{vertical:!0,align:"center",children:[e.jsx(V,{size:s}),e.jsx("p",{style:{fontFamily:"monospace",textAlign:"center"},children:"SuccessStateIcon"})]},"success-state-icon")]})]}),e.jsxs("div",{style:a,children:[e.jsx(c.Title,{level:4,children:"UI Actions"}),i("Light",O.lightIcons),i("Duotone",O.duotoneIcons)]}),e.jsxs("div",{style:a,children:[e.jsx(c.Title,{level:4,children:"Informational Icons"}),i("Light",_.lightIcons),i("Duotone",_.duotoneIcons)]}),e.jsxs("div",{style:a,children:[e.jsx(c.Title,{level:4,children:"Data Type Icons"}),i("Light",E.lightIcons),i("Duotone",E.duotoneIcons)]}),e.jsxs("div",{style:a,children:[e.jsx(c.Title,{level:4,children:"Navigation"}),i("Light",M.lightIcons),i("Duotone",M.duotoneIcons)]}),D.length>0&&e.jsxs("div",{style:a,children:[e.jsx(c.Title,{level:4,children:"Other Icons"}),i("Light",C.lightIcons),i("Duotone",C.duotoneIcons)]}),e.jsxs("div",{style:a,children:[e.jsx(c.Title,{level:4,type:"secondary",children:"Deprecated Icons"}),e.jsx("div",{style:g,children:k.sort().map(j)})]})]});function j(t){const l=p[t].deprecated,u=l?{textDecoration:"line-through"}:{};return e.jsxs(v,{vertical:!0,align:"center",children:[e.jsx(U,{name:t,size:s,color:d,variant:R}),e.jsxs("p",{style:{fontFamily:"monospace",textAlign:"center",...u},children:[l?"deprecated ":"",t]})]},t)}},$=`
...
`,me={title:"Components/General/Icons",component:m,argTypes:{size:{control:"select",options:Y},color:{control:"select",options:X},variant:{control:"select",options:Object.values(b)}},parameters:{docs:{description:{component:$}}}};m.parameters={...m.parameters,docs:{...m.parameters?.docs,source:{originalSource:`({
  color = 'black',
  size = 'lg',
  name,
  variant
...
}`,...m.parameters?.docs?.source}}};const ye=["IconTable"];export{m as IconTable,ye as __namedExportsOrder,me as default};
