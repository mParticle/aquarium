import{j as e}from"./jsx-runtime-u17CrQMm.js";import{r as S}from"./iframe-ZAwtOOsv.js";import{A as a,I as r,a as n,B as f,c as E}from"./UnauthorizedTooltip-C-uexwNG.js";import"./ErrorStateIcon-B6JkuEkJ.js";import"./SuccessStateIcon-BoEEKEoh.js";import"./WarningStateIcon-DvK-CXgy.js";import{E as i}from"./ExampleStory-B49bSB_-.js";import"./preload-helper-PPVm8Dsz.js";import"./LightTheme-BtoaoHMG.js";import"./row-_uEFDODe.js";import"./Context-D1vOXvMD.js";import"./useToken-xerQhSdt.js";import"./presets-C7IxLGBr.js";import"./index-BkWt5-fR.js";import"./index-CKTaITbW.js";import"./AntdIcon-CLyLtIX5.js";import"./style-BLGxefMg.js";import"./client-D5Z-HDZA.js";import"./WarningFilled-DrGq8YeO.js";const V={title:"Components/Not Prod Ready/Data Display/Avatar",component:a,args:{alt:"Avatar",gap:4,icon:e.jsx(r,{name:"alicorn",size:"lg",color:"white"}),shape:"circle",size:"default",src:void 0,srcSet:void 0,draggable:!0,crossOrigin:"",onError:()=>!0},argTypes:{crossOrigin:{control:"select",options:["anonymous","use-credentials",""]},shape:{control:"select",options:["circle","square"]},draggable:{control:"select",options:[!0,!1,"true","false"]},icon:{control:"select",options:["Users","Sparkles"],mapping:{Users:e.jsx(r,{name:"users"}),Sparkles:e.jsx(r,{name:"predictions",variant:"duo-tone"})}}}},l={},p={args:{shape:"square"}},m={args:{size:"large"}},d={args:{size:"small"}},u={args:{size:{xs:24,sm:32,md:40,lg:64,xl:80,xxl:120}}},g={args:{icon:"Sparkles"}},x={render:()=>e.jsx(i,{title:"Four sizes and two shapes are available.",children:e.jsxs(n,{orientation:"vertical",size:16,children:[e.jsxs(n,{wrap:!0,size:16,children:[e.jsx(a,{size:64,icon:e.jsx(r,{name:"alicorn"})}),e.jsx(a,{size:"large",icon:e.jsx(r,{name:"alicorn"})}),e.jsx(a,{icon:e.jsx(r,{name:"alicorn"})}),e.jsx(a,{size:"small",icon:e.jsx(r,{name:"alicorn"})})]}),e.jsxs(n,{wrap:!0,size:16,children:[e.jsx(a,{shape:"square",size:64,icon:e.jsx(r,{name:"alicorn"})}),e.jsx(a,{shape:"square",size:"large",icon:e.jsx(r,{name:"alicorn"})}),e.jsx(a,{shape:"square",icon:e.jsx(r,{name:"alicorn"})}),e.jsx(a,{shape:"square",size:"small",icon:e.jsx(r,{name:"alicorn"})})]})]})})},h={render:()=>{const s="https://gw.alipayobjects.com/zos/rmsportal/KDpgvguMpGfqaHPjicRK.svg";return e.jsx(i,{title:"Image, Icon and letter are supported, and the latter two kinds of avatar can have custom colors and background colors.",children:e.jsxs(n,{size:16,wrap:!0,children:[e.jsx(a,{icon:e.jsx(r,{name:"alicorn"})}),e.jsx(a,{children:"U"}),e.jsx(a,{size:40,children:"USER"}),e.jsx(a,{src:s}),e.jsx(a,{src:e.jsx("img",{src:s,alt:"avatar"})}),e.jsx(a,{style:{backgroundColor:"#fde3cf",color:"#f56a00"},children:"U"}),e.jsx(a,{style:{backgroundColor:"#87d068"},icon:e.jsx(r,{name:"alicorn"})})]})})}},j={render:()=>e.jsx(i,{title:"Usually used for reminders and notifications.",children:e.jsxs(n,{size:24,children:[e.jsx(f,{count:1,children:e.jsx(a,{shape:"square",icon:e.jsx(r,{name:"alicorn"})})}),e.jsx(f,{dot:!0,children:e.jsx(a,{shape:"square",icon:e.jsx(r,{name:"alicorn"})})})]})})},v={render:()=>e.jsx(i,{title:"Avatar size can be automatically adjusted based on the screen size.",children:e.jsx(a,{size:{xs:24,sm:32,md:40,lg:64,xl:80,xxl:100},icon:e.jsx(r,{name:"alicorn"})})})},z={render:()=>{const s=["Edward","U","Lucy","Tom"],c=["#f56a00","#7265e6","#ffbf00","#00a2ae"],t=[4,3,2,1],[y,U]=S.useState(s[0]),[C,b]=S.useState(c[0]),[A,L]=S.useState(t[0]),w=()=>{const o=s.indexOf(y);U(o<s.length-1?s[o+1]:s[0]),b(o<c.length-1?c[o+1]:c[0])},I=()=>{const o=t.indexOf(A);L(o<t.length-1?t[o+1]:t[0])};return e.jsxs(i,{title:"For letter type Avatar, when the letters are too long to display, the font size can be automatically adjusted according to the width of the Avatar. You can also use gap to set the unit distance between left and right sides.",children:[e.jsx(a,{style:{backgroundColor:C,verticalAlign:"middle"},size:"large",gap:A,children:y}),e.jsx(E,{size:"small",style:{margin:"0 16px",verticalAlign:"middle"},onClick:w,children:"ChangeUser"}),e.jsx(E,{size:"small",style:{verticalAlign:"middle"},onClick:I,children:"changeGap"})]})}};l.parameters={...l.parameters,docs:{...l.parameters?.docs,source:{originalSource:"{}",...l.parameters?.docs?.source}}};p.parameters={...p.parameters,docs:{...p.parameters?.docs,source:{originalSource:`{
  args: {
    shape: 'square'
  }
...
}`,...z.parameters?.docs?.source}}};const X=["Primary","Square","Large","Small","CustomSizes","CustomIcon","ExampleBasic","ExampleTypes","ExampleWithBadge","ExampleResponsive","ExampleAutosetFontSize"];export{g as CustomIcon,u as CustomSizes,z as ExampleAutosetFontSize,x as ExampleBasic,v as ExampleResponsive,h as ExampleTypes,j as ExampleWithBadge,m as Large,l as Primary,d as Small,p as Square,X as __namedExportsOrder,V as default};
