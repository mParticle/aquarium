import{j as e}from"./jsx-runtime-u17CrQMm.js";import{r as u}from"./iframe-ZAwtOOsv.js";import{r as i,u as k,a as z,I,F as V}from"./UnauthorizedTooltip-C-uexwNG.js";import"./ErrorStateIcon-B6JkuEkJ.js";import"./SuccessStateIcon-BoEEKEoh.js";import"./WarningStateIcon-DvK-CXgy.js";import{E as m}from"./ExampleStory-B49bSB_-.js";import"./preload-helper-PPVm8Dsz.js";import"./LightTheme-BtoaoHMG.js";import"./row-_uEFDODe.js";import"./Context-D1vOXvMD.js";import"./useToken-xerQhSdt.js";import"./presets-C7IxLGBr.js";import"./index-BkWt5-fR.js";import"./index-CKTaITbW.js";import"./AntdIcon-CLyLtIX5.js";import"./style-BLGxefMg.js";import"./client-D5Z-HDZA.js";import"./WarningFilled-DrGq8YeO.js";const O=[{label:"The quick brown fox jumps over the lazy dog",value:1},{label:"Waxy and quivering, jocks fumble the pizza",value:2},{label:"When zombies arrive, quickly fax judge Pat",value:3},{label:"Pack my red box with five dozen quality jugs",value:4},{label:"The quick onyx goblin jumps over the lazy dwarf",value:5}],Z={title:"Components/Not Prod Ready/Data Entry/Auto Complete",component:t=>{const[s,l]=u.useState(""),[n,r]=u.useState([]),a=c=>c?O.filter(h=>h.label.toLowerCase().includes(c.toLowerCase())):[],o=c=>{r(a(c))},d=c=>{console.log("you selected value: "+c)};return e.jsx(e.Fragment,{children:e.jsx(i,{...t,value:s,options:n,onSelect:d,onSearch:o,onChange:l})})},args:{allowClear:!1,autoFocus:!1,backfill:!1,bordered:!0,defaultActiveFirstOption:!0,options:O,defaultOpen:void 0,defaultValue:void 0,disabled:!1,popupClassName:void 0,open:void 0,placeholder:"Search AutoComplete",status:void 0,style:{width:200},value:void 0,onBlur:()=>{console.log("Blur Event")},onChange:t=>{alert(`Selected Value: ${t}`)},onDropdownVisibleChange:t=>{console.log(`Dropdown Open: ${t}`)},onFocus:()=>{console.log("Focus Event")},onSearch:t=>{alert(`Search Value: ${t}`)},onSelect:(t,s)=>{alert(`Selected Value: ${t}, Option: ${String(s.label)}`)},onClear:()=>{alert("Clear Event")}},argTypes:{status:{control:"select",options:["error","warning"]}}},g={args:{allowClear:!0}},x={args:{placeholder:"Custom Placeholder Text"}},S={args:{disabled:!0}},C={args:{notFoundContent:e.jsx(e.Fragment,{children:"Custom Not Found Component goes here"})}},y={args:{bordered:!1}},b={render:()=>{const[t,s]=u.useState(""),[l,n]=u.useState([]),[r,a]=u.useState([]),o=(p,F=1)=>({value:p.repeat(F)}),d=p=>p?[o(p),o(p,2),o(p,3)]:[],c=p=>{alert("onSelect:"+p)},h=p=>{s(p)};return e.jsx(e.Fragment,{children:e.jsxs(m,{title:"Basic Usage, set data source of autocomplete with options property.",children:[e.jsx(i,{options:l,style:{width:200},onSelect:c,onSearch:p=>{n(d(p))},placeholder:"input here"}),e.jsx("br",{}),e.jsx("br",{}),e.jsx(i,{value:t,options:r,style:{width:200},onSelect:c,onSearch:p=>{a(d(p))},onChange:h,placeholder:"control mode"})]})})}},w={render:()=>{const[t,s]=u.useState([]),l=n=>{let r;!n||n.includes("@")?r=[]:r=["gmail.com","163.com","qq.com"].map(a=>({value:n,label:`${n}@${a}`})),s(r)};return e.jsx(e.Fragment,{children:e.jsx(m,{title:"You could set custom Option label.",children:e.jsx(i,{style:{width:200},onSearch:l,placeholder:"input here",options:t})})})}},A={render:()=>{const[t,s]=u.useState([]),l=a=>{s(a?[{value:a},{value:a+a},{value:a+a+a}]:[])},n=a=>{console.log("handleKeyPress",a)},r=a=>{alert("selected: "+a)};return e.jsx(m,{title:"Customize Input Component",children:e.jsx(i,{options:t,style:{width:200},onSelect:r,onSearch:l,children:e.jsx(k.TextArea,{placeholder:"input here",className:"custom",style:{height:50},onKeyPress:n})})})}},f={render:()=>e.jsx(e.Fragment,{children:e.jsx(m,{title:"A non-case-sensitive AutoComplete.",children:e.jsx(i,{style:{width:200},options:O.map(t=>({...t,label:t.label.toUpperCase()})),placeholder:"try to type `b`",filterOption:(t,s)=>s?.label?.toString().toUpperCase().includes(t.toUpperCase())??!1})})})},j={render:()=>{const t=n=>e.jsxs("span",{children:[n,e.jsx("a",{style:{float:"right"},href:"https://www.google.com/search?q=antd",target:"_blank",rel:"noopener noreferrer",children:"more"})]}),s=(n,r)=>({value:n,label:e.jsxs(V,{justify:"space-between",children:[n,e.jsxs("span",{children:[e.jsx(I,{name:"mpLogo"}),r]})]})}),l=[{label:t("Libraries"),options:[s("AntDesign",1e4),s("AntDesign UI",10600)]},{label:t("Solutions"),options:[s("AntDesign UI FAQ",60100),s("AntDesign FAQ",30010)]},{label:t("Articles"),options:[s("AntDesign design language",1e5)]}];return e.jsx(e.Fragment,{children:e.jsx(m,{title:e.jsxs(e.Fragment,{children:["Demonstration of"," ",e.jsx("a",{href:"https://ant.design/docs/spec/reaction/#lookup-patterns",target:"_blank",rel:"noreferrer",children:"Lookup Patterns: Certain Category"}),"Basic Usage, set options of autocomplete with options property."]}),children:e.jsx(i,{popupClassName:"certain-category-search-dropdown",popupMatchSelectWidth:500,style:{width:250},options:l,size:"large",children:e.jsx(k.Search,{size:"large",placeholder:"input here"})})})})}},v={render:()=>{const t=(o,d=0)=>Math.floor(Math.random()*(o-d+1))+d,s=o=>new Array(t(5)).join(".").split(".").map((d,c)=>{const h=`${o}${c}`;return{value:h,label:e.jsxs(V,{justify:"space-between",children:[e.jsxs("span",{children:["Found ",o," on"," ",e.jsx("a",{href:`https://s.taobao.com/search?q=${o}`,target:"_blank",rel:"noopener noreferrer",children:h})]}),e.jsxs("span",{children:[t(200,100)," results"]})]})}}),[l,n]=u.useState([]),r=o=>{n(o!==""?s(o):[])},a=o=>{alert("selected: "+o)};return e.jsx(e.Fragment,{children:e.jsx(m,{title:e.jsxs(e.Fragment,{children:["Demonstration of"," ",e.jsx("a",{href:"https://ant.design/docs/spec/reaction#lookup-patterns",target:"_blank",rel:"noreferrer",children:"Lookup Patterns: Certain Category"}),"Basic Usage, set options of autocomplete with options property."]}),children:e.jsx(i,{popupMatchSelectWidth:252,style:{width:300},options:l,onSelect:a,onSearch:r,size:"large",children:e.jsx(k.Search,{size:"large",placeholder:"input here",enterButton:!0})})})})}},P={render:()=>{const t=(o,d=1)=>({value:o.repeat(d)}),[s,l]=u.useState([]),[n,r]=u.useState([]),a=o=>o?[t(o),t(o,2),t(o,3)]:[];return e.jsx(m,{title:"Add status to AutoComplete with status, which could be error or warning.",children:e.jsxs(z,{orientation:"vertical",style:{width:"100%"},children:[e.jsx(i,{placeholder:"Error",options:s,onSearch:o=>{l(a(o))},status:"error",style:{width:200}}),e.jsx(i,{placeholder:"Warning",options:n,onSearch:o=>{r(a(o))},status:"warning",style:{width:200}})]})})}},E={render:()=>{const t=(r,a=1)=>({value:r.repeat(a)}),[s,l]=u.useState([]),n=r=>r?[t(r),t(r,2),t(r,3)]:[];return e.jsx(e.Fragment,{children:e.jsxs(m,{title:"Customize clear button",children:[e.jsx(i,{options:s,style:{width:200},onSearch:r=>{l(n(r))},placeholder:"No clear icon",allowClear:!1}),e.jsx("br",{}),e.jsx("br",{}),e.jsx(i,{options:s,style:{width:200},onSearch:r=>{l(n(r))},placeholder:"Customized clear icon",allowClear:{clearIcon:e.jsx(I,{name:"mpLogo"})}})]})})}};g.parameters={...g.parameters,docs:{...g.parameters?.docs,source:{originalSource:`{
  args: {
    allowClear: true
  }
...
}`,...E.parameters?.docs?.source}}};const ee=["ClearButton","Placeholder","Disabled","NotFound","Borderless","ExampleBasic","ExampleCustomized","ExampleCustomizeInput","ExampleNonCaseSensitive","ExampleLookupPatternsCertainCategory","ExampleLookupPatternsUnCertainCategory","ExampleStatus","ExampleClearButton"];export{y as Borderless,g as ClearButton,S as Disabled,b as ExampleBasic,E as ExampleClearButton,A as ExampleCustomizeInput,w as ExampleCustomized,j as ExampleLookupPatternsCertainCategory,v as ExampleLookupPatternsUnCertainCategory,f as ExampleNonCaseSensitive,P as ExampleStatus,C as NotFound,x as Placeholder,ee as __namedExportsOrder,Z as default};
