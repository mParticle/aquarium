import{j as e}from"./jsx-runtime-u17CrQMm.js";import{useMDXComponents as l}from"./index-BkeRIKkE.js";import"./iframe-DPsSDxI5.js";import"./preload-helper-PPVm8Dsz.js";function i(t){const n={h1:"h1",h3:"h3",h4:"h4",p:"p",...l(),...t.components};return e.jsxs(e.Fragment,{children:[e.jsx(n.h1,{id:"table-cells",children:"Table Cells"}),`
...
`,e.jsx(n.p,{children:"Text content within table cells is typically left-aligned to enhance readability and allow for easier scanning of information."})]})}function r(t={}){const{wrapper:n}={...l(),...t.components};return n?e.jsx(n,{...t,children:e.jsx(i,{...t})}):i(t)}export{r as default};
