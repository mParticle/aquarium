import{j as a}from"./jsx-runtime-u17CrQMm.js";import{s as r,I as L}from"./UnauthorizedTooltip-C-uexwNG.js";import"./ErrorStateIcon-B6JkuEkJ.js";import"./SuccessStateIcon-BoEEKEoh.js";import"./WarningStateIcon-DvK-CXgy.js";import{E as O}from"./ExampleStory-B49bSB_-.js";import{r as E}from"./iframe-ZAwtOOsv.js";const w=[{value:"A",label:"A",children:[{value:"B",label:"B",children:[{value:"C",label:"C"}]}]},{value:"D",label:"D",children:[{value:"E",label:"E",children:[{value:"F",label:"F"}]}]}],A={title:"Components/Not Prod Ready/Data Entry/Cascader",component:r,args:{allowClear:!0,autoClearSearchValue:!0,autoFocus:!1,bordered:!0,changeOnSelect:!1,className:"",defaultValue:[],disabled:!1,tagRender:void 0,popupClassName:"",dropdownRender:void 0,expandIcon:void 0,expandTrigger:"click",loadData:void 0,maxTagCount:void 0,maxTagPlaceholder:void 0,maxTagTextLength:void 0,notFoundContent:"Not Found",open:void 0,options:w,placeholder:"Placeholder Text",placement:"bottomLeft",showSearch:!1,size:void 0,status:void 0,style:{},suffixIcon:void 0,value:void 0,multiple:!1,removeIcon:void 0,searchValue:void 0,dropdownMenuColumnStyle:void 0,loadingIcon:void 0,showCheckedStrategy:r.SHOW_PARENT,fieldNames:{label:"label",value:"value",children:"children"},displayRender:(e,o)=>e.join("/"),onSearch:e=>{console.log(`Search Value: ${e}`)},onDropdownVisibleChange:e=>{console.log(`Dropdown Visible: ${e}`)},onChange:(e,o)=>{alert(`Selected Value: ${String(e)}, Selected Options: ${JSON.stringify(o)}`)},getPopupContainer:e=>document.body},argTypes:{placement:{control:"select",options:["bottomLeft","bottomRight","topLeft","topRight"]},size:{control:"select",options:["small","middle","large"]},status:{control:"select",options:["error","warning"]},showCheckedStrategy:{control:"select",options:[r.SHOW_PARENT,r.SHOW_CHILD]}}},n={},t={args:{allowClear:!0}},l={args:{autoFocus:!0}},c={args:{expandTrigger:"hover"}},i={args:{bordered:!1}},d={args:{multiple:!0}},p={args:{showSearch:!0}},u={args:{dropdownMenuColumnStyle:{minWidth:"15px",color:"blueviolet"}}},m={args:{suffixIcon:a.jsx(L,{name:"mpLogo"})}},g={args:{displayRender:(e,o)=>e.join(" -> ")}},h={args:{disabled:!0}},b={args:{options:[{value:"A",label:"A",children:[{value:"B",label:"B",children:[{value:"C",label:"C"}]}]},{value:"D",label:"D",children:[{value:"E",label:"E",disabled:!0,children:[{value:"F",label:"F"}]}]}]}},S={args:{defaultValue:["A","B","C"]}},v={render:()=>{const[e,o]=E.useState("Unselect");return a.jsx(a.Fragment,{children:a.jsx(O,{title:"Separate trigger button and result.",children:a.jsxs("span",{children:[e," ",a.jsx(r,{options:w,onChange:(D,y)=>{o(y.map(f=>f.label).join(", "))},children:a.jsx("a",{children:"Change city"})})]})})})}},C={render:()=>{const e=[{value:"A",label:"A",isLeaf:!1},{value:"B",label:"B",isLeaf:!1}],[o,D]=E.useState(e),y=(x,s)=>{console.log(x,s)},f=x=>{const s=x?.[x.length-1];setTimeout(()=>{s.children=[{label:`${s.label} Dynamic 1`,value:"dynamic1"},{label:`${s.label} Dynamic 2`,value:"dynamic2"}],D([...o])},1e3)};return a.jsx(a.Fragment,{children:a.jsx(O,{title:"Load options lazily with loadData.",children:a.jsx(r,{options:o,loadData:f,onChange:y,changeOnSelect:!0})})})}};n.parameters={...n.parameters,docs:{...n.parameters?.docs,source:{originalSource:"{}",...n.parameters?.docs?.source}}};t.parameters={...t.parameters,docs:{...t.parameters?.docs,source:{originalSource:`{
  args: {
    allowClear: true
  }
