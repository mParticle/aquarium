...
}`},(re=(ee=f.parameters)==null?void 0:ee.docs)==null?void 0:re.source)})});const ye=["Primary","PrimaryWithIcon","Default","DefaultWithIcon","Dashed","DashedWithIcon","Link","LinkWithIcon","IconOnly","Refresh"],Se=Object.freeze(Object.defineProperty({__proto__:null,Dashed:u,DashedWithIcon:h,Default:m,DefaultWithIcon:p,IconOnly:x,Link:y,LinkWithIcon:g,Primary:l,PrimaryWithIcon:d,Refresh:f,__namedExportsOrder:ye,default:he},Symbol.toStringTag,{value:"Module"}));export{Se as B,p as D,x as I,g as L,d as P,l as a,m as b,h as c,u as d,y as e};
