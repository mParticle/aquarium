var Se=Object.defineProperty,ye=Object.defineProperties;var ve=Object.getOwnPropertyDescriptors;var W=Object.getOwnPropertySymbols;var be=Object.prototype.hasOwnProperty,Ee=Object.prototype.propertyIsEnumerable;var R=(s,a,t)=>a in s?Se(s,a,{enumerable:!0,configurable:!0,writable:!0,value:t}):s[a]=t,e=(s,a)=>{for(var t in a||(a={}))be.call(a,t)&&R(s,t,a[t]);if(W)for(var t of W(a))Ee.call(a,t)&&R(s,t,a[t]);return s},r=(s,a)=>ye(s,ve(a));var j=(s,a,t)=>new Promise((n,l)=>{var u=c=>{try{w(t.next(c))}catch(C){l(C)}},xe=c=>{try{w(t.throw(c))}catch(C){l(C)}},w=c=>c.done?n(c.value):Promise.resolve(c.value).then(u,xe);w((t=t.apply(s,a)).next())});import{j as o}from"./jsx-runtime-CVnACwZl.js";import{u as he,c as F,f as B}from"./NavigationItemsService-4v_cF5PP.js";import"./ErrorStateIcon-BRZ77WZC.js";import"./_baseClone-CXAe4HsA.js";import{E as we}from"./ExampleStory-CiNCqn3y.js";import{r as Ce}from"./index-3OP4wdng.js";import{e as A,u as Be}from"./index-BU0ZtLqn.js";import"./LightTheme-BtoaoHMG.js";import"./row-Bsm_WxsR.js";import"./Context-R5ee3nrF.js";import"./useToken-C_i1q6Gz.js";import"./presets-BrZHayqo.js";import"./extends-CF3RwP-h.js";import"./index-B-gr4m3q.js";import"./isNativeReflectConstruct-CWIsGhkf.js";const Ne={title:"Components/Not Prod Ready/Data Entry/Input",component:he,args:{placeholder:"Input Placeholder",addonAfter:void 0,addonBefore:void 0,allowClear:!1,bordered:!0,classNames:{},count:void 0,defaultValue:"",disabled:!1,id:void 0,maxLength:void 0,prefix:void 0,showCount:!1,status:void 0,styles:{},size:"middle",suffix:void 0,type:"text",value:"",onChange:s=>{console.log("Input changed: "+s.target.value)},onPressEnter:s=>{console.log("Enter key pressed: "+String(s))}},argTypes:{status:{control:"select",options:["warning","error"]},size:{control:"select",options:["small","medium","large"]}}},i={args:{status:"error"}},p={args:{type:"textarea"}},m={args:{size:"large"}},d={args:{size:"middle"}},g={args:{size:"small"}},f={},h={args:{addonBefore:"https://",placeholder:"Enter URL"}},x={args:{addonAfter:".com",placeholder:"Domain"}},S={args:{allowClear:!0,placeholder:"Clearable Input"}},y={args:{disabled:!0}},v={args:{maxLength:10,placeholder:"Max 10 characters"}},b={args:{prefix:"@",suffix:".com",placeholder:"Email"}},E={args:{value:"Test value"},render:(s,a)=>{const t=Ce.useRef(null),n=(l="start")=>{var u;(u=t.current)==null||u.focus({cursor:l})};return o.jsx(we,{title:a.name,children:o.jsxs(F,{direction:"vertical",style:{width:"100%"},children:[o.jsxs(F,{wrap:!0,children:[o.jsx(B,{onClick:()=>{n("start")},children:"Focus at start"}),o.jsx(B,{onClick:()=>{n("end")},children:"Focus at last"}),o.jsx(B,{onClick:()=>{n("all")},children:"Focus to select all"})]}),o.jsx("br",{}),o.jsx(he,r(e({},s),{defaultValue:"Welcome to the Aquarium",ref:t}))]})})},play:s=>j(void 0,null,function*(){const a=s.canvasElement.querySelector("input");yield A(a).toBeInTheDocument();const t=s.canvasElement.querySelectorAll("button");yield A(t.length).toBe(3);for(const n of t)a==null||a.blur(),yield Be.click(n),yield A(a).toHaveFocus(),a==null||a.blur()})};var I,k,D;i.parameters=r(e({},i.parameters),{docs:r(e({},(I=i.parameters)==null?void 0:I.docs),{source:e({originalSource:`{
  args: {
    status: 'error'
  }
...
}`},(ne=(oe=y.parameters)==null?void 0:oe.docs)==null?void 0:ne.source)})});var ce,le,ue;v.parameters=r(e({},v.parameters),{docs:r(e({},(ce=v.parameters)==null?void 0:ce.docs),{source:e({originalSource:`{
  args: {
    maxLength: 10,
    placeholder: 'Max 10 characters'
  }
}`},(ue=(le=v.parameters)==null?void 0:le.docs)==null?void 0:ue.source)})});var ie,pe,me;b.parameters=r(e({},b.parameters),{docs:r(e({},(ie=b.parameters)==null?void 0:ie.docs),{source:e({originalSource:`{
  args: {
    prefix: '@',
    suffix: '.com',
    placeholder: 'Email'
...
}`},(fe=(ge=E.parameters)==null?void 0:ge.docs)==null?void 0:fe.source)})});const Ue=["Error","TextArea","Large","Middle","Small","Primary","WithHttpsBefore","WithDotComAfter","AllowClear","Disabled","WithMaxLength","WithPrefixAndSuffix","WithFocusManagement"];export{S as AllowClear,y as Disabled,i as Error,m as Large,d as Middle,f as Primary,g as Small,p as TextArea,x as WithDotComAfter,E as WithFocusManagement,h as WithHttpsBefore,v as WithMaxLength,b as WithPrefixAndSuffix,Ue as __namedExportsOrder,Ne as default};
