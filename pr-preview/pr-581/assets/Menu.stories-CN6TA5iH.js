...
}`},(Oe=(ke=C.parameters)==null?void 0:ke.docs)==null?void 0:Oe.source)})});const Ke=["Primary","Inline","Horizontal","MultipleSelection","CustomExpandIcon","InlineCollapsedState","Dark","CustomStyle","WithSubMenuDelay","ExampleHorizontalTop","ExampleVerticalInline","ExampleCollapsable","ExampleOpenCurrentSubmenu","ExampleVerticalMenu"],ze=Object.freeze(Object.defineProperty({__proto__:null,CustomExpandIcon:m,CustomStyle:k,Dark:b,ExampleCollapsable:S,ExampleHorizontalTop:g,ExampleOpenCurrentSubmenu:x,ExampleVerticalInline:h,ExampleVerticalMenu:C,Horizontal:u,Inline:p,InlineCollapsedState:d,MultipleSelection:y,Primary:c,WithSubMenuDelay:O,__namedExportsOrder:Ke,default:fe},Symbol.toStringTag,{value:"Module"}));export{ze as M,fe as m};
