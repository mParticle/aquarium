...
}`},(Te=(be=x.parameters)==null?void 0:be.docs)==null?void 0:Te.source)})});const Qe=["Primary","Code","Copyable","Deleted","Disabled","Editable","Keyboard","Marked","Strong","Italic","Success","Secondary","Warning","Danger","Underline","CustomOnClick","ExampleLinks"];export{c as Code,p as Copyable,T as CustomOnClick,S as Danger,d as Deleted,g as Disabled,l as Editable,x as ExampleLinks,k as Italic,m as Keyboard,u as Marked,i as Primary,h as Secondary,y as Strong,L as Success,b as Underline,D as Warning,Qe as __namedExportsOrder,Ne as default};
