...
}`},(se=(re=S.parameters)==null?void 0:re.docs)==null?void 0:se.source)})});var ce,pe,me;C.parameters=o(n({},C.parameters),{docs:o(n({},(ce=C.parameters)==null?void 0:ce.docs),{source:n({originalSource:`{
  render: () => {
...
}`},(me=(pe=C.parameters)==null?void 0:pe.docs)==null?void 0:me.source)})});var ue,ye,de;I.parameters=o(n({},I.parameters),{docs:o(n({},(ue=I.parameters)==null?void 0:ue.docs),{source:n({originalSource:`{
  render: () => {
    const items: IMenuProps['items'] = [{
      label: 'Navigation One',
      key: 'sub1',
...
}`},(Oe=(ke=v.parameters)==null?void 0:ke.docs)==null?void 0:Oe.source)})});const Re=["Primary","Inline","Horizontal","MultipleSelection","CustomExpandIcon","InlineCollapsedState","Dark","CustomStyle","WithSubMenuDelay","ExampleHorizontalTop","ExampleVerticalInline","ExampleCollapsable","ExampleOpenCurrentSubmenu","ExampleVerticalMenu"];export{b as CustomExpandIcon,g as CustomStyle,O as Dark,C as ExampleCollapsable,x as ExampleHorizontalTop,I as ExampleOpenCurrentSubmenu,S as ExampleVerticalInline,v as ExampleVerticalMenu,y as Horizontal,u as Inline,k as InlineCollapsedState,d as MultipleSelection,m as Primary,h as WithSubMenuDelay,Re as __namedExportsOrder,Ge as default};
