...
}`},(ue=(pe=S.parameters)==null?void 0:pe.docs)==null?void 0:ue.source)})});var ye,me,de;x.parameters=o(n({},x.parameters),{docs:o(n({},(ye=x.parameters)==null?void 0:ye.docs),{source:n({originalSource:`{
  render: () => {
    const items: IMenuProps['items'] = [{
      label: 'Navigation One',
      key: 'sub1',
...
}`},(de=(me=x.parameters)==null?void 0:me.docs)==null?void 0:de.source)})});var be,ke,Oe;C.parameters=o(n({},C.parameters),{docs:o(n({},(be=C.parameters)==null?void 0:be.docs),{source:n({originalSource:`{
  render: () => {
    const items: IMenuProps['items'] = [{
      label: 'Navigation One',
      key: 'sub1',
...
}`},(Oe=(ke=C.parameters)==null?void 0:ke.docs)==null?void 0:Oe.source)})});const Ke=["Primary","Inline","Horizontal","MultipleSelection","CustomExpandIcon","InlineCollapsedState","Dark","CustomStyle","WithSubMenuDelay","ExampleHorizontalTop","ExampleVerticalInline","ExampleCollapsable","ExampleOpenCurrentSubmenu","ExampleVerticalMenu"],De=Object.freeze(Object.defineProperty({__proto__:null,CustomExpandIcon:m,CustomStyle:k,Dark:b,ExampleCollapsable:S,ExampleHorizontalTop:g,ExampleOpenCurrentSubmenu:x,ExampleVerticalInline:h,ExampleVerticalMenu:C,Horizontal:u,Inline:p,InlineCollapsedState:d,MultipleSelection:y,Primary:c,WithSubMenuDelay:O,__namedExportsOrder:Ke,default:fe},Symbol.toStringTag,{value:"Module"}));export{De as M,fe as m};
