...
}`},(te=(ee=v.parameters)==null?void 0:ee.docs)==null?void 0:te.source)})});var re,oe,se;j.parameters=r(t({},j.parameters),{docs:r(t({},(re=j.parameters)==null?void 0:re.docs),{source:t({originalSource:`{
  render: () => {
...
}`},(se=(oe=j.parameters)==null?void 0:oe.docs)==null?void 0:se.source)})});var ne,ae,ie;f.parameters=r(t({},f.parameters),{docs:r(t({},(ne=f.parameters)==null?void 0:ne.docs),{source:t({originalSource:`{
  render: () => {
...
}`},(ie=(ae=f.parameters)==null?void 0:ae.docs)==null?void 0:ie.source)})});var le,de,ce;S.parameters=r(t({},S.parameters),{docs:r(t({},(le=S.parameters)==null?void 0:le.docs),{source:t({originalSource:`{
  render: () => {
...
}`},(ce=(de=S.parameters)==null?void 0:de.docs)==null?void 0:ce.source)})});var he,pe,ue;C.parameters=r(t({},C.parameters),{docs:r(t({},(he=C.parameters)==null?void 0:he.docs),{source:t({originalSource:`{
  render: () => {
...
}`},(ue=(pe=C.parameters)==null?void 0:pe.docs)==null?void 0:ue.source)})});const Ie=["Primary","WithAutoplay","CustomAutoplaySpeed","CustomDotPosition","WithoutDots","WithFadeEffect","WithLinearEasing","WithoutInfiniteLoop","CustomSpeed","WaitForAnimate","ExampleBasic","ExamplePosition","ExampleAutoScroll","ExampleFadeIn"];export{h as CustomAutoplaySpeed,p as CustomDotPosition,g as CustomSpeed,S as ExampleAutoScroll,j as ExampleBasic,C as ExampleFadeIn,f as ExamplePosition,d as Primary,v as WaitForAnimate,c as WithAutoplay,m as WithFadeEffect,x as WithLinearEasing,u as WithoutDots,y as WithoutInfiniteLoop,Ie as __namedExportsOrder,Le as default};
