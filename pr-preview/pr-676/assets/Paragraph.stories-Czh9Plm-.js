...
}`},(U=(R=u.parameters)==null?void 0:R.docs)==null?void 0:U.source)})});var v,L,W;m.parameters=s(i({},m.parameters),{docs:s(i({},(v=m.parameters)==null?void 0:v.docs),{source:i({originalSource:`{
  render: () => {
...
}`},(W=(L=m.parameters)==null?void 0:L.docs)==null?void 0:W.source)})});const we=["Primary","ExampleEditable","ExampleCopyable","ExampleEllipsis","ExampleSuffix"];export{h as ExampleCopyable,d as ExampleEditable,u as ExampleEllipsis,m as ExampleSuffix,g as Primary,we as __namedExportsOrder,Ce as default};
