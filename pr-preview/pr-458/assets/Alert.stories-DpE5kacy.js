...
}`},(R=(P=u.parameters)==null?void 0:P.docs)==null?void 0:R.source)})});var V,_,Z;y.parameters=n(r({},y.parameters),{docs:n(r({},(V=y.parameters)==null?void 0:V.docs),{source:r({originalSource:`{
  args: {
    closeIcon: <Icon name="mpLogo" />
  }
}`},(Z=(_=y.parameters)==null?void 0:_.docs)==null?void 0:Z.source)})});var q,G,H;E.parameters=n(r({},E.parameters),{docs:n(r({},(q=E.parameters)==null?void 0:q.docs),{source:r({originalSource:`{
  render: () => {
    return <>
...
}`},(H=(G=E.parameters)==null?void 0:G.docs)==null?void 0:H.source)})});var J,K,Q;h.parameters=n(r({},h.parameters),{docs:n(r({},(J=h.parameters)==null?void 0:J.docs),{source:r({originalSource:`{
  render: () => {
    return <>
...
}`},(Q=(K=h.parameters)==null?void 0:K.docs)==null?void 0:Q.source)})});var X,Y,$;T.parameters=n(r({},T.parameters),{docs:n(r({},(X=T.parameters)==null?void 0:X.docs),{source:r({originalSource:`{
  render: () => {
    return <>
...
}`},($=(Y=T.parameters)==null?void 0:Y.docs)==null?void 0:$.source)})});var ee,re,ne;S.parameters=n(r({},S.parameters),{docs:n(r({},(ee=S.parameters)==null?void 0:ee.docs),{source:r({originalSource:`{
  render: () => {
