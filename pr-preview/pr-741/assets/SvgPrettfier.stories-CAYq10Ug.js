...
`,V={title:"Contributing/Tooling/SVGPrettifier",component:b,parameters:{docs:{description:{component:P}}}},c={};c.parameters={...c.parameters,docs:{...c.parameters?.docs,source:{originalSource:"{}",...c.parameters?.docs?.source}}};const F=["Primary"];export{c as Primary,F as __namedExportsOrder,V as default};
