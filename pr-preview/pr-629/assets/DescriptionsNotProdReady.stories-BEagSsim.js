...
}`},(N=(L=x.parameters)==null?void 0:L.docs)==null?void 0:N.source)})});var Y,_,X;g.parameters=a(r({},g.parameters),{docs:a(r({},(Y=g.parameters)==null?void 0:Y.docs),{source:r({originalSource:`{
  args: {
    labelStyle: {
      fontWeight: 'bold'
    }
  }
}`},(X=(_=g.parameters)==null?void 0:_.docs)==null?void 0:X.source)})});var q,J,K;h.parameters=a(r({},h.parameters),{docs:a(r({},(q=h.parameters)==null?void 0:q.docs),{source:r({originalSource:`{
  args: {
    column: {
      xs: 8,
      sm: 16,
...
}`},(K=(J=h.parameters)==null?void 0:J.docs)==null?void 0:K.source)})});var Q,Z,ee;y.parameters=a(r({},y.parameters),{docs:a(r({},(Q=y.parameters)==null?void 0:Q.docs),{source:r({originalSource:`{
  render: () => {
...
}`},(te=(ae=k.parameters)==null?void 0:ae.docs)==null?void 0:te.source)})});var se,le,oe;f.parameters=a(r({},f.parameters),{docs:a(r({},(se=f.parameters)==null?void 0:se.docs),{source:r({originalSource:`{
  render: () => {
    const items: IDescriptionsProps['items'] = [{
      label: 'Product',
      children: 'Cloud Database'
...
}`},(oe=(le=f.parameters)==null?void 0:le.docs)==null?void 0:oe.source)})});const Pe=["Bordered","Vertical","Small","CustomTitle","WithExtra","WithTitleAndExtra","WithContentStyle","WithLabelStyle","ResponsiveColumn","ExampleTableLook","ExampleSize","ExampleResponsiveDescriptions"];export{c as Bordered,p as CustomTitle,f as ExampleResponsiveDescriptions,k as ExampleSize,y as ExampleTableLook,h as ResponsiveColumn,m as Small,d as Vertical,x as WithContentStyle,u as WithExtra,g as WithLabelStyle,b as WithTitleAndExtra,Pe as __namedExportsOrder,Ee as default};
