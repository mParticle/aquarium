...
}`},(M=(L=g.parameters)==null?void 0:L.docs)==null?void 0:M.source)})});var N,G,Y;x.parameters=o(r({},x.parameters),{docs:o(r({},(N=x.parameters)==null?void 0:N.docs),{source:r({originalSource:`{
  args: {
    text: 'Custom Text'
  }
}`},(Y=(G=x.parameters)==null?void 0:G.docs)==null?void 0:Y.source)})});var W,_,F;f.parameters=o(r({},f.parameters),{docs:o(r({},(W=f.parameters)==null?void 0:W.docs),{source:r({originalSource:`{
  args: {
...
}`},(fe=(xe=y.parameters)==null?void 0:xe.docs)==null?void 0:fe.source)})});const Ye=["Primary","SmallSize","OverflowCount","CustomColor","CustomText","HoverTitle","ExampleBasic","ExampleStandalone","ExampleOverflowCount","ExampleDynamic","ExampleOffset","ExampleRibbon","ExampleClickable","ExampleColors"];export{g as CustomColor,x as CustomText,w as ExampleBasic,B as ExampleClickable,y as ExampleColors,j as ExampleDynamic,v as ExampleOffset,C as ExampleOverflowCount,b as ExampleRibbon,S as ExampleStandalone,f as HoverTitle,h as OverflowCount,p as Primary,m as SmallSize,Ye as __namedExportsOrder,Ge as default};
