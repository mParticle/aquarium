...
}`},(k=(_=u.parameters)==null?void 0:_.docs)==null?void 0:k.source)})});var N,O,X;m.parameters=r(t({},m.parameters),{docs:r(t({},(N=m.parameters)==null?void 0:N.docs),{source:t({originalSource:`{
  args: {
    fade: true,
    effect: 'fade'
  }
}`},(X=(O=m.parameters)==null?void 0:O.docs)==null?void 0:X.source)})});var q,z,J;x.parameters=r(t({},x.parameters),{docs:r(t({},(q=x.parameters)==null?void 0:q.docs),{source:t({originalSource:`{
  args: {
    easing: 'linear'
  }
}`},(J=(z=x.parameters)==null?void 0:z.docs)==null?void 0:J.source)})});var K,M,Q;y.parameters=r(t({},y.parameters),{docs:r(t({},(K=y.parameters)==null?void 0:K.docs),{source:t({originalSource:`{
  args: {
    infinite: false
  }
}`},(Q=(M=y.parameters)==null?void 0:M.docs)==null?void 0:Q.source)})});var V,Y,Z;g.parameters=r(t({},g.parameters),{docs:r(t({},(V=g.parameters)==null?void 0:V.docs),{source:t({originalSource:`{
  args: {
    speed: 1000
  }
...
}`},(ue=(pe=C.parameters)==null?void 0:pe.docs)==null?void 0:ue.source)})});const we=["Primary","WithAutoplay","CustomAutoplaySpeed","CustomDotPosition","WithoutDots","WithFadeEffect","WithLinearEasing","WithoutInfiniteLoop","CustomSpeed","WaitForAnimate","ExampleBasic","ExamplePosition","ExampleAutoScroll","ExampleFadeIn"];export{h as CustomAutoplaySpeed,p as CustomDotPosition,g as CustomSpeed,S as ExampleAutoScroll,f as ExampleBasic,C as ExampleFadeIn,j as ExamplePosition,d as Primary,v as WaitForAnimate,c as WithAutoplay,m as WithFadeEffect,x as WithLinearEasing,u as WithoutDots,y as WithoutInfiniteLoop,we as __namedExportsOrder,Le as default};
