...
}`},(j=(E=p.parameters)==null?void 0:E.docs)==null?void 0:j.source)})});var S,k,w;c.parameters=i(s({},c.parameters),{docs:i(s({},(S=c.parameters)==null?void 0:S.docs),{source:s({originalSource:`{
  render: () => {
    return <ExampleStory title={<> </>}>
        <Space direction="vertical">
