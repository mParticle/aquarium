...
}`},($=(_=m.parameters)==null?void 0:_.docs)==null?void 0:$.source)})});var J,G,H;u.parameters=c(r({},u.parameters),{docs:c(r({},(J=u.parameters)==null?void 0:J.docs),{source:r({originalSource:`{
  args: {
    closeIcon: true,
    onClose: e => {
      alert('Tag Closed');
...
}`},(H=(G=u.parameters)==null?void 0:G.docs)==null?void 0:H.source)})});var K,M,Q;h.parameters=c(r({},h.parameters),{docs:c(r({},(K=h.parameters)==null?void 0:K.docs),{source:r({originalSource:`{
  render: () => {
