...
}`},(we=(Se=v.parameters)==null?void 0:Se.docs)==null?void 0:we.source)})});var je,Ce,Be;E.parameters=s(t({},E.parameters),{docs:s(t({},(je=E.parameters)==null?void 0:je.docs),{source:t({originalSource:`{
  render: () => {
...
}`},(Be=(Ce=E.parameters)==null?void 0:Ce.docs)==null?void 0:Be.source)})});var be,ve,Ee;y.parameters=s(t({},y.parameters),{docs:s(t({},(be=y.parameters)==null?void 0:be.docs),{source:t({originalSource:`{
  render: () => {
...
}`},(Ee=(ve=y.parameters)==null?void 0:ve.docs)==null?void 0:Ee.source)})});const Me=["Primary","DotBadge","SmallSize","OverflowCount","CustomColor","CustomText","HoverTitle","ExampleBasic","ExampleStandalone","ExampleOverflowCount","ExampleDynamic","ExampleOffset","ExampleStatus","ExampleRibbon","ExampleClickable","ExampleColors"],Fe=Object.freeze(Object.defineProperty({__proto__:null,CustomColor:h,CustomText:x,DotBadge:p,ExampleBasic:S,ExampleClickable:E,ExampleColors:y,ExampleDynamic:C,ExampleOffset:B,ExampleOverflowCount:j,ExampleRibbon:v,ExampleStandalone:w,ExampleStatus:b,HoverTitle:f,OverflowCount:g,Primary:u,SmallSize:m,__namedExportsOrder:Me,default:_e},Symbol.toStringTag,{value:"Module"}));export{Fe as B,b as E};
