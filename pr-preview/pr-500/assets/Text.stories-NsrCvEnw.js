...
}`},(Ue=(Ie=k.parameters)==null?void 0:Ie.docs)==null?void 0:Ue.source)})});const cr=["Primary","Code","Copyable","Deleted","Disabled","Editable","Keyboard","Marked","Strong","Italic","Success","Secondary","Warning","Danger","Underline","CustomOnClick","ExampleTexts","ExampleEllipsis"];export{p as Code,l as Copyable,A as CustomOnClick,S as Danger,d as Deleted,g as Disabled,m as Editable,k as ExampleEllipsis,E as ExampleTexts,T as Italic,u as Keyboard,y as Marked,c as Primary,D as Secondary,x as Strong,h as Success,f as Underline,b as Warning,cr as __namedExportsOrder,ir as default};
