import{j as r,cs as l,I as t}from"./iframe-CPW_KvgL.js";import"./preload-helper-PPVm8Dsz.js";const i={title:"Experimental/Navigation/NavigationItem",component:s=>r.jsx(l,{...s}),args:{label:"Label"}},e={},a={args:{icon:r.jsx(t,{name:"mpLogo"}),label:"Icon Label",type:"link",onClick:()=>{alert("Redirection!")}}},o={args:{label:"List Label",type:"menu",icon:r.jsx(t,{name:"mpLogo"}),items:[{label:"Nav Item - Menu",type:"menu",children:[{label:"a",type:"link"},{label:"b",type:"link"},{label:"c"}]}]}};e.parameters={...e.parameters,docs:{...e.parameters?.docs,source:{originalSource:"{}",...e.parameters?.docs?.source}}};a.parameters={...a.parameters,docs:{...a.parameters?.docs,source:{originalSource:`{
  args: {
