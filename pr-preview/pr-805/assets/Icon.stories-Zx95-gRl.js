import{j as t,c as k,G as o,cP as l,aT as L,T as a,F as V,I as w,a7 as F}from"./iframe-D96v7dCn.js";import"./preload-helper-PPVm8Dsz.js";const b={LIGHT:"light",DUO_TONE:"duo-tone"},B=["xxxxl","xxxl","xxl","xl","lg","md","sm","xs"],H=["default","primary","success","warning","error","info","white","black","text","strong","brand"],S={UI_ACTION_PATTERNS:["accept","close","edit","delete","copy","add","remove","unlock","lock","play","pause","run","filter","search","upload","next","previous","back","openTab","fullScreen","fitToScreen","zoomIn","zoomOut","jumpTo","moreActions","dragAndDrop","reorder","refresh","clone","boost","submitFeedback","dropdown","logout","moveToTop"],INFORMATIONAL_PATTERNS:["info","help","history","hybrid","notification","active","cohort","funnel","group","placeholder","privileges","textWidget","annotation","generic","calculatedAttribute","conversion","criteriaGroup","audienceGroup","abSplit","account","user","users","viewOnly","premium","agentCopilot","refreshFrequency","stateError","bannerFreemium","toggleLogicBlocks"],DATA_TYPE_PATTERNS:["array","boolean","number","string","timestamp","list","otherData","stateEmpty","stateNoResults"],NAVIGATION_PATTERNS:["catalog","directory","dsr","enrichment","forwarding","journeyAnalysis","liveStream","observability","systemAlerts","transformation","userProfiles"]},v=(d,p)=>p.some(u=>d.includes(u)),N=d=>d.filter(p=>!l[p].deprecated),g=({color:d="black",size:p="lg",name:u,variant:C})=>{const n=Object.keys(l),A={display:"grid",gridTemplateColumns:"repeat(6, 1fr)",gap:k,alignItems:"center",justifyItems:"center"},r={marginBottom:L},P={marginBottom:F};if(u)return typeof u=="string"?t.jsx("div",{style:A,children:D(u)}):null;const I=e=>{const s=[],c=[];return e.forEach(m=>{l[m].default===b.DUO_TONE?c.push(m):s.push(m)}),{lightIcons:s,duotoneIcons:c}},i=(e,s,c=5)=>s.length===0?null:t.jsxs("div",{style:P,children:[t.jsx(a.Title,{level:c,children:e}),t.jsx("div",{style:A,children:s.sort().map(D)})]}),y=o.useMemo(()=>N(n.filter(e=>v(e,S.UI_ACTION_PATTERNS))),[n]),R=["api","audiences","database","dashboard","date","devices","identity","organization","predictions","scheduledReport","segmentationAnalysis","flag","insights","link","favorite","paywall","pipelines","precision","rateDown","rateStar","rateUp","settings","support","selected"],h=o.useMemo(()=>N(n.filter(e=>v(e,S.INFORMATIONAL_PATTERNS)||R.includes(e)||e.includes("other")&&e!=="otherData")),[n]),G=["empty","event","eventAttribute","userAttribute"],T=o.useMemo(()=>N(n.filter(e=>v(e,S.DATA_TYPE_PATTERNS)||G.includes(e))),[n]),z=["connections","savedProjects","privacy","setup"],f=o.useMemo(()=>N(n.filter(e=>v(e,S.NAVIGATION_PATTERNS)||z.includes(e))),[n]),U=o.useMemo(()=>n.filter(e=>l[e].deprecated),[n]),x=o.useMemo(()=>n.filter(e=>!l[e].deprecated&&!y.includes(e)&&!h.includes(e)&&!T.includes(e)&&!f.includes(e)),[n,y,h,T,f]),O=o.useMemo(()=>I(y),[y]),_=o.useMemo(()=>I(h),[h]),E=o.useMemo(()=>I(T),[T]),M=o.useMemo(()=>I(f),[f]),j=o.useMemo(()=>I(x),[x]);return t.jsxs("div",{children:[t.jsxs("div",{style:r,children:[t.jsx(a.Title,{level:4,children:"UI Actions"}),i("Light",O.lightIcons),i("Duotone",O.duotoneIcons)]}),t.jsxs("div",{style:r,children:[t.jsx(a.Title,{level:4,children:"Informational Icons"}),i("Light",_.lightIcons),i("Duotone",_.duotoneIcons)]}),t.jsxs("div",{style:r,children:[t.jsx(a.Title,{level:4,children:"Data Type Icons"}),i("Light",E.lightIcons),i("Duotone",E.duotoneIcons)]}),t.jsxs("div",{style:r,children:[t.jsx(a.Title,{level:4,children:"Navigation"}),i("Light",M.lightIcons),i("Duotone",M.duotoneIcons)]}),x.length>0&&t.jsxs("div",{style:r,children:[t.jsx(a.Title,{level:4,children:"Other Icons"}),i("Light",j.lightIcons),i("Duotone",j.duotoneIcons)]}),t.jsxs("div",{style:r,children:[t.jsx(a.Title,{level:4,type:"secondary",children:"Deprecated Icons"}),t.jsx("div",{style:A,children:U.sort().map(D)})]})]});function D(e){const c=l[e].deprecated,m=c?{textDecoration:"line-through"}:{};return t.jsxs(V,{vertical:!0,align:"center",children:[t.jsx(w,{name:e,size:p,color:d,variant:C}),t.jsxs("p",{style:{fontFamily:"monospace",textAlign:"center",...m},children:[c?"deprecated ":"",e]})]},e)}},Y=`
