var Y=Object.defineProperty,X=Object.defineProperties;var $=Object.getOwnPropertyDescriptors;var F=Object.getOwnPropertySymbols;var q=Object.prototype.hasOwnProperty,Q=Object.prototype.propertyIsEnumerable;var G=(o,n,i)=>n in o?Y(o,n,{enumerable:!0,configurable:!0,writable:!0,value:i}):o[n]=i,y=(o,n)=>{for(var i in n||(n={}))q.call(n,i)&&G(o,i,n[i]);if(F)for(var i of F(n))Q.call(n,i)&&G(o,i,n[i]);return o},_=(o,n)=>X(o,$(n));import{j as e}from"./jsx-runtime-C9TrHvcC.js";import{r as c}from"./index-3OP4wdng.js";import{aA as I,c as r,F as x,I as Z}from"./NavigationItemsService-Dtp5CN9e.js";import{E as J}from"./ErrorStateIcon-C6CBbN6f.js";import{S as K}from"./SuccessStateIcon-DewHreeH.js";import{W as ee}from"./WarningStateIcon-8iKuf-az.js";import"./_baseClone-DwBCp-Ss.js";import{aQ as te,aR as ne,w as oe}from"./style-DvQeleTo.js";import"./LightTheme-vAO8T2BA.js";import"./row-DlEJUZa0.js";import"./Context-R5ee3nrF.js";import"./useToken-BIYN7ogo.js";import"./presets-CQzyf-6F.js";import"./extends-CF3RwP-h.js";import"./index-DA79H6I3.js";import"./isNativeReflectConstruct-CWIsGhkf.js";import"./AntdIcon-DRQs8XP6.js";import"./WarningFilled-D6ijQqgK.js";const D={LIGHT:"light",DUO_TONE:"duo-tone"},ie=["xxxxl","xxxl","xxl","xl","lg","md","sm","xs"],se=["default","primary","success","warning","error","info","white","black","text","strong","brand"],A={UI_ACTION_PATTERNS:["accept","close","edit","delete","copy","add","remove","unlock","lock","play","pause","run","filter","search","upload","next","previous","back","openTab","fullScreen","fitToScreen","zoomIn","zoomOut","jumpTo","moreActions","dragAndDrop","reorder","refresh","clone","boost","submitFeedback","dropdown","logout","moveToTop"],INFORMATIONAL_PATTERNS:["info","help","history","hybrid","notification","active","cohort","funnel","group","placeholder","privileges","textWidget","annotation","generic","calculatedAttribute","conversion","criteriaGroup","audienceGroup","abSplit","account","user","users","viewOnly","premium","agentCopilot","refreshFrequency","stateError","bannerFreemium","toggleLogicBlocks"],DATA_TYPE_PATTERNS:["array","boolean","number","string","timestamp","list","otherData","stateEmpty","stateNoResults"],NAVIGATION_PATTERNS:["catalog","directory","dsr","enrichment","forwarding","journeyAnalysis","liveStream","observability","systemAlerts","transformation","userProfiles"]},N=(o,n)=>n.some(i=>o.includes(i)),b=o=>o.filter(n=>!I[n].deprecated),g=({color:o="black",size:n="lg",name:i,variant:L})=>{const s=Object.keys(I),h={display:"grid",gridTemplateColumns:"repeat(6, 1fr)",gap:te,alignItems:"center",justifyItems:"center"},l={marginBottom:ne},w={marginBottom:oe};if(i)return e.jsx("div",{style:h,children:O(i)});const u=t=>{const p=[],d=[];return t.forEach(m=>{I[m].default===D.DUO_TONE?d.push(m):p.push(m)}),{lightIcons:p,duotoneIcons:d}},a=(t,p,d=5)=>p.length===0?null:e.jsxs("div",{style:w,children:[e.jsx(r.Title,{level:d,children:t}),e.jsx("div",{style:h,children:p.sort().map(O)})]}),S=c.useMemo(()=>b(s.filter(t=>N(t,A.UI_ACTION_PATTERNS))),[s]),V=["api","audiences","database","dashboard","date","devices","identity","organization","predictions","scheduledReport","segmentationAnalysis","flag","insights","link","favorite","paywall","pipelines","precision","rateDown","rateStar","rateUp","settings","support","selected"],f=c.useMemo(()=>b(s.filter(t=>N(t,A.INFORMATIONAL_PATTERNS)||V.includes(t)||t.includes("other")&&t!=="otherData")),[s]),B=["empty","event","eventAttribute","userAttribute"],v=c.useMemo(()=>b(s.filter(t=>N(t,A.DATA_TYPE_PATTERNS)||B.includes(t))),[s]),W=["connections","savedProjects","privacy","setup"],T=c.useMemo(()=>b(s.filter(t=>N(t,A.NAVIGATION_PATTERNS)||W.includes(t))),[s]),H=c.useMemo(()=>s.filter(t=>I[t].deprecated),[s]),j=c.useMemo(()=>s.filter(t=>!I[t].deprecated&&!S.includes(t)&&!f.includes(t)&&!v.includes(t)&&!T.includes(t)),[s,S,f,v,T]),E=c.useMemo(()=>u(S),[S]),M=c.useMemo(()=>u(f),[f]),C=c.useMemo(()=>u(v),[v]),R=c.useMemo(()=>u(T),[T]),P=c.useMemo(()=>u(j),[j]);return e.jsxs("div",{children:[e.jsxs("div",{style:l,children:[e.jsx(r.Title,{level:4,children:"Special Icons"}),e.jsxs("div",{style:h,children:[e.jsxs(x,{vertical:!0,align:"center",children:[e.jsx(J,{size:n}),e.jsx("p",{style:{fontFamily:"monospace",textAlign:"center"},children:"ErrorStateIcon"})]},"error-state-icon"),e.jsxs(x,{vertical:!0,align:"center",children:[e.jsx(ee,{size:n}),e.jsx("p",{style:{fontFamily:"monospace",textAlign:"center"},children:"WarningStateIcon"})]},"warning-state-icon"),e.jsxs(x,{vertical:!0,align:"center",children:[e.jsx(K,{size:n}),e.jsx("p",{style:{fontFamily:"monospace",textAlign:"center"},children:"SuccessStateIcon"})]},"success-state-icon")]})]}),e.jsxs("div",{style:l,children:[e.jsx(r.Title,{level:4,children:"UI Actions"}),a("Light",E.lightIcons),a("Duotone",E.duotoneIcons)]}),e.jsxs("div",{style:l,children:[e.jsx(r.Title,{level:4,children:"Informational Icons"}),a("Light",M.lightIcons),a("Duotone",M.duotoneIcons)]}),e.jsxs("div",{style:l,children:[e.jsx(r.Title,{level:4,children:"Data Type Icons"}),a("Light",C.lightIcons),a("Duotone",C.duotoneIcons)]}),e.jsxs("div",{style:l,children:[e.jsx(r.Title,{level:4,children:"Navigation"}),a("Light",R.lightIcons),a("Duotone",R.duotoneIcons)]}),j.length>0&&e.jsxs("div",{style:l,children:[e.jsx(r.Title,{level:4,children:"Other Icons"}),a("Light",P.lightIcons),a("Duotone",P.duotoneIcons)]}),e.jsxs("div",{style:l,children:[e.jsx(r.Title,{level:4,type:"secondary",children:"Deprecated Icons"}),e.jsx("div",{style:h,children:H.sort().map(O)})]})]});function O(t){const d=I[t].deprecated,m=d?{textDecoration:"line-through"}:{};return e.jsxs(x,{vertical:!0,align:"center",children:[e.jsx(Z,{name:t,size:n,color:o,variant:L}),e.jsxs("p",{style:y({fontFamily:"monospace",textAlign:"center"},m),children:[d?"deprecated ":"",t]})]},t)}},ce=`
