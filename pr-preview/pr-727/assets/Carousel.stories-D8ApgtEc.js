...
}`},(k=(_=u.parameters)==null?void 0:_.docs)==null?void 0:k.source)})});var q,z,N;m.parameters=r(t({},m.parameters),{docs:r(t({},(q=m.parameters)==null?void 0:q.docs),{source:t({originalSource:`{
  args: {
    fade: true,
    effect: 'fade'
  }
}`},(N=(z=m.parameters)==null?void 0:z.docs)==null?void 0:N.source)})});var O,J,K;x.parameters=r(t({},x.parameters),{docs:r(t({},(O=x.parameters)==null?void 0:O.docs),{source:t({originalSource:`{
  args: {
    easing: 'linear'
  }
...
}`},(ue=(he=C.parameters)==null?void 0:he.docs)==null?void 0:ue.source)})});const ze=["Primary","WithAutoplay","CustomAutoplaySpeed","CustomDotPosition","WithoutDots","WithFadeEffect","WithLinearEasing","WithoutInfiniteLoop","CustomSpeed","WaitForAnimate","ExampleBasic","ExamplePosition","ExampleAutoScroll","ExampleFadeIn"];export{p as CustomAutoplaySpeed,h as CustomDotPosition,g as CustomSpeed,S as ExampleAutoScroll,f as ExampleBasic,C as ExampleFadeIn,j as ExamplePosition,d as Primary,v as WaitForAnimate,c as WithAutoplay,m as WithFadeEffect,x as WithLinearEasing,u as WithoutDots,y as WithoutInfiniteLoop,ze as __namedExportsOrder,qe as default};
