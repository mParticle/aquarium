...
}`},(F=(q=g.parameters)==null?void 0:q.docs)==null?void 0:F.source)})});const te=["Primary","WithCustomSeparator","WithLongItemLabels","WithCustomItemRender","ExampleBasic","ExampleIcon","ExampleSeperator","ExampleDropdown","ExampleIndependentSeparators"],de=Object.freeze(Object.defineProperty({__proto__:null,ExampleBasic:c,ExampleDropdown:h,ExampleIcon:d,ExampleIndependentSeparators:g,ExampleSeperator:u,Primary:s,WithCustomItemRender:m,WithCustomSeparator:l,WithLongItemLabels:p,__namedExportsOrder:te,default:ee},Symbol.toStringTag,{value:"Module"}));export{de as B,ee as m};
