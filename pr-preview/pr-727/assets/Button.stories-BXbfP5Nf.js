...
}`},(he=(ye=B.parameters)==null?void 0:ye.docs)==null?void 0:he.source)})});var ge,xe,fe;I.parameters=r(n({},I.parameters),{docs:r(n({},(ge=I.parameters)==null?void 0:ge.docs),{source:n({originalSource:`{
  args: {
    type: 'link',
    icon: <Icon name="add" />,
    children: 'Link'
  }
}`},(fe=(xe=I.parameters)==null?void 0:xe.docs)==null?void 0:fe.source)})});var je,Be,Ie;T.parameters=r(n({},T.parameters),{docs:r(n({},(je=T.parameters)==null?void 0:je.docs),{source:n({originalSource:`{
  args: {
    type: 'text',
    children: 'Text'
  }
}`},(Ie=(Be=T.parameters)==null?void 0:Be.docs)==null?void 0:Ie.source)})});var Te,ze,Se;z.parameters=r(n({},z.parameters),{docs:r(n({},(Te=z.parameters)==null?void 0:Te.docs),{source:n({originalSource:`{
  args: {
    type: 'default',
    danger: true,
    children: 'Delete'
  }
}`},(Se=(ze=z.parameters)==null?void 0:ze.docs)==null?void 0:Se.source)})});var ke,we,ve;S.parameters=r(n({},S.parameters),{docs:r(n({},(ke=S.parameters)==null?void 0:ke.docs),{source:n({originalSource:`{
  args: {
    type: 'primary',
    loading: true,
    children: 'Loading'
  }
}`},(ve=(we=S.parameters)==null?void 0:we.docs)==null?void 0:ve.source)})});var be,Ue,Le;k.parameters=r(n({},k.parameters),{docs:r(n({},(be=k.parameters)==null?void 0:be.docs),{source:n({originalSource:`{
  args: {
    type: 'text',
    loading: true,
    children: 'Load more'
  }
}`},(Le=(Ue=k.parameters)==null?void 0:Ue.docs)==null?void 0:Le.source)})});var De,Fe,Ee;w.parameters=r(n({},w.parameters),{docs:r(n({},(De=w.parameters)==null?void 0:De.docs),{source:n({originalSource:`{
  render: () => {
...
}`},(Ee=(Fe=w.parameters)==null?void 0:Fe.docs)==null?void 0:Ee.source)})});var Me,Re,Pe;v.parameters=r(n({},v.parameters),{docs:r(n({},(Me=v.parameters)==null?void 0:Me.docs),{source:n({originalSource:`{
  render: () => {
    return <Flex wrap gap={MarginMd} align="center">
...
}`},(Pe=(Re=v.parameters)==null?void 0:Re.docs)==null?void 0:Pe.source)})});var We,Ce,Oe;b.parameters=r(n({},b.parameters),{docs:r(n({},(We=b.parameters)==null?void 0:We.docs),{source:n({originalSource:`{
  render: () => {
    return <Flex wrap gap={MarginMd} align="center">
...
}`},(Oe=(Ce=b.parameters)==null?void 0:Ce.docs)==null?void 0:Oe.source)})});var Ae,Ne,_e;U.parameters=r(n({},U.parameters),{docs:r(n({},(Ae=U.parameters)==null?void 0:Ae.docs),{source:n({originalSource:`{
  render: () => {
...
}`},(_e=(Ne=U.parameters)==null?void 0:Ne.docs)==null?void 0:_e.source)})});var qe,$e,Ge;L.parameters=r(n({},L.parameters),{docs:r(n({},(qe=L.parameters)==null?void 0:qe.docs),{source:n({originalSource:`{
  render: () => {
    return <Flex wrap gap={MarginMd} align="center">
...
}`},(Ge=($e=L.parameters)==null?void 0:$e.docs)==null?void 0:Ge.source)})});var Ve,Xe,Ke;D.parameters=r(n({},D.parameters),{docs:r(n({},(Ve=D.parameters)==null?void 0:Ve.docs),{source:n({originalSource:`{
  render: () => {
    return <>
...
}`},(Ke=(Xe=D.parameters)==null?void 0:Xe.docs)==null?void 0:Ke.source)})});var Ze,He,Je;F.parameters=r(n({},F.parameters),{docs:r(n({},(Ze=F.parameters)==null?void 0:Ze.docs),{source:n({originalSource:`{
  render: () => {
...
}`},(tn=(rn=M.parameters)==null?void 0:rn.docs)==null?void 0:tn.source)})});var an,sn,on;R.parameters=r(n({},R.parameters),{docs:r(n({},(an=R.parameters)==null?void 0:an.docs),{source:n({originalSource:`{
  render: () => {
...
}`},(on=(sn=R.parameters)==null?void 0:sn.docs)==null?void 0:on.source)})});const Sn=["LinkUsageNote","Primary","PrimaryWithIcon","Default","DefaultWithIcon","Dashed","DashedWithIcon","Link","LinkWithIcon","Text","Danger","Loading","LoadingText","TypesOverview","DarkButton","IconTypesOverview","SizeExamples","IconOnly","Refresh","With2Options","ButtonsWithLocalIcons","ButtonsWithUntitledUIIcons","WithUntitledUIIcons"],Pn=Object.freeze(Object.defineProperty({__proto__:null,ButtonsWithLocalIcons:E,ButtonsWithUntitledUIIcons:M,Danger:z,DarkButton:v,Dashed:f,DashedWithIcon:j,Default:g,DefaultWithIcon:x,IconOnly:L,IconTypesOverview:b,Link:B,LinkUsageNote:u,LinkWithIcon:I,Loading:S,LoadingText:k,Primary:y,PrimaryWithIcon:h,Refresh:D,SizeExamples:U,Text:T,TypesOverview:w,With2Options:F,WithUntitledUIIcons:R,__namedExportsOrder:Sn,default:zn},Symbol.toStringTag,{value:"Module"}));export{Pn as B,v as D,b as I,u as L,U as S,w as T,L as a,E as b,M as c,S as d,k as e,z as f};
