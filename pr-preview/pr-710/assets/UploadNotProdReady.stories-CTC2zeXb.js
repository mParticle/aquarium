...
}`},(L=(F=n.parameters)==null?void 0:F.docs)==null?void 0:L.source)})});var P,R,T;c.parameters=o(r({},c.parameters),{docs:o(r({},(P=c.parameters)==null?void 0:P.docs),{source:r({originalSource:`{
  args: {
    accept: '.pdf,.docx'
  }
}`},(T=(R=c.parameters)==null?void 0:R.docs)==null?void 0:T.source)})});var b,j,k;d.parameters=o(r({},d.parameters),{docs:o(r({},(b=d.parameters)==null?void 0:b.docs),{source:r({originalSource:`{
  args: {
    disabled: true
  }
}`},(k=(j=d.parameters)==null?void 0:j.docs)==null?void 0:k.source)})});const pe=["Primary","CustomListType","DragAndDropUpload","CustomProgress","CustomAcceptFileType","DisabledUpload"];export{c as CustomAcceptFileType,p as CustomListType,n as CustomProgress,d as DisabledUpload,i as DragAndDropUpload,s as Primary,pe as __namedExportsOrder,se as default};
