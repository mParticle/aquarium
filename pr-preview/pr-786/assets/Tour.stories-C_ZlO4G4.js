import{bJ as a,aE as r,j as e,bK as l,I as c}from"./iframe-CLJD4-Bh.js";const p={title:"Components/Not Prod Ready/Data Display/Tour",component:a,args:{}},t={render:()=>{const s=r.useRef(null),[n,o]=r.useState(!0),i=[{title:"Navigate mParticle effortlessly!",description:"Switch between product suites anytime using this selector.",placement:"right",target:()=>s.current}];return e.jsxs(e.Fragment,{children:[e.jsx("div",{ref:s,children:e.jsx(l,{label:"Data Platform",icon:e.jsx(c,{name:"siteMap"}),onSuiteLogoClick:()=>{o(!0)}})}),e.jsx(a,{mask:!1,type:"primary",open:n,onClose:()=>{o(!1)},steps:i})]})}};t.parameters={...t.parameters,docs:{...t.parameters?.docs,source:{originalSource:`{
  render: () => {
