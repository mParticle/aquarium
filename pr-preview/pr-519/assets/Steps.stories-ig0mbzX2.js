...
}`},(Vt=(Nt=D.parameters)==null?void 0:Nt.docs)==null?void 0:Vt.source)})});var Yt,Rt,_t;I.parameters=i(t({},I.parameters),{docs:i(t({},(Yt=I.parameters)==null?void 0:Yt.docs),{source:t({originalSource:`{
  render: () => {
    const [current, setCurrent] = useState(0);
    const onChange = (value: number) => {
      console.log('onChange:', value);
...
}`},(_t=(Rt=I.parameters)==null?void 0:Rt.docs)==null?void 0:_t.source)})});var Mt,$t,Ot;F.parameters=i(t({},F.parameters),{docs:i(t({},(Mt=F.parameters)==null?void 0:Mt.docs),{source:t({originalSource:`{
  render: () => {
    const description = 'This is a description.';
