var K=Object.defineProperty,Q=Object.defineProperties;var ee=Object.getOwnPropertyDescriptors;var b=Object.getOwnPropertySymbols;var L=Object.prototype.hasOwnProperty,w=Object.prototype.propertyIsEnumerable;var G=(t,n,i)=>n in t?K(t,n,{enumerable:!0,configurable:!0,writable:!0,value:i}):t[n]=i,u=(t,n)=>{for(var i in n||(n={}))L.call(n,i)&&G(t,i,n[i]);if(b)for(var i of b(n))w.call(n,i)&&G(t,i,n[i]);return t},_=(t,n)=>Q(t,ee(n));var k=(t,n)=>{var i={};for(var a in t)L.call(t,a)&&n.indexOf(a)<0&&(i[a]=t[a]);if(t!=null&&b)for(var a of b(t))n.indexOf(a)<0&&w.call(t,a)&&(i[a]=t[a]);return i};import{j as e}from"./jsx-runtime-C9TrHvcC.js";import{r as s}from"./index-3OP4wdng.js";import{aC as g,b as d,F as l,a4 as y,I as te}from"./UnauthorizedTooltip-1ZRAhzDH.js";import{E as ne}from"./ErrorStateIcon-CcQoYP7x.js";import{S as oe}from"./SuccessStateIcon-Dn1_3x90.js";import{W as ie}from"./WarningStateIcon-OlzhE0bB.js";import"./_baseClone-DwBCp-Ss.js";import{S as ce,aT as se,G as ae}from"./style-BbwCNso5.js";import{s as re,b as le,i as de,a as pe}from"./Trash04-BKnMg25G.js";import"./LightTheme-BtoaoHMG.js";import"./row-DlEJUZa0.js";import"./Context-R5ee3nrF.js";import"./useToken-BIYN7ogo.js";import"./presets-CQzyf-6F.js";import"./extends-CF3RwP-h.js";import"./index-DA79H6I3.js";import"./isNativeReflectConstruct-CWIsGhkf.js";import"./AntdIcon-DRQs8XP6.js";import"./WarningFilled-D6ijQqgK.js";const W=a=>{var c=a,{size:t=24,color:n="currentColor"}=c,i=k(c,["size","color"]);return s.createElement("svg",u({viewBox:"0 0 24 24",width:t,height:t,stroke:n,strokeWidth:"2",fill:"none",strokeLinecap:"round",strokeLinejoin:"round","aria-hidden":"true"},i),s.createElement("path",{d:"M9.09 9a3 3 0 0 1 5.83 1c0 2-3 3-3 3m.08 4h.01M22 12c0 5.523-4.477 10-10 10S2 17.523 2 12 6.477 2 12 2s10 4.477 10 10Z"}))};W.displayName="HelpCircle";const $=a=>{var c=a,{size:t=24,color:n="currentColor"}=c,i=k(c,["size","color"]);return s.createElement("svg",u({viewBox:"0 0 24 24",width:t,height:t,stroke:n,strokeWidth:"2",fill:"none",strokeLinecap:"round",strokeLinejoin:"round","aria-hidden":"true"},i),s.createElement("path",{d:"m7.5 12 3 3 6-6m5.5 3c0 5.523-4.477 10-10 10S2 17.523 2 12 6.477 2 12 2s10 4.477 10 10Z"}))};$.displayName="CheckCircle";const E={LIGHT:"light",DUO_TONE:"duo-tone"},me=["xxxxl","xxxl","xxl","xl","lg","md","sm","xs"],Ie=["default","primary","success","warning","error","info","white","black","text","strong","brand"],j={UI_ACTION_PATTERNS:["accept","close","edit","delete","copy","add","remove","unlock","lock","play","pause","run","filter","search","upload","next","previous","back","openTab","fullScreen","fitToScreen","zoomIn","zoomOut","jumpTo","moreActions","dragAndDrop","reorder","refresh","clone","boost","submitFeedback","dropdown","logout","moveToTop"],INFORMATIONAL_PATTERNS:["info","help","history","hybrid","notification","active","cohort","funnel","group","placeholder","privileges","textWidget","annotation","generic","calculatedAttribute","conversion","criteriaGroup","audienceGroup","abSplit","account","user","users","viewOnly","premium","agentCopilot","refreshFrequency","stateError","bannerFreemium","toggleLogicBlocks"],DATA_TYPE_PATTERNS:["array","boolean","number","string","timestamp","list","otherData","stateEmpty","stateNoResults"],NAVIGATION_PATTERNS:["catalog","directory","dsr","enrichment","forwarding","journeyAnalysis","liveStream","observability","systemAlerts","transformation","userProfiles"]},U=(t,n)=>n.some(i=>t.includes(i)),D=t=>t.filter(n=>!g[n].deprecated),f=({color:t="black",size:n="lg",name:i,variant:a})=>{const c=Object.keys(g),h={display:"grid",gridTemplateColumns:"repeat(6, 1fr)",gap:ce,alignItems:"center",justifyItems:"center"},p={marginBottom:se},Y={marginBottom:ae};if(i)return e.jsx("div",{style:h,children:O(i)});const S=o=>{const m=[],I=[];return o.forEach(v=>{g[v].default===E.DUO_TONE?I.push(v):m.push(v)}),{lightIcons:m,duotoneIcons:I}},r=(o,m,I=5)=>m.length===0?null:e.jsxs("div",{style:Y,children:[e.jsx(d.Title,{level:I,children:o}),e.jsx("div",{style:h,children:m.sort().map(O)})]}),x=s.useMemo(()=>D(c.filter(o=>U(o,j.UI_ACTION_PATTERNS))),[c]),Z=["api","audiences","database","dashboard","date","devices","identity","organization","predictions","scheduledReport","segmentationAnalysis","flag","insights","link","favorite","paywall","pipelines","precision","rateDown","rateStar","rateUp","settings","support","selected"],T=s.useMemo(()=>D(c.filter(o=>U(o,j.INFORMATIONAL_PATTERNS)||Z.includes(o)||o.includes("other")&&o!=="otherData")),[c]),X=["empty","event","eventAttribute","userAttribute"],A=s.useMemo(()=>D(c.filter(o=>U(o,j.DATA_TYPE_PATTERNS)||X.includes(o))),[c]),q=["connections","savedProjects","privacy","setup"],N=s.useMemo(()=>D(c.filter(o=>U(o,j.NAVIGATION_PATTERNS)||q.includes(o))),[c]),J=s.useMemo(()=>c.filter(o=>g[o].deprecated),[c]),F=s.useMemo(()=>c.filter(o=>!g[o].deprecated&&!x.includes(o)&&!T.includes(o)&&!A.includes(o)&&!N.includes(o)),[c,x,T,A,N]),C=s.useMemo(()=>S(x),[x]),M=s.useMemo(()=>S(T),[T]),z=s.useMemo(()=>S(A),[A]),P=s.useMemo(()=>S(N),[N]),R=s.useMemo(()=>S(F),[F]);return e.jsxs("div",{children:[e.jsxs("div",{style:p,children:[e.jsx(d.Title,{level:4,children:"Special Icons"}),e.jsxs("div",{style:h,children:[e.jsxs(l,{vertical:!0,align:"center",children:[e.jsx(ne,{size:n}),e.jsx("p",{style:{fontFamily:"monospace",textAlign:"center"},children:"ErrorStateIcon"})]},"error-state-icon"),e.jsxs(l,{vertical:!0,align:"center",children:[e.jsx(ie,{size:n}),e.jsx("p",{style:{fontFamily:"monospace",textAlign:"center"},children:"WarningStateIcon"})]},"warning-state-icon"),e.jsxs(l,{vertical:!0,align:"center",children:[e.jsx(oe,{size:n}),e.jsx("p",{style:{fontFamily:"monospace",textAlign:"center"},children:"SuccessStateIcon"})]},"success-state-icon")]})]}),e.jsxs("div",{style:p,children:[e.jsx(d.Title,{level:4,children:"Untitled UI Icons"}),e.jsxs("div",{style:h,children:[e.jsxs(l,{vertical:!0,align:"center",children:[e.jsx(y,{name:W,size:n,color:t}),e.jsx("p",{style:{fontFamily:"monospace",textAlign:"center"},children:"UUIHelp"})]},"untitled-help"),e.jsxs(l,{vertical:!0,align:"center",children:[e.jsx(y,{name:re,size:n,color:t}),e.jsx("p",{style:{fontFamily:"monospace",textAlign:"center"},children:"UUIPlus"})]},"untitled-plus"),e.jsxs(l,{vertical:!0,align:"center",children:[e.jsx(y,{name:le,size:n,color:t}),e.jsx("p",{style:{fontFamily:"monospace",textAlign:"center"},children:"UUISearch"})]},"untitled-search"),e.jsxs(l,{vertical:!0,align:"center",children:[e.jsx(y,{name:de,size:n,color:t}),e.jsx("p",{style:{fontFamily:"monospace",textAlign:"center"},children:"UUIEdit"})]},"untitled-edit"),e.jsxs(l,{vertical:!0,align:"center",children:[e.jsx(y,{name:pe,size:n,color:t}),e.jsx("p",{style:{fontFamily:"monospace",textAlign:"center"},children:"UUITrash"})]},"untitled-trash"),e.jsxs(l,{vertical:!0,align:"center",children:[e.jsx(y,{name:$,size:n,color:t}),e.jsx("p",{style:{fontFamily:"monospace",textAlign:"center"},children:"UUICheckCircle"})]},"untitled-check-circle")]})]}),e.jsxs("div",{style:p,children:[e.jsx(d.Title,{level:4,children:"UI Actions"}),r("Light",C.lightIcons),r("Duotone",C.duotoneIcons)]}),e.jsxs("div",{style:p,children:[e.jsx(d.Title,{level:4,children:"Informational Icons"}),r("Light",M.lightIcons),r("Duotone",M.duotoneIcons)]}),e.jsxs("div",{style:p,children:[e.jsx(d.Title,{level:4,children:"Data Type Icons"}),r("Light",z.lightIcons),r("Duotone",z.duotoneIcons)]}),e.jsxs("div",{style:p,children:[e.jsx(d.Title,{level:4,children:"Navigation"}),r("Light",P.lightIcons),r("Duotone",P.duotoneIcons)]}),F.length>0&&e.jsxs("div",{style:p,children:[e.jsx(d.Title,{level:4,children:"Other Icons"}),r("Light",R.lightIcons),r("Duotone",R.duotoneIcons)]}),e.jsxs("div",{style:p,children:[e.jsx(d.Title,{level:4,type:"secondary",children:"Deprecated Icons"}),e.jsx("div",{style:h,children:J.sort().map(O)})]})]});function O(o){const I=g[o].deprecated,v=I?{textDecoration:"line-through"}:{};return e.jsxs(l,{vertical:!0,align:"center",children:[e.jsx(te,{name:o,size:n,color:t,variant:a}),e.jsxs("p",{style:u({fontFamily:"monospace",textAlign:"center"},v),children:[I?"deprecated ":"",o]})]},o)}},ue=`
...
`,ze={title:"Components/General/Icons",component:f,argTypes:{size:{control:"select",options:me},color:{control:"select",options:Ie},variant:{control:"select",options:Object.values(E)}},parameters:{docs:{description:{component:ue}}}};var V,B,H;f.parameters=_(u({},f.parameters),{docs:_(u({},(V=f.parameters)==null?void 0:V.docs),{source:u({originalSource:`({
  color = 'black',
  size = 'lg',
  name,
  variant
...
}`},(H=(B=f.parameters)==null?void 0:B.docs)==null?void 0:H.source)})});const Pe=["IconTable"];export{f as IconTable,Pe as __namedExportsOrder,ze as default};
