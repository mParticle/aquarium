...
}`},(Ke=(Ye=O.parameters)==null?void 0:Ye.docs)==null?void 0:Ke.source)})});var $e,Fe,Ve;T.parameters=r(t({},T.parameters),{docs:r(t({},($e=T.parameters)==null?void 0:$e.docs),{source:t({originalSource:`{
  render: () => {
    const items: MenuProps['items'] = [{
      key: '1',
      label: 'Item 1'
...
}`},(Ve=(Fe=T.parameters)==null?void 0:Fe.docs)==null?void 0:Ve.source)})});var qe,Je,Qe;A.parameters=r(t({},A.parameters),{docs:r(t({},(qe=A.parameters)==null?void 0:qe.docs),{source:t({originalSource:`{
  render: () => {
    const items: MenuProps['items'] = [{
      label: '1st menu item',
      key: '1'
...
}`},(Qe=(Je=A.parameters)==null?void 0:Je.docs)==null?void 0:Qe.source)})});var Ue,Xe,Ze;M.parameters=r(t({},M.parameters),{docs:r(t({},(Ue=M.parameters)==null?void 0:Ue.docs),{source:t({originalSource:`{
  render: () => {
    const items: MenuProps['items'] = [{
      key: '1',
      type: 'group',
