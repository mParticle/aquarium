...
}`},(L=(F=i.parameters)==null?void 0:F.docs)==null?void 0:L.source)})});var P,R,T;c.parameters=o(r({},c.parameters),{docs:o(r({},(P=c.parameters)==null?void 0:P.docs),{source:r({originalSource:`{
  args: {
    accept: '.pdf,.docx'
  }
...
}`},(k=(j=d.parameters)==null?void 0:j.docs)==null?void 0:k.source)})});const Z=["Primary","CustomListType","DragAndDropUpload","CustomProgress","CustomAcceptFileType","DisabledUpload"];export{c as CustomAcceptFileType,n as CustomListType,i as CustomProgress,d as DisabledUpload,p as DragAndDropUpload,t as Primary,Z as __namedExportsOrder,Y as default};
