var q=Object.defineProperty,X=Object.defineProperties;var $=Object.getOwnPropertyDescriptors;var P=Object.getOwnPropertySymbols;var W=Object.prototype.hasOwnProperty,Z=Object.prototype.propertyIsEnumerable;var G=(o,n,i)=>n in o?q(o,n,{enumerable:!0,configurable:!0,writable:!0,value:i}):o[n]=i,y=(o,n)=>{for(var i in n||(n={}))W.call(n,i)&&G(o,i,n[i]);if(P)for(var i of P(n))Z.call(n,i)&&G(o,i,n[i]);return o},_=(o,n)=>X(o,$(n));import{j as t}from"./jsx-runtime-CVnACwZl.js";import{r as c}from"./index-3OP4wdng.js";import{aq as I,c as r,F as z,I as J}from"./NavigationItemsService-CRkKWdOB.js";import{E as K,S as Q,j as ee,k as te}from"./ErrorStateIcon-DUz035cB.js";import"./_baseClone-CXAe4HsA.js";import"./LightTheme-BtoaoHMG.js";import"./row-Bsm_WxsR.js";import"./Context-R5ee3nrF.js";import"./useToken-C_i1q6Gz.js";import"./presets-BrZHayqo.js";import"./extends-CF3RwP-h.js";import"./index-B-gr4m3q.js";import"./isNativeReflectConstruct-CWIsGhkf.js";const b={LIGHT:"light",DUO_TONE:"duo-tone"},ne=["xxxxl","xxxl","xxl","xl","lg","md","sm","xs"],oe=["default","primary","success","warning","error","info","white","black","text","strong","brand"],N={UI_ACTION_PATTERNS:["accept","close","edit","delete","copy","add","remove","unlock","lock","play","pause","run","filter","search","upload","next","previous","back","openTab","fullScreen","fitToScreen","zoomIn","zoomOut","jumpTo","moreActions","dragAndDrop","reorder","refresh","clone","boost","submitFeedback","dropdown","logout"],INFORMATIONAL_PATTERNS:["info","help","notification","active","cohort","funnel","group","placeholder","private","privileges","textWidget","annotation","generic","calculatedAttribute","conversion","criteriaGroup","audienceGroup","abSplit","account","users","viewOnly","premium","agentCopilot","refreshFrequency","stateError","bannerFreemium"],DATA_TYPE_PATTERNS:["array","boolean","number","string","timestamp","list","otherData","stateEmpty","stateNoResults"],NAVIGATION_PATTERNS:["catalog","directory","dsr","enrichment","forwarding","journeyAnalysis","liveStream","observability","systemAlerts","transformation","userProfiles"]},x=(o,n)=>n.some(i=>o.includes(i)),A=o=>o.filter(n=>!I[n].deprecated),g=({color:o="black",size:n="lg",name:i,variant:V})=>{const s=Object.keys(I),h={display:"grid",gridTemplateColumns:"repeat(6, 1fr)",gap:Q,alignItems:"center",justifyItems:"center"},l={marginBottom:ee},F={marginBottom:te};if(i)return t.jsx("div",{style:h,children:O(i)});const u=e=>{const d=[],p=[];return e.forEach(m=>{I[m].default===b.DUO_TONE?p.push(m):d.push(m)}),{lightIcons:d,duotoneIcons:p}},a=(e,d,p=5)=>d.length===0?null:t.jsxs("div",{style:F,children:[t.jsx(r.Title,{level:p,children:e}),t.jsx("div",{style:h,children:d.sort().map(O)})]}),S=c.useMemo(()=>A(s.filter(e=>x(e,N.UI_ACTION_PATTERNS))),[s]),w=["api","audiences","database","dashboard","date","devices","identity","organization","predictions","scheduledReport","segmentationAnalysis","flag","insights","link","favorite","paywall","pipelines","precision","rateDown","rateStar","rateUp","settings","support","selected"],T=c.useMemo(()=>A(s.filter(e=>x(e,N.INFORMATIONAL_PATTERNS)||w.includes(e)||e.includes("other")&&e!=="otherData")),[s]),B=["empty","event","eventAttribute","userAttribute"],f=c.useMemo(()=>A(s.filter(e=>x(e,N.DATA_TYPE_PATTERNS)||B.includes(e))),[s]),H=["connections","savedProjects","privacy","setup"],v=c.useMemo(()=>A(s.filter(e=>x(e,N.NAVIGATION_PATTERNS)||H.includes(e))),[s]),Y=c.useMemo(()=>s.filter(e=>I[e].deprecated),[s]),D=c.useMemo(()=>s.filter(e=>!I[e].deprecated&&!S.includes(e)&&!T.includes(e)&&!f.includes(e)&&!v.includes(e)),[s,S,T,f,v]),j=c.useMemo(()=>u(S),[S]),E=c.useMemo(()=>u(T),[T]),M=c.useMemo(()=>u(f),[f]),C=c.useMemo(()=>u(v),[v]),R=c.useMemo(()=>u(D),[D]);return t.jsxs("div",{children:[t.jsxs("div",{style:l,children:[t.jsx(r.Title,{level:4,children:"Special Icons"}),t.jsx("div",{style:h,children:t.jsxs(z,{vertical:!0,align:"center",children:[t.jsx(K,{size:n}),t.jsx("p",{style:{fontFamily:"monospace",textAlign:"center"},children:"ErrorStateIcon"})]},"error-state-icon")})]}),t.jsxs("div",{style:l,children:[t.jsx(r.Title,{level:4,children:"UI Actions"}),a("Light",j.lightIcons),a("Duotone",j.duotoneIcons)]}),t.jsxs("div",{style:l,children:[t.jsx(r.Title,{level:4,children:"Informational Icons"}),a("Light",E.lightIcons),a("Duotone",E.duotoneIcons)]}),t.jsxs("div",{style:l,children:[t.jsx(r.Title,{level:4,children:"Data Type Icons"}),a("Light",M.lightIcons),a("Duotone",M.duotoneIcons)]}),t.jsxs("div",{style:l,children:[t.jsx(r.Title,{level:4,children:"Navigation"}),a("Light",C.lightIcons),a("Duotone",C.duotoneIcons)]}),D.length>0&&t.jsxs("div",{style:l,children:[t.jsx(r.Title,{level:4,children:"Other Icons"}),a("Light",R.lightIcons),a("Duotone",R.duotoneIcons)]}),t.jsxs("div",{style:l,children:[t.jsx(r.Title,{level:4,type:"secondary",children:"Deprecated Icons"}),t.jsx("div",{style:h,children:Y.sort().map(O)})]})]});function O(e){const p=I[e].deprecated,m=p?{textDecoration:"line-through"}:{};return t.jsxs(z,{vertical:!0,align:"center",children:[t.jsx(J,{name:e,size:n,color:o,variant:V}),t.jsxs("p",{style:y({fontFamily:"monospace",textAlign:"center"},m),children:[p?"deprecated ":"",e]})]},e)}},ie=`
...
`,fe={title:"Components/General/Icons",component:g,argTypes:{size:{control:"select",options:ne},color:{control:"select",options:oe},variant:{control:"select",options:Object.values(b)}},parameters:{docs:{description:{component:ie}}}};var k,U,L;g.parameters=_(y({},g.parameters),{docs:_(y({},(k=g.parameters)==null?void 0:k.docs),{source:y({originalSource:`({
  color = 'black',
  size = 'lg',
  name,
  variant
...
}`},(L=(U=g.parameters)==null?void 0:U.docs)==null?void 0:L.source)})});const ve=["IconTable"];export{g as IconTable,ve as __namedExportsOrder,fe as default};
