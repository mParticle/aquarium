...
}`},(L=(F=g.parameters)==null?void 0:F.docs)==null?void 0:L.source)})});var N,O,U;x.parameters=t(r({},x.parameters),{docs:t(r({},(N=x.parameters)==null?void 0:N.docs),{source:r({originalSource:`{
  args: {
    description: 'Additional content of the alert.'
  }
}`},(U=(O=x.parameters)==null?void 0:O.docs)==null?void 0:U.source)})});var P,R,M;u.parameters=t(r({},u.parameters),{docs:t(r({},(P=u.parameters)==null?void 0:P.docs),{source:r({originalSource:`{
  args: {
    action: <a style={{
      paddingLeft: '8px'
    }}>Click Me Link</a>
