...
export enum NavigationItemId {
  ...
  DataWarehouse_External = 'dataWarehouse_external',
  DataWarehouse_External_Connections = 'dataWarehouse_external_connections',
  DataWarehouse_External_DataModels = 'dataWarehouse_external_dataModels',
...
const allNavigationItems: IGlobalNavigationItem[] = [
  ...
  {
    id: NavigationItemId.DataWarehouse,
    label: 'Data Warehouse',
    type: 'menu',
    icon: <Icon name="database" variant="light" />,
    children: [
      {
        id: NavigationItemId.DataWarehouse_WarehouseIngest,
        label: 'Warehouse Ingest',
        type: 'link',
        hrefOptions: { href: Paths.DataWarehouse.WarehouseIngest },
      },
      {
        id: NavigationItemId.DataWarehouse_External,
        label: 'External',
        type: 'menu',
        children: [
          {
            id: NavigationItemId.DataWarehouse_External_Connections,
            label: 'Connections',
            type: 'link',
            hrefOptions: { href: Paths.DataWarehouse.External.Connections },
          },
          {
            id: NavigationItemId.DataWarehouse_External_DataModels,
            label: 'Data Models',
            type: 'link',
            hrefOptions: { href: Paths.DataWarehouse.External.DataModels },
          },
        ],
      },
      {
        id: NavigationItemId.DataWarehouse_WarehouseOutput,
        label: 'Output',
        type: 'link',
        hrefOptions: { href: Paths.DataWarehouse.WarehouseOutput },
      },
    ],
  },
  {
