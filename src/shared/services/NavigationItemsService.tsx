...
const allNavigationItems: IGlobalNavigationItem[] = [
  ...
  },
  {
    ...
    children: [
      {
        id: NavigationItemId.DataWarehouse_Connections,
        label: 'Connections',
        type: 'link',
        hrefOptions: { href: Paths.DataWarehouse.Connections },
      },
      {
        id: NavigationItemId.DataWarehouse_DataModels,
        label: 'Data Models',
        type: 'link',
        hrefOptions: { href: Paths.DataWarehouse.DataModels },
      },
      {
        id: NavigationItemId.DataWarehouse_Pipelines,
        label: 'Pipelines',
        type: 'link',
        hrefOptions: { href: Paths.DataWarehouse.Pipelines },
      },
    ],
  },
  {
