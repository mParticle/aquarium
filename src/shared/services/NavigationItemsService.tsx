...
export class NavigationItemsService {
  ...
  public static initialize() {
    ...
    const isSegmentationNewExperience = userPreferences[mParticleUserPreferenceIds.IsSegmentationNewExperience].optedIn
    const isJourneysEnabled =
      isSegmentationNewExperience || !window.mParticleConfig.organizationPolicy.uiEnableAudiencesRealTime
