...
const allNavigationItems: IGlobalNavigationItem[] = [
  ...
  },
  {
    ...
    children: [
      ...
      {
        id: NavigationItemId.DataWarehouse_Activation,
        label: 'Activation',
        type: 'menu',
        children: [
          {
            id: NavigationItemId.DataWarehouse_Activation_Connections,
            label: 'Connections',
            type: 'link',
            hrefOptions: { href: Paths.DataWarehouse.Activation.Connections },
          },
          {
            id: NavigationItemId.DataWarehouse_Activation_DataModels,
            label: 'Data Models',
            type: 'link',
            hrefOptions: { href: Paths.DataWarehouse.Activation.DataModels },
          },
        ],
      },
      {
