...
const meta: Meta<typeof Alert> = {
  ...
  args: {
    ...
    showIcon: false,
    type: "info",
    onClose: (e) => { alert("Alert On Close"); },
    afterClose: () => { console.log("Alert After Closed"); },
  },
  argTypes: {
    type: {
      control: "select",
...
export const ExampleCatchError: Story = {
  render: () => {
    ...
    const ThrowError: React.FC = () => {
      const onClick = () => { setError(new Error("An Uncaught Error")); };
      if (error) { throw error; }
      return (
        <Button danger onClick={onClick}>Click me to throw a error</Button>);
    };
