...
Compact reference card of all available skills organized by category.
...
| Command             | Purpose                           |
| ------------------- | --------------------------------- |
| `/debug-jest`       | Jest/unit test failure analysis   |
...
| Command        | Purpose                             |
| -------------- | ----------------------------------- |
| `/datadog`     | Query Datadog logs, metrics, traces |
| `/google-docs` | Manage Google Docs & Drive          |
