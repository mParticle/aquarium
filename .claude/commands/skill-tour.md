---
description: Interactive guided tour of available AI coding skills
---

Walk the developer through available AI coding assistant capabilities at their own pace.
...
1. **Headline Skills** - Present the top 5 skills with one-line descriptions:
   ...
   - `/doc-writer` - Track 2 documentation generation
...
5. **Cheat Sheet** - Provide a quick-reference table of all `/slash-commands`
