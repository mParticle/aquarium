...
export declare const DatePicker: {
    ...
    QuarterPicker: (<ValueType_2 = Dayjs>(props: PickerPropsWithMultiple<Dayjs, Omit<Omit<PickerProps<Dayjs>, "picker" | "showTime">, "picker">, ValueType_2>) => ReactElement<any, string | JSXElementConstructor<any>>) & {
    ...
    TimePicker: (<ValueType_2_1 = Dayjs>(props: PickerPropsWithMultiple<Dayjs, Omit<Omit<PickerProps<Dayjs>, "picker" | "showTime">, "picker">, ValueType_2_1>) => ReactElement<any, string | JSXElementConstructor<any>>) & {
        displayName?: string | undefined;
    };
